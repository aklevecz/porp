...
define("com/fido/app/Fallback", ["require", "exports", "module"], function(t, e, i) {
        var r = function(t) {
            ...
            r.type = "text/css", r.rel = "stylesheet", r.href = "assets/css/unsupported.css", document.getElementsByTagName("head")[0].appendChild(r), t.innerHTML = i
        };
        r.constructor = r, i.exports = r
    }),
    function(t) {
        var e, i, r, n, o, s = t.GreenSockGlobals || t,
            a = function(t) {
                var e, i = t.split("."),
                    r = s;
            ...
            d = function(e, i, r, n) {
                ...
                this.check = function(h) {
                    for (var l, u, p, f, m = i.length, v = m; --m > -1;)(l = c[i[m]] || new d(i[m], [])).gsClass ? (o[m] = l.gsClass, v--) : h && l.sc.push(this);
                    if (0 === v && r)
                        for (u = ("com.greensock." + e).split("."), p = u.pop(), f = a(u.join("."))[p] = this.gsClass = r.apply(r, o), n && (s[p] = f, "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + e.split(".").join("/"), [], function() {
                                return f
                            }) : "undefined" != typeof module && module.exports && (module.exports = f)), m = 0; this.sc.length > m; m++) this.sc[m].check()
                }, this.check(!0)
            },
            ...
            f = h._class = function(t, e, i) {
                return e = e || function() {}, p(t, [], function() {
                    return e
                }, i), e
            };
        p.globals = s;
        var m = [0, 0, 1, 1],
            v = [],
            g = f("easing.Ease", function(t, e, i, r) {
            ...
            x = g.register = function(t, e, i, r) {
                for (var n, o, s, a, l = e.split(","), u = l.length, c = (i || "easeIn,easeOut,easeInOut").split(","); --u > -1;)
                    for (o = l[u], n = r ? f("easing." + o, null, !0) : h.easing[o] || {}, s = c.length; --s > -1;) a = c[s], y[o + "." + a] = y[a + o] = n[a] = t.getRatio ? t : t[a] || new t
            };
        for (r = g.prototype, r._calcEnd = !1, r.getRatio = function(t) {
            ...
            }, e = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"], i = e.length; --i > -1;) r = e[i] + ",Power" + i, x(new g(null, null, 1, i), r, "easeOut", !0), x(new g(null, null, 2, i), r, "easeIn" + (0 === i ? ",easeNone" : "")), x(new g(null, null, 3, i), r, "easeInOut");
        y.linear = h.easing.Linear.easeIn, y.swing = h.easing.Quad.easeInOut;
        var _ = f("events.EventDispatcher", function(t) {
            this._listeners = {}, this._eventTarget = t || this
        });
        r = _.prototype, r.addEventListener = function(t, e, i, r, s) {
            s = s || 0;
            var a, h, l = this._listeners[t],
                u = 0;
            for (null == l && (this._listeners[t] = l = []), h = l.length; --h > -1;) a = l[h], a.c === e && a.s === i ? l.splice(h, 1) : 0 === u && s > a.pr && (u = h + 1);
            l.splice(u, 0, {
                c: e,
                s: i,
                up: r,
        ...
        var b = t.requestAnimationFrame,
            ...
            S = T();
        for (e = ["ms", "moz", "webkit", "o"], i = e.length; --i > -1 && !b;) b = t[e[i] + "RequestAnimationFrame"], w = t[e[i] + "CancelAnimationFrame"] || t[e[i] + "CancelRequestAnimationFrame"];
        f("Ticker", function(t, e) {
            var i, r, s, a, h, l = this,
                c = T(),
                d = e !== !1 && b,
                p = function(t) {
                    S = T(), l.time = (S - c) / 1e3;
                    var e, n = l.time - h;
                    (!i || n > 0 || t === !0) && (l.frame++, h += n + (n >= a ? .004 : a - n), e = !0), t !== !0 && (s = r(p)), e && l.dispatchEvent("tick")
                };
            _.call(l), this.time = this.frame = 0, this.tick = function() {
                ...
                null !== s && l.sleep(), r = 0 === i ? u : d && b ? b : function(t) {
        ...
        n = E.ticker = new h.Ticker, r = E.prototype, r._dirty = r._gc = r._initted = r._paused = !1, r._totalTime = r._time = 0, r._rawPrevTime = -1, r._next = r._last = r._onUpdate = r._timeline = r.timeline = null, r._paused = !1;
        var A = function() {
        ...
        A(), r.play = function(t, e) {
            ...
            return o || n.wake(), this._gc = !t, this._active = t && !this._paused && this._totalTime > 0 && this._totalTime < this._totalDuration, e !== !0 && (t && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !t && this.timeline && this._timeline._remove(this, !0)), !1
        }, r._kill = function() {
        ...
        r = C.prototype = new E, r.constructor = C, r.kill()._gc = !1, r._first = r._last = null, r._sortChildren = !1, r.add = r.insert = function(t, e) {
            var i, r;
        ...
        var M = f("TweenLite", function(e, i, r) {
                ...
                if (this._overwrite = h = null == h ? I[M.defaultOverwrite] : "number" == typeof h ? h >> 0 : I[h], (a || e instanceof Array) && "number" != typeof e[0])
                    for (this._targets = s = l.call(e, 0), this._propLookup = [], this._siblings = [], n = 0; s.length > n; n++) o = s[n], o ? "string" != typeof o ? o.length && o !== t && o[0] && (o[0] === t || o[0].nodeType && o[0].style && !o.nodeType) ? (s.splice(n--, 1), this._targets = s = s.concat(l.call(o, 0))) : (this._siblings[n] = U(o, this, !1), 1 === h && this._siblings[n].length > 1 && X(o, this, null, 1, this._siblings[n])) : (o = s[n--] = M.selector(o), "string" == typeof o && s.splice(n + 1, 1)) : s.splice(n--, 1);
                else this._propLookup = {}, this._siblings = U(e, this, !1), 1 === h && this._siblings.length > 1 && X(e, this, null, 1, this._siblings);
            ...
            P = function(t, e) {
                var i, r = {};
                for (i in t) k[i] || i in e && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!D[i] || D[i] && D[i]._autoCSS) || (r[i] = t[i], delete t[i]);
                t.css = r
            };
        r = M.prototype = new E, r.constructor = M, r.kill()._gc = !1, r.ratio = 0, r._firstPT = r._targets = r._overwrittenProps = r._startAt = null, r._notifyPluginsOfEnabled = !1, M.version = "1.10.2", M.defaultEase = r._ease = new g(null, null, 1, 1), M.defaultOverwrite = "auto", M.ticker = n, M.autoSleep = !0, M.selector = t.$ || t.jQuery || function(e) {
        ...
        N._startTime = n.time, B._startTime = n.frame, N._active = B._active = !0, E._updateRoot = function() {
            if (N.render((n.time - N._startTime) * N._timeScale, !1, !1), B.render((n.frame - B._startTime) * B._timeScale, !1, !1), !(n.frame % 120)) {
                var t, e, i;
                for (i in F) {
        ...
        var U = function(t, e, i) {
            ...
            X = function(t, e, i, r, n) {
                ...
                var l, u = e._startTime + 1e-10,
                    ...
                    d = 0,
                    p = 0 === e._duration;
                for (o = n.length; --o > -1;)(a = n[o]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (l = l || j(e, 0, p), 0 === j(a, l, p) && (c[d++] = a)) : u >= a._startTime && a._startTime + a.totalDuration() / a._timeScale + 1e-10 > u && ((p || !a._initted) && 2e-10 >= u - a._startTime || (c[d++] = a)));
                for (o = d; --o > -1;) a = c[o], 2 === r && a._kill(i, t) && (s = !0), (2 !== r || !a._firstPT && a._initted) && a._enabled(!1, !1) && (s = !0);
                return s
            },
            j = function(t, e, i) {
                ...
                return o /= n, o > e ? o - e : i && o === e || !t._initted && 2 * s > o - e ? s : (o += t.totalDuration() / t._timeScale / n) > e + s ? 0 : o - e - s
            };
        r._init = function() {
            ...
            if (this._ease = h ? h instanceof g ? n.easeParams instanceof Array ? h.config.apply(h, n.easeParams) : h : "function" == typeof h ? new g(h, n.easeParams) : y[h] || M.defaultEase : M.defaultEase, this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
            ...
            if (e && M._onPluginEvent("_onInitAllProps", this), o && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), n.runBackwards)
            ...
            for (o in this.vars) {
                if (u = this.vars[o], k[o]) u instanceof Array && -1 !== u.join("").indexOf("{self}") && (this.vars[o] = u = this._swapSelfInParams(u, this));
            ...
            return n && this._kill(n, e) ? this._initProps(e, i, r, n) : this._overwrite > 1 && this._firstPT && r.length > 1 && X(e, this, i, this._overwrite, r) ? (this._kill(i, e), this._initProps(e, i, r, n)) : a
        }, r.render = function(t, e, i) {
            var r, n, o, s = this._time;
            ...
            else if (1e-7 > t) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== s || 0 === this._duration && this._rawPrevTime > 0) && (n = "onReverseComplete", r = this._reversed), 0 > t ? (this._active = !1, 0 === this._duration && (this._rawPrevTime >= 0 && (i = !0), this._rawPrevTime = t)) : this._initted || (i = !0);
            ...
            if (this._time !== s || i) {
                ...
                for (this._active || !this._paused && this._time !== s && t >= 0 && (this._active = !0), 0 === s && (this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : n || (n = "_dummyGS")), this.vars.onStart && (0 !== this._time || 0 === this._duration) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || v))), o = this._firstPT; o;) o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s, o = o._next;
            ...
            if ((e instanceof Array || R(e)) && "number" != typeof e[0])
                ...
                if (s) {
                    ...
                    for (n in h)(o = s[n]) && (o.pg && o.t._kill(h) && (a = !0), o.pg && 0 !== o.t._overwriteProps.length || (o._prev ? o._prev._next = o._next : o === this._firstPT && (this._firstPT = o._next), o._next && (o._next._prev = o._prev), o._next = o._prev = null), delete s[n]), l && (r[n] = 1);
            ...
            return E.prototype._enabled.call(this, t, e), this._notifyPluginsOfEnabled && this._firstPT ? M._onPluginEvent(t ? "_onEnable" : "_onDisable", this) : !1
        }, M.to = function(t, e, i) {
            return new M(t, e, i)
        ...
        if (r = z.prototype, z.version = "1.10.1", z.API = 2, r._firstPT = null, r._addTween = function(t, e, i, r, n, o) {
                var s, a;
                return null != r && (s = "number" == typeof r || "=" !== r.charAt(1) ? Number(r) - i : parseInt(r.charAt(0) + "1", 10) * Number(r.substr(2))) ? (this._firstPT = a = {
                    _next: this._firstPT,
                    t: t,
                    p: e,
                    s: i,
                ...
                var e, i = t.propName,
                    ...
                    s = f("plugins." + i.charAt(0).toUpperCase() + i.substr(1) + "Plugin", function() {
        ...
        o = !1
    }(window), define("TWEEN", function() {}), (window._gsQueue || (window._gsQueue = [])).push(function() {
        window._gsDefine("easing.Back", ["easing.Ease"], function(t) {
            ...
            return v.constructor = m, v.getRatio = function(t) {
                ...
                e = e || {};
                for (var i, r, n, o, s, a, h = e.taper || "none", l = [], u = 0, c = 0 | (e.points || 20), p = c, f = e.randomize !== !1, m = e.clamp === !0, v = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; --p > -1;) i = f ? Math.random() : 1 / c * p, r = v ? v.getRatio(i) : i, "none" === h ? n = g : "out" === h ? (o = 1 - i, n = o * o * g) : "in" === h ? n = i * i * g : .5 > i ? (o = 2 * i, n = .5 * o * o * g) : (o = 2 * (1 - i), n = .5 * o * o * g), f ? r += Math.random() * n - .5 * n : p % 2 ? r += .5 * n : r -= .5 * n, m && (r > 1 ? r = 1 : 0 > r && (r = 0)), l[u++] = {
                    x: i,
                    y: r
                };
                for (l.sort(function(t, e) {
                        return t.x - e.x
                    }), a = new d(1, 1, null), p = c; --p > -1;) s = l[p], a = new d(s.x, s.y, a);
    ...
    }), window._gsDefine && window._gsQueue.pop()(), define("EASEPACK", function() {}), (window._gsQueue || (window._gsQueue = [])).push(function() {
        window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
            ...
            var l, u, c, d, p, f, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                ...
                X = function() {
                    var t, e = U.indexOf("Android"),
                        i = k.createElement("div");
                    return c = -1 !== U.indexOf("Safari") && -1 === U.indexOf("Chrome") && (-1 === e || Number(U.substr(e + 8, 1)) > 3), p = c && 6 > Number(U.substr(U.indexOf("Version/") + 8, 1)), d = -1 !== U.indexOf("Firefox"), /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(U), f = parseFloat(RegExp.$1), i.innerHTML = "<a style='top:1px;opacity:.55;'>a</a>", t = i.getElementsByTagName("a")[0], t ? /^0.55/.test(t.style.opacity) : !1
                }(),
                j = function(t) {
                ...
                V = s.getStyle = function(t, e, i, r, n) {
                    var o;
                    return X || "opacity" !== e ? (!r && t.style[e] ? o = t.style[e] : (i = i || H(t, null)) ? (t = i.getPropertyValue(e.replace(S, "-$1").toLowerCase()), o = t || i.length ? t : i[e]) : t.currentStyle && (i = t.currentStyle, o = i[e]), null == n || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : n) : j(t)
                },
                q = function(t, e, i, r, n) {
                    ...
                    var o, s = M.test(e),
                        ...
                        h = I.style,
                        l = 0 > i;
                    return l && (i = -i), "%" === r && -1 !== e.indexOf("border") ? o = i / 100 * (s ? t.clientWidth : t.clientHeight) : (h.cssText = "border-style:solid; border-width:0; position:absolute; line-height:0;", "%" !== r && a.appendChild ? h[s ? "borderLeftWidth" : "borderTopWidth"] = i + r : (a = t.parentNode || k.body, h[s ? "width" : "height"] = i + r), a.appendChild(I), o = parseFloat(I[s ? "offsetWidth" : "offsetHeight"]), a.removeChild(I), 0 !== o || n || (o = q(t, e, i, r, !0))), l ? -o : o
                },
                K = function(t, e, i) {
                ...
                Q = function(t, e) {
                    ...
                    if (e = e || H(t, null))
                        if (i = e.length)
                            for (; --i > -1;) n[e[i].replace(E, C)] = e.getPropertyValue(e[i]);
                        else
                            for (i in e) n[i] = e[i];
                    else if (e = t.currentStyle || t.style)
                        for (i in e) n[i.replace(E, C)] = e[i];
                    return X || (n.opacity = j(t)), r = Te(t, e, !1), n.rotation = r.rotation * F, n.skewX = r.skewX * F, n.scaleX = r.scaleX, n.scaleY = r.scaleY, n.x = r.x, n.y = r.y, we && (n.z = r.z, n.rotationX = r.rotationX * F, n.rotationY = r.rotationY * F, n.scaleZ = r.scaleZ), n.filters && delete n.filters, n
                },
                $ = function(t, e, i, r, n) {
                    var o, s, a, h = {},
                        l = t.style;
                    for (s in i) "cssText" !== s && "length" !== s && isNaN(s) && (e[s] !== (o = i[s]) || n && n[s]) && -1 === s.indexOf("Origin") && ("number" == typeof o || "string" == typeof o) && (h[s] = "auto" !== o || "left" !== s && "top" !== s ? "" !== o && "auto" !== o && "none" !== o || "string" != typeof e[s] || "" === e[s].replace(y, "") ? o : 0 : K(t, s), void 0 !== l[s] && (a = new ce(l, s, l[s], a)));
                    if (r)
                ...
                te = function(t, e, i) {
                    var r = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight),
                        n = J[e],
                        o = n.length;
                    for (i = i || H(t, null); --o > -1;) r -= parseFloat(V(t, "padding" + n[o], i, !0)) || 0, r -= parseFloat(V(t, "border" + n[o] + "Width", i, !0)) || 0;
                    return r
                },
                ee = function(t, e) {
                    ...
                    return null == n ? n = "0" : "center" === n && (n = "50%"), ("center" === r || isNaN(parseFloat(r))) && (r = "50%"), e && (e.oxp = -1 !== r.indexOf("%"), e.oyp = -1 !== n.indexOf("%"), e.oxr = "=" === r.charAt(1), e.oyr = "=" === n.charAt(1), e.ox = parseFloat(r.replace(y, "")), e.oy = parseFloat(n.replace(y, ""))), r + " " + n + (i.length > 2 ? " " + i[2] : "")
                },
                ie = function(t, e) {
                ...
                ne = function(t, e, i, r) {
                    var n, o, s, a, h = 1e-6;
                    return null == t ? a = e : "number" == typeof t ? a = t * D : (n = 2 * Math.PI, o = t.split("_"), s = Number(o[0].replace(y, "")) * (-1 === t.indexOf("rad") ? D : 1) - ("=" === t.charAt(1) ? 0 : e), o.length && (r && (r[i] = e + s), -1 !== t.indexOf("short") && (s %= n, s !== s % (n / 2) && (s = 0 > s ? s + n : s - n)), -1 !== t.indexOf("_cw") && 0 > s ? s = (s + 9999999999 * n) % n - (0 | s / n) * n : -1 !== t.indexOf("ccw") && s > 0 && (s = (s - 9999999999 * n) % n - (0 | s / n) * n)), a = e + s), h > a && a > -h && (a = 0), a
                },
                oe = {
                    aqua: [0, 255, 255],
                    lime: [0, 255, 0],
                ...
                ae = function(t) {
                    var e, i, r, n, o, s;
                    return t && "" !== t ? "number" == typeof t ? [t >> 16, 255 & t >> 8, 255 & t] : ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), oe[t] ? oe[t] : "#" === t.charAt(0) ? (4 === t.length && (e = t.charAt(1), i = t.charAt(2), r = t.charAt(3), t = "#" + e + e + i + i + r + r), t = parseInt(t.substr(1), 16), [t >> 16, 255 & t >> 8, 255 & t]) : "hsl" === t.substr(0, 3) ? (t = t.match(m), n = Number(t[0]) % 360 / 360, o = Number(t[1]) / 100, s = Number(t[2]) / 100, i = .5 >= s ? s * (o + 1) : s + o - s * o, e = 2 * s - i, t.length > 3 && (t[3] = Number(t[3])), t[0] = se(n + 1 / 3, e, i), t[1] = se(n, e, i), t[2] = se(n - 1 / 3, e, i), t) : (t = t.match(m) || oe.transparent, t[0] = Number(t[0]), t[1] = Number(t[1]), t[2] = Number(t[2]), t.length > 3 && (t[3] = Number(t[3])), t)) : oe.black
                },
            ...
            var le = function(t, e, i, r) {
                    ...
                    return u ? n = e ? function(t) {
                        ...
                        if (e = (t.match(he) || [o])[0], d = t.split(e).join("").match(g) || [], p = d.length, u > p--)
                ...
                ce = (N._setPluginRatio = function(t) {
                    this.plugin.setRatio(t);
                    for (var e, i, r, n, o = this.data, s = o.proxy, a = o.firstMPT, h = 1e-6; a;) e = s[a.v], a.r ? e = e > 0 ? 0 | e + .5 : 0 | e - .5 : h > e && e > -h && (e = 0), a.t[a.p] = e, a = a._next;
                ...
                de = (N._parseToProxy = function(t, e, i, r, n, o) {
                    var s, a, h, l, u, c = r,
                        d = {},
                        p = {},
                        f = i._transform,
                        m = L;
                    for (i._transform = null, L = e, r = u = i.parse(t, e, r, n), L = m, o && (i._transform = f, c && (c._prev = null, c._prev && (c._prev._next = null))); r && r !== c;) {
                        if (1 >= r.type && (a = r.p, p[a] = r.s + r.c, d[a] = r.s, o || (l = new ce(r, "s", a, l, r.r), r.c = 0), 1 === r.type))
                            for (s = r.l; --s > 0;) h = "xn" + s, a = r.p + "_" + h, p[a] = r.data[h], d[a] = r[h], o || (l = new ce(r, h, a, l, r.rxp[h]));
                        r = r._next
                    }
                    return {
                        proxy: d,
                    ...
                    this.t = t, this.p = e, this.s = r, this.c = n, this.n = h || "css_" + e, t instanceof de || o.push(this.n), this.r = l, this.type = a || 0, u && (this.pr = u, i = !0), this.b = void 0 === c ? r : c, this.e = void 0 === d ? r + n : d, s && (this._next = s, s._prev = this)
                }),
                pe = s.parseComplex = function(t, e, i, r, n, o, s, a, h, u) {
                    s = new de(t, e, 0, 0, s, u ? 2 : 1, null, !1, a, i, r), r += "";
                    var c, d, p, f, g, y, x, _, b, w, S, E, A = i.split(", ").join(",").split(" "),
                        C = r.split(", ").join(",").split(" "),
                        M = A.length,
                        R = l !== !1;
                    for ((-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && (A = A.join(" ").replace(O, ", ").split(" "), C = C.join(" ").replace(O, ", ").split(" "), M = A.length), M !== C.length && (A = (o || "").split(" "), M = A.length), s.plugin = h, s.setRatio = u, c = 0; M > c; c++)
                        if (f = A[c], g = C[c], _ = parseFloat(f), _ || 0 === _) s.appendXtra("", _, ie(g, _), g.replace(v, ""), R && -1 !== g.indexOf("px"), !0);
                        else if (n && ("#" === f.charAt(0) || oe[f] || T.test(f))) E = "," === g.charAt(g.length - 1) ? ")," : ")", f = ae(f), g = ae(g), b = f.length + g.length > 6, b && !X && 0 === g[3] ? (s["xs" + s.l] += s.l ? " transparent" : "transparent", s.e = s.e.split(C[c]).join("transparent")) : (X || (b = !1), s.appendXtra(b ? "rgba(" : "rgb(", f[0], g[0] - f[0], ",", !0, !0).appendXtra("", f[1], g[1] - f[1], ",", !0).appendXtra("", f[2], g[2] - f[2], b ? "," : E, !0), b && (f = 4 > f.length ? 1 : f[3], s.appendXtra("", f, (4 > g.length ? 1 : g[3]) - f, E, !1)));
                    else if (y = f.match(m)) {
                        if (x = g.match(v), !x || x.length !== y.length) return s;
                        for (p = 0, d = 0; y.length > d; d++) S = y[d], w = f.indexOf(S, p), s.appendXtra(f.substr(p, w - p), Number(S), ie(x[d], S), "", R && "px" === f.substr(w + S.length, 2), 0 === d), p = w + S.length;
                        s["xs" + s.l] += f.substr(p)
            ...
            h.xs0 = "", h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null, h.appendXtra = function(t, e, i, r, n, o) {
                var s = this,
                    a = s.l;
                return s["xs" + a] += o && a ? " " + t : t || "", i || 0 === a || s.plugin ? (s.l++, s.type = s.setRatio ? 2 : 1, s["xs" + s.l] = r || "", a > 0 ? (s.data["xn" + a] = e + i, s.rxp["xn" + a] = n, s["xn" + a] = e, s.plugin || (s.xfirst = new de(s, "xn" + a, e, i, s.xfirst || s, 0, s.n, n, s.pr), s.xfirst.xs0 = 0), s) : (s.data = {
                    s: e + i
                }, s.rxp = {}, s.s = e, s.c = i, s.r = n, s)) : (s["xs" + a] += e + (r || ""), s)
            };
            var me = function(t, e) {
                    e = e || {}, this.p = e.prefix ? G(t) || t : t, a[t] = a[this.p] = this, this.format = e.formatter || le(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0
                },
                ve = N._registerComplexSpecialProp = function(t, e, i) {
                    ...
                    var r, n, o = t.split(","),
                        s = e.defaultValue;
                    for (i = i || [s], r = 0; o.length > r; r++) e.prefix = 0 === r && e.prefix, e.defaultValue = i[r] || s, n = new me(o[r], e)
                },
                ge = function(t) {
                    if (!a[t]) {
                        ...
                        ve(t, {
                            parser: function(t, i, r, n, o, s, h) {
                                ...
                                return l ? (l._cssRegister(), a[r].parse(t, i, r, n, o, s, h)) : (z("Error: " + e + " js file not loaded."), o)
                            }
                        })
                    }
                };
            h = me.prototype, h.parseComplex = function(t, e, i, r, n, o) {
                var s, a, h, l, u, c, d = this.keyword;
                if (this.multi && (O.test(i) || O.test(e) ? (a = e.replace(O, "|").split("|"), h = i.replace(O, "|").split("|")) : d && (a = [e], h = [i])), h) {
                    for (l = h.length > a.length ? h.length : a.length, s = 0; l > s; s++) e = a[s] = a[s] || this.dflt, i = h[s] = h[s] || this.dflt, d && (u = e.indexOf(d), c = i.indexOf(d), u !== c && (i = -1 === c ? h : a, i[s] += " " + d));
                    e = a.join(", "), i = h.join(", ")
                }
            ...
            var ye = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","),
                ...
                Te = function(t, e, i) {
                    var r, n, o, a, h, l, u, c, d, p, f, m, v, g = i ? t._gsTransform || {
                            skewY: 0
                        } : {
                            skewY: 0
                        },
                    ...
                    if (xe) r = V(t, _e, e, !0);
                        ...
                        if (r = t.currentStyle.filter.match(R), r && 4 === r.length) r = [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), g.x || 0, g.y || 0].join(",");
                        else {
                            if (null != g.x) return g;
                            r = ""
                        }
                    for (n = (r || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], o = n.length; --o > -1;) a = Number(n[o]), n[o] = (h = a - (a |= 0)) ? (0 | h * _ + (0 > h ? -.5 : .5)) / _ + a : a;
                    if (16 === n.length) {
                        var S = n[8],
                            E = n[9],
                            A = n[10],
                            ...
                            M = n[13],
                            P = n[14];
                        if (g.zOrigin && (P = -g.zOrigin, C = S * P - n[12], M = E * P - n[13], P = A * P + g.zOrigin - n[14]), !i || null == g.rotationX) {
                            var O, D, F, L, k, I, B, N = n[0],
                                U = n[1],
                                X = n[2],
                                j = n[3],
                                z = n[4],
                                ...
                                K = b > q || q > w;
                            q && (L = Math.cos(-q), k = Math.sin(-q), O = z * L + S * k, D = Y * L + E * k, F = W * L + A * k, S = z * -k + S * L, E = Y * -k + E * L, A = W * -k + A * L, H = G * -k + H * L, z = O, Y = D, W = F), q = g.rotationY = Math.atan2(S, N), q && (I = b > q || q > w, L = Math.cos(-q), k = Math.sin(-q), O = N * L - S * k, D = U * L - E * k, F = X * L - A * k, E = U * k + E * L, A = X * k + A * L, H = j * k + H * L, N = O, U = D, X = F), q = g.rotation = Math.atan2(U, Y), q && (B = b > q || q > w, L = Math.cos(-q), k = Math.sin(-q), N = N * L + z * k, D = U * L + Y * k, Y = U * -k + Y * L, W = X * -k + W * L, U = D), B && K ? g.rotation = g.rotationX = 0 : B && I ? g.rotation = g.rotationY = 0 : I && K && (g.rotationY = g.rotationX = 0), g.scaleX = (0 | Math.sqrt(N * N + U * U) * _ + .5) / _, g.scaleY = (0 | Math.sqrt(Y * Y + E * E) * _ + .5) / _, g.scaleZ = (0 | Math.sqrt(W * W + A * A) * _ + .5) / _, g.skewX = 0, g.perspective = H ? 1 / (0 > H ? -H : H) : 0, g.x = C, g.y = M, g.z = P
                        }
                    } else if (!(we && 0 !== n.length && g.x === n[4] && g.y === n[5] && (g.rotationX || g.rotationY) || void 0 !== g.x && "none" === V(t, "display", e))) {
                        var Q = n.length >= 6,
                            $ = Q ? n[0] : 1,
                            J = n[1] || 0,
                            Z = n[2] || 0,
                            te = Q ? n[3] : 1;
                        g.x = n[4] || 0, g.y = n[5] || 0, l = Math.sqrt($ * $ + J * J), u = Math.sqrt(te * te + Z * Z), c = $ || J ? Math.atan2(J, $) : g.rotation || 0, d = Z || te ? Math.atan2(Z, te) + c : g.skewX || 0, p = l - Math.abs(g.scaleX || 0), f = u - Math.abs(g.scaleY || 0), Math.abs(d) > Math.PI / 2 && Math.abs(d) < 1.5 * Math.PI && (y ? (l *= -1, d += 0 >= c ? Math.PI : -Math.PI, c += 0 >= c ? Math.PI : -Math.PI) : (u *= -1, d += 0 >= d ? Math.PI : -Math.PI)), m = (c - g.rotation) % Math.PI, v = (d - g.skewX) % Math.PI, (void 0 === g.skewX || p > x || -x > p || f > x || -x > f || m > b && w > m && !1 | m * _ || v > b && w > v && !1 | v * _) && (g.scaleX = l, g.scaleY = u, g.rotation = c, g.skewX = d), we && (g.rotationX = g.rotationY = g.z = 0, g.perspective = parseFloat(s.defaultTransformPerspective) || 0, g.scaleZ = 1)
                    }
                    g.zOrigin = T;
                ...
                Se = function(t) {
                    ...
                    if (d) {
                        ...
                        var p, m, v = this.t.offsetWidth,
                            ...
                            w = r.x,
                            T = r.y;
                        if (null != r.ox && (p = (r.oxp ? .01 * v * r.ox : r.ox) - v / 2, m = (r.oyp ? .01 * g * r.oy : r.oy) - g / 2, w += p - (p * a + m * h), T += m - (p * l + m * u)), y) p = v / 2, m = g / 2, b += ", Dx=" + (p - (p * a + m * h) + w) + ", Dy=" + (m - (p * l + m * u) + T) + ")";
                        else {
                            var S, E, A, C = 8 > f ? 1 : -1;
                            for (p = r.ieOffsetX || 0, m = r.ieOffsetY || 0, r.ieOffsetX = Math.round((v - ((0 > a ? -a : a) * v + (0 > h ? -h : h) * g)) / 2 + w), r.ieOffsetY = Math.round((g - ((0 > u ? -u : u) * g + (0 > l ? -l : l) * v)) / 2 + T), fe = 0; 4 > fe; fe++) E = Z[fe], S = d[E], i = -1 !== S.indexOf("px") ? parseFloat(S) : q(this.t, E, parseFloat(S), S.replace(x, "")) || 0, A = i !== r[E] ? 2 > fe ? -r.ieOffsetX : -r.ieOffsetY : 2 > fe ? p - r.ieOffsetX : m - r.ieOffsetY, c[E] = (r[E] = Math.round(i - A * (0 === fe || 2 === fe ? 1 : C))) + "px";
                            b += ", sizingMethod='auto expand')"
                        }
                        c.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(P, b) : b + " " + e, (0 === t || 1 === t) && 1 === a && 0 === h && 0 === l && 1 === u && (y && -1 === b.indexOf("Dx=0, Dy=0") || _.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf("gradient(") && c.removeAttribute("filter"))
                    }
                },
                Ee = function() {
                    var t, e, i, r, n, o, s, a, h, l = this.data,
                        u = this.t.style,
                        c = l.perspective,
                        p = l.scaleX,
                        f = 0,
                        ...
                        R = l.zOrigin,
                        P = 1e5;
                    d && (s = u.top ? "top" : u.bottom ? "bottom" : parseFloat(V(this.t, "top", null, !1)) ? "bottom" : "top", i = V(this.t, s, null, !1), a = parseFloat(i) || 0, h = i.substr((a + "").length) || "px", l._ffFix = !l._ffFix, u[s] = (l._ffFix ? a + .05 : a - .05) + h), (M || l.skewX) && (i = p * Math.cos(M), r = y * Math.sin(M), M -= l.skewX, f = p * -Math.sin(M), y *= Math.cos(M), p = i, g = r), M = l.rotationY, M && (t = Math.cos(M), e = Math.sin(M), i = p * t, r = g * t, n = T * -e, o = C * -e, m = p * e, x = g * e, T *= t, C *= t, p = i, g = r, b = n, E = o), M = l.rotationX, M && (t = Math.cos(M), e = Math.sin(M), i = f * t + m * e, r = y * t + x * e, n = w * t + T * e, o = A * t + C * e, m = f * -e + m * t, x = y * -e + x * t, T = w * -e + T * t, C = A * -e + C * t, f = i, y = r, w = n, A = o), R && (S -= R, v = m * S, _ = x * S, S = T * S + R), v = (i = (v += l.x) - (v |= 0)) ? (0 | i * P + (0 > i ? -.5 : .5)) / P + v : v, _ = (i = (_ += l.y) - (_ |= 0)) ? (0 | i * P + (0 > i ? -.5 : .5)) / P + _ : _, S = (i = (S += l.z) - (S |= 0)) ? (0 | i * P + (0 > i ? -.5 : .5)) / P + S : S, u[xe] = "matrix3d(" + [(0 | p * P) / P, (0 | g * P) / P, (0 | b * P) / P, (0 | E * P) / P, (0 | f * P) / P, (0 | y * P) / P, (0 | w * P) / P, (0 | A * P) / P, (0 | m * P) / P, (0 | x * P) / P, (0 | T * P) / P, (0 | C * P) / P, v, _, S, c ? 1 + -S / c : 1].join(",") + ")"
                },
                Ae = function() {
                    var t, e, i, r, n, o, s, a, h, l = this.data,
                        u = this.t,
                        c = u.style;
                    d && (t = c.top ? "top" : c.bottom ? "bottom" : parseFloat(V(u, "top", null, !1)) ? "bottom" : "top", e = V(u, t, null, !1), i = parseFloat(e) || 0, r = e.substr((i + "").length) || "px", l._ffFix = !l._ffFix, c[t] = (l._ffFix ? i + .05 : i - .05) + r), l.rotation || l.skewX ? (n = l.rotation, o = n - l.skewX, s = 1e5, a = l.scaleX * s, h = l.scaleY * s, c[xe] = "matrix(" + (0 | Math.cos(n) * a) / s + "," + (0 | Math.sin(n) * a) / s + "," + (0 | Math.sin(o) * -h) / s + "," + (0 | Math.cos(o) * h) / s + "," + l.x + "," + l.y + ")") : c[xe] = "matrix(" + l.scaleX + ",0,0," + l.scaleY + "," + l.x + "," + l.y + ")"
                };
            ve("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation", {
                parser: function(t, e, i, r, o, s, a) {
                    if (r._transform) return o;
                    var h, l, u, c, d, p, f, m = r._transform = Te(t, n, !0),
                        v = t.style,
                        g = 1e-6,
                        y = ye.length,
                        x = a,
                        _ = {};
                    if ("string" == typeof x.transform && xe) u = v.cssText, v[xe] = x.transform, v.display = "block", h = Te(t, null, !1), v.cssText = u;
                        ...
                        h.rotation = ne("rotation" in x ? x.rotation : "shortRotation" in x ? x.shortRotation + "_short" : "rotationZ" in x ? x.rotationZ : m.rotation * F, m.rotation, "rotation", _), we && (h.rotationX = ne("rotationX" in x ? x.rotationX : "shortRotationX" in x ? x.shortRotationX + "_short" : m.rotationX * F || 0, m.rotationX, "rotationX", _), h.rotationY = ne("rotationY" in x ? x.rotationY : "shortRotationY" in x ? x.shortRotationY + "_short" : m.rotationY * F || 0, m.rotationY, "rotationY", _)), h.skewX = null == x.skewX ? m.skewX : ne(x.skewX, m.skewX), h.skewY = null == x.skewY ? m.skewY : ne(x.skewY, m.skewY), (l = h.skewY - m.skewY) && (h.skewX += l, h.rotation += l)
                    }
                    for (d = m.z || m.rotationX || m.rotationY || h.z || h.rotationX || h.rotationY || h.perspective, d || null == x.scale || (h.scaleZ = 1); --y > -1;) i = ye[y], c = h[i] - m[i], (c > g || -g > c || null != L[i]) && (p = !0, o = new de(m, i, m[i], c, o), i in _ && (o.e = _[i]), o.xs0 = 0, o.plugin = s, r._overwriteProps.push(o.n));
                    return c = x.transformOrigin, (c || we && d && m.zOrigin) && (xe ? (p = !0, c = (c || V(t, i, n, !1, "50% 50%")) + "", i = be, o = new de(v, i, 0, 0, o, -1, "css_transformOrigin"), o.b = v[i], o.plugin = s, we ? (u = m.zOrigin, c = c.split(" "), m.zOrigin = (c.length > 2 ? parseFloat(c[2]) : u) || 0, o.xs0 = o.e = v[i] = c[0] + " " + (c[1] || "50%") + " 0px", o = new de(m, "zOrigin", 0, 0, o, -1, o.n), o.b = u, o.xs0 = o.e = m.zOrigin) : o.xs0 = o.e = v[i] = c) : ee(c + "", m)), p && (r._transformType = d || 3 === this._transformType ? 3 : 2), o
                },
                prefix: !0
            }), ve("boxShadow", {
                ...
                parser: function(t, e, i, o, s) {
                    e = this.format(e);
                    var a, h, l, u, c, d, p, f, m, v, g, y, x, _, b, w, T = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                        S = t.style;
                    for (m = parseFloat(t.offsetWidth), v = parseFloat(t.offsetHeight), a = e.split(" "), h = 0; T.length > h; h++) this.p.indexOf("border") && (T[h] = G(T[h])), c = u = V(t, T[h], n, !1, "0px"), -1 !== c.indexOf(" ") && (u = c.split(" "), c = u[0], u = u[1]), d = l = a[h], p = parseFloat(c), y = c.substr((p + "").length), x = "=" === d.charAt(1), x ? (f = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), f *= parseFloat(d), g = d.substr((f + "").length - (0 > f ? 1 : 0)) || "") : (f = parseFloat(d), g = d.substr((f + "").length)), "" === g && (g = r[i] || y), g !== y && (_ = q(t, "borderLeft", p, y), b = q(t, "borderTop", p, y), "%" === g ? (c = 100 * (_ / m) + "%", u = 100 * (b / v) + "%") : "em" === g ? (w = q(t, "borderLeft", 1, "em"), c = _ / w + "em", u = b / w + "em") : (c = _ + "px", u = b + "px"), x && (d = parseFloat(c) + f + g, l = parseFloat(u) + f + g)), s = pe(S, T[h], c + " " + u, d + " " + l, !1, "0px", s);
                    return s
                },
                prefix: !0,
                ...
                parser: function(t, e, i, r, o, s) {
                    var a, h, l, u, c, d, p = "background-position",
                        m = n || H(t, null),
                        ...
                        g = this.format(e);
                    if (-1 !== v.indexOf("%") != (-1 !== g.indexOf("%")) && (d = V(t, "backgroundImage").replace(A, ""), d && "none" !== d)) {
                        for (a = v.split(" "), h = g.split(" "), B.setAttribute("src", d), l = 2; --l > -1;) v = a[l], u = -1 !== v.indexOf("%"), u !== (-1 !== h[l].indexOf("%")) && (c = 0 === l ? t.offsetWidth - B.width : t.offsetHeight - B.height, a[l] = u ? parseFloat(v) / 100 * c + "px" : 100 * (parseFloat(v) / c) + "%");
                        v = a.join(" ")
                    }
                ...
                parser: function(t, e, i, r, o, s) {
                    var a, h, l;
                    return 9 > f ? (h = t.currentStyle, l = 8 > f ? " " : ",", a = "rect(" + h.clipTop + l + h.clipRight + l + h.clipBottom + l + h.clipLeft + ")", e = this.format(e).split(",").join(l)) : (a = this.format(V(t, this.p, n, !1, this.dflt)), e = this.format(e)), this.parseComplex(t.style, a, e, o, s)
                }
            }), ve("textShadow", {
                ...
                parser: function(t, e, i, r, o, s) {
                    return this.parseComplex(t.style, this.format(V(t, "borderTopWidth", n, !1, "0px") + " " + V(t, "borderTopStyle", n, !1, "solid") + " " + V(t, "borderTopColor", n, !1, "#000")), this.format(e), o, s)
                },
                color: !0,
            ...
            var Ce = function(t) {
                var e, i = this.t,
                    r = i.filter,
                    n = 0 | this.s + this.c * t;
                100 === n && (-1 === r.indexOf("atrix(") && -1 === r.indexOf("radient(") ? (i.removeAttribute("filter"), e = !V(this.data, "filter")) : (i.filter = r.replace(w, ""), e = !0)), e || (this.xn1 && (i.filter = r = r || "alpha(opacity=100)"), -1 === r.indexOf("opacity") ? i.filter += " alpha(opacity=" + n + ")" : i.filter = r.replace(_, "opacity=" + n))
            };
            ve("opacity,alpha,autoAlpha", {
                defaultValue: "1",
                parser: function(t, e, i, r, o, s) {
                    var a, h = parseFloat(V(t, "opacity", n, !1, "1")),
                        l = t.style;
                    return e = parseFloat(e), "autoAlpha" === i && (a = V(t, "visibility", n), 1 === h && "hidden" === a && 0 !== e && (h = 0), o = new de(l, "visibility", 0, 0, o, -1, null, !1, 0, 0 !== h ? "visible" : "hidden", 0 === e ? "hidden" : "visible"), o.xs0 = "visible", r._overwriteProps.push(o.n)), X ? o = new de(l, "opacity", h, e - h, o) : (o = new de(l, "opacity", 100 * h, 100 * (e - h), o), o.xn1 = "autoAlpha" === i ? 1 : 0, l.zoom = 1, o.type = 2, o.b = "alpha(opacity=" + o.s + ")", o.e = "alpha(opacity=" + (o.s + o.c) + ")", o.data = t, o.plugin = s, o.setRatio = Ce), o
                }
            });
            var Me = function(t, e) {
            ...
            ve("className", {
                parser: function(t, e, r, o, s, a, h) {
                    var l, u, c, d, p, f = t.className,
                        m = t.style.cssText;
                    if (s = o._classNamePT = new de(t, r, 0, 0, s, 2), s.setRatio = Re, s.pr = -11, i = !0, s.b = f, u = Q(t, n), c = t._gsClassPT) {
                        for (d = {}, p = c.data; p;) d[p.p] = 1, p = p._next;
                        c.setRatio(1)
                    }
                    return t._gsClassPT = s, s.e = "=" !== e.charAt(1) ? e : f.replace(RegExp("\\s*\\b" + e.substr(2) + "\\b"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), o._tween._duration && (t.className = s.e, l = $(t, u, Q(t), h, d), t.className = f, s.data = l.firstMPT, t.style.cssText = m, s = s.xfirst = o.parse(t, l.difs, s, a)), s
                }
            });
            var Pe = function(t) {
                if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration)
                    for (var e, i = "all" === this.e, r = this.t.style, n = i ? r.cssText.split(";") : this.e.split(","), o = n.length, s = a.transform.parse; --o > -1;) e = n[o], i && (e = e.substr(0, e.indexOf(":")).split(" ").join("")), a[e] && (e = a[e].parse === s ? xe : a[e].p), Me(r, e)
            };
            for (ve("clearProps", {
                    parser: function(t, e, r, n, o) {
                        return o = new de(t, r, 0, 0, o, 2), o.setRatio = Pe, o.e = e, o.pr = -10, o.data = n._tween, i = !0, o
                    }
            ...
            h = s.prototype, h._firstPT = null, h._onInitTween = function(t, e, a) {
                ...
                this._target = t, this._tween = a, this._vars = e, l = e.autoRound, i = !1, r = e.suffixMap || s.suffixMap, n = H(t, ""), o = this._overwriteProps;
                var h, d, f, m, v, g, y, x, _, w = t.style;
                if (u && "" === w.zIndex && (h = V(t, "zIndex", n), ("auto" === h || "" === h) && (w.zIndex = 0)), "string" == typeof e && (m = w.cssText, h = Q(t, n), w.cssText = m + ";" + e, h = $(t, h, Q(t)).difs, !X && b.test(e) && (h.opacity = parseFloat(RegExp.$1)), e = h, w.cssText = m), this._firstPT = d = this.parse(t, e, null), this._transformType) {
                    for (_ = 3 === this._transformType, xe ? c && (u = !0, "" === w.zIndex && (y = V(t, "zIndex", n), ("auto" === y || "" === y) && (w.zIndex = 0)), p && (w.WebkitBackfaceVisibility = this._vars.WebkitBackfaceVisibility || (_ ? "visible" : "hidden"))) : w.zoom = 1, f = d; f && f._next;) f = f._next;
                    x = new de(t, "transform", 0, 0, null, 2), this._linkCSSP(x, null, f), x.setRatio = _ && we ? Ee : xe ? Ae : Se, x.data = this._transform || Te(t, n, !0), o.pop()
                }
                if (i) {
                    for (; d;) {
                        for (g = d._next, f = m; f && f.pr > d.pr;) f = f._next;
                        (d._prev = f ? f._prev : v) ? d._prev._next = d: m = d, (d._next = f) ? f._prev = d : v = d, d = g
                    }
                    this._firstPT = m
                }
                return !0
            }, h.parse = function(t, e, i, o) {
                var s, h, u, c, d, p, f, m, v, g, y = t.style;
                for (s in e) p = e[s], h = a[s], h ? i = h.parse(t, p, s, this, i, o, e) : (d = V(t, s, n) + "", v = "string" == typeof p, "color" === s || "fill" === s || "stroke" === s || -1 !== s.indexOf("Color") || v && T.test(p) ? (v || (p = ae(p), p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"), i = pe(y, s, d, p, !0, "transparent", i, 0, o)) : !v || -1 === p.indexOf(" ") && -1 === p.indexOf(",") ? (u = parseFloat(d), f = u || 0 === u ? d.substr((u + "").length) : "", ("" === d || "auto" === d) && ("width" === s || "height" === s ? (u = te(t, s, n), f = "px") : "left" === s || "top" === s ? (u = K(t, s, n), f = "px") : (u = "opacity" !== s ? 0 : 1, f = "")), g = v && "=" === p.charAt(1), g ? (c = parseInt(p.charAt(0) + "1", 10), p = p.substr(2), c *= parseFloat(p), m = p.replace(x, "")) : (c = parseFloat(p), m = v ? p.substr((c + "").length) || "" : ""), "" === m && (m = r[s] || f), p = c || 0 === c ? (g ? c + u : c) + m : e[s], f !== m && "" !== m && (c || 0 === c) && (u || 0 === u) && (u = q(t, s, u, f), "%" === m ? (u /= q(t, s, 100, "%") / 100, u > 100 && (u = 100), e.strictUnits !== !0 && (d = u + "%")) : "em" === m ? u /= q(t, s, 1, "em") : (c = q(t, s, c, m), m = "px"), g && (c || 0 === c) && (p = c + u + m)), g && (c += u), !u && 0 !== u || !c && 0 !== c ? p || "NaN" != p + "" && null != p ? (i = new de(y, s, c || u || 0, 0, i, -1, "css_" + s, !1, 0, d, p), i.xs0 = "none" !== p || "display" !== s && -1 === s.indexOf("Style") ? p : d) : z("invalid " + s + " tween value: " + e[s]) : (i = new de(y, s, u, c - u, i, 0, "css_" + s, l !== !1 && ("px" === m || "zIndex" === s), 0, d, p), i.xs0 = m)) : i = pe(y, s, d, p, !0, null, i, 0, o)), o && i && !i.plugin && (i.plugin = o);
                return i
                ...
                if (1 !== t || this._tween._time !== this._tween._duration && 0 !== this._tween._time)
                    if (t || this._tween._time !== this._tween._duration && 0 !== this._tween._time || this._tween._rawPrevTime === -1e-6)
                        for (; n;) {
                            if (e = n.c * t + n.s, n.r ? e = e > 0 ? 0 | e + .5 : 0 | e - .5 : o > e && e > -o && (e = 0), n.type)
                                if (1 === n.type)
                ...
                return t && (e && (e._prev = t), t._next && (t._next._prev = t._prev), i ? i._next = t : r || null !== this._firstPT || (this._firstPT = t), t._prev ? t._prev._next = t._next : this._firstPT === t && (this._firstPT = t._next), t._next = e, t._prev = i), t
            }, h._kill = function(e) {
                var i, r, n, o = e;
                ...
                return e.css_className && (i = this._classNamePT) && (n = i.xfirst, n && n._prev ? this._linkCSSP(n._prev, i._next, n._prev._prev) : n === this._firstPT && (this._firstPT = i._next), i._next && this._linkCSSP(i._next, i._next._next, n._prev), this._classNamePT = null), t.prototype._kill.call(this, o)
            };
            var Oe = function(t, e, i) {
                var r, n, o, s;
                if (t.slice)
                    for (n = t.length; --n > -1;) Oe(t[n], e, i);
                else
                    for (r = t.childNodes, n = r.length; --n > -1;) o = r[n], s = o.type, o.style && (e.push(Q(o)), i && i.push(o)), 1 !== s && 9 !== s && 11 !== s || !o.childNodes.length || Oe(o, e, i)
            };
            return s.cascadeTo = function(t, i, r) {
                var n, o, s, a = e.to(t, i, r),
                    h = [a],
                    l = [],
                    u = [],
                    c = [],
                    d = e._internals.reservedProps;
                for (t = a._targets || a.target, Oe(t, l, c), a.render(i, !0), Oe(t, u), a.render(0, !0), a._enabled(!0), n = c.length; --n > -1;)
    ...
    }), window._gsDefine && window._gsQueue.pop()(), define("CSSPACK", function() {}), ! function() {
        var t = {},
            e = null,
            i = !0,
            r = !1;
                ...
                if (t = parseFloat(t), t && t >= 0 && 1 >= t) {
                    ...
                    for (var r in e._howls)
                        if (e._howls.hasOwnProperty(r) && e._howls[r]._webAudio === !1)
                            for (var n = 0; n < e._howls[r]._audioNode.length; n++) e._howls[r]._audioNode[n].volume = e._howls[r]._volume * e._volume;
                    return e
                }
        ...
        if (u.prototype = {
                load: function() {
                    ...
                    for (var n = 0; n < e._urls.length; n++) {
                        ...
                        if (e._format) o = e._format;
                            ...
                            if (s = e._urls[n].toLowerCase().split("?")[0], o = s.match(/.+\.([^?]+)(\?|$)/), o = o && o.length >= 2 ? o : s.match(/data\:audio\/([^?]+);/), !o) return void e.on("loaderror");
                            o = o[1]
                        }
                        if (l[o]) {
                            i = e._urls[n];
                    ...
                    if (e._src = i, e._webAudio) c(e, i);
                        ...
                        var h = new Audio;
                        e._audioNode.push(h), h.src = i, h._pos = 0, h.preload = "auto", h.volume = a._muted ? 0 : e._volume * a.volume(), t[i] = e;
                        var u = function() {
                            e._duration = h.duration, 0 === Object.getOwnPropertyNames(e._sprite).length && (e._sprite = {
                                _default: [0, 1e3 * e._duration]
                            }), e._loaded || (e._loaded = !0, e.on("load")), e._autoplay && e.play(), h.removeEventListener("canplaythrough", u, !1)
                        };
                ...
                play: function(t, i) {
                    var r = this;
                    return "function" == typeof t && (i = t), t && "function" != typeof t || (t = "_default"), r._loaded ? r._sprite[t] ? (r._inactiveNode(function(n) {
                        n._sprite = t;
                        var o, s = n._pos > 0 ? n._pos : r._sprite[t][0] / 1e3,
                        ...
                        if (function() {
                                ...
                                o = setTimeout(function() {
                                    !r._webAudio && l && r.stop(e.id, e.timer).play(t, e.id), r._webAudio && !l && (r._nodeById(e.id).paused = !0), r._webAudio || l || r.stop(e.id, e.timer), r.on("end", u)
                                }, 1e3 * h), r._onendTimer.push(o), e.timer = r._onendTimer[r._onendTimer.length - 1]
                            }(), r._webAudio) {
                            var c = r._sprite[t][0] / 1e3,
                                d = r._sprite[t][1] / 1e3;
                            n.id = u, n.paused = !1, p(r, [l, c, d], u), r._playStart = e.currentTime, n.gain.value = r._volume, void 0 === n.bufferSource.start ? n.bufferSource.noteGrainOn(0, s, h) : n.bufferSource.start(0, s, h)
                        } else {
                            if (4 !== n.readyState) return r._clearEndTimer(o),
                                function() {
                                    var e = r,
                                        o = t,
                                        s = i,
                            ...
                            n.id = u, n.currentTime = s, n.muted = a._muted, n.volume = r._volume * a.volume(), setTimeout(function() {
                                n.play()
                            }, 0)
                        }
                        return r.on("play"), "function" == typeof i && i(u), r
                    }), r) : ("function" == typeof i && i(), r) : (r.on("load", function() {
                        r.play(t, i)
                    }), r)
                },
                pause: function(t, e) {
                ...
                volume: function(t, e) {
                    ...
                    if (t = parseFloat(t), t >= 0 && 1 >= t) {
                        if (i._volume = t, !i._loaded) return i.on("play", function() {
                            i.volume(t, e)
                        }), i;
                ...
                pos: function(t, i) {
                    ...
                    if (n) return r._webAudio ? t >= 0 ? (n._pos = t, r.pause(i).play(n._sprite, i), r) : n._pos + (e.currentTime - r._playStart) : t >= 0 ? (n.currentTime = t, r) : n.currentTime;
                    if (t >= 0) return r;
                    for (var o = 0; o < r._audioNode.length; o++)
                        if (r._audioNode[o].paused && 4 === r._audioNode[o].readyState) return r._webAudio ? r._audioNode[o]._pos : r._audioNode[o].currentTime
                },
                pos3d: function(t, e, i, r) {
                    var n = this;
                    if (e = void 0 !== e && e ? e : 0, i = void 0 !== i && i ? i : -.5, !n._loaded) return n.on("play", function() {
                        n.pos3d(t, e, i, r)
                    }), n;
                ...
                fade: function(t, e, i, r, n) {
                    ...
                    o.volume(t, n);
                    for (var u = 1; h >= u; u++) ! function() {
                        var t = o._volume + ("up" === a ? .01 : -.01) * u,
                ...
                fadeOut: function(t, e, i, r) {
                    var n = this;
                    return n.fade(n._volume, t, e, function() {
                ...
                _inactiveNode: function(t) {
                    ...
                    if (e._drainPool(), !i) {
                        var n;
                        e._webAudio ? (n = e._setupAudioNode(), t(n)) : (e.load(), n = e._audioNode[e._audioNode.length - 1], n.addEventListener("loadedmetadata", function() {
                            t(n)
                        }))
                    }
                },
                _drainPool: function() {
                    ...
                    for (t = e._audioNode.length - 1; t >= 0 && !(5 >= i); t--) e._audioNode[t].paused && (e._webAudio && e._audioNode[t].disconnect(0), i--, e._audioNode.splice(t, 1))
                },
                ...
                _setupAudioNode: function() {
                    ...
                    return i[r] = void 0 === e.createGain ? e.createGainNode() : e.createGain(), i[r].gain.value = t._volume, i[r].paused = !0, i[r]._pos = 0, i[r].readyState = 4, i[r].connect(o), i[r].panner = e.createPanner(), i[r].panner.setPosition(t._pos3d[0], t._pos3d[1], t._pos3d[2]), i[r].panner.connect(i[r]), i[r]
                },
                on: function(t, e) {
                    var i = this,
                        r = i["_on" + t];
                    if ("function" == typeof e) r.push(e);
                        ...
                        for (var n = 0; n < r.length; n++) e ? r[n].call(i, e) : r[n].call(i);
                    return i
                },
                off: function(t, e) {
                ...
                unload: function() {
                    for (var e = this, i = e._audioNode, r = 0; r < e._audioNode.length; r++) e.stop(i[r].id), e._webAudio ? i[r].disconnect(0) : i[r].src = "";
                    var n = a._howls.indexOf(e);
                    n && a._howls.splice(n, 1), delete t[e._src], e = null
                }
            }, i) var c = function(i, r) {
            ...
            p = function(i, r, n) {
                var o = i._nodeById(n);
                o.bufferSource = e.createBufferSource(), o.bufferSource.buffer = t[i._src], o.bufferSource.connect(o.panner), o.bufferSource.loop = r[0], r[0] && (o.bufferSource.loopStart = r[1], o.bufferSource.loopEnd = r[1] + r[2]), o.bufferSource.playbackRate.value = i._rate
            };
        ...
        }), window.Howler = a, window.Howl = u
    }(), ! function(t) {
        if ("object" == typeof exports && "undefined" != typeof module) module.exports = t();
        else if ("function" == typeof define && define.amd) define("PIXI", [], t);
        else {
            var e;
            "undefined" != typeof window ? e = window : "undefined" != typeof global ? e = global : "undefined" != typeof self && (e = self), e.PIXI = t()
        }
    }(function() {
        var t;
        return function e(t, i, r) {
            ...
            1: [function(t, e) {
                ...
                i.extras = t("./extras"), i.filters = t("./filters"), i.interaction = t("./interaction"), i.loaders = t("./loaders"), i.spine = t("./spine"), i.text = t("./text"), i.Text = i.text.Text, i.Point = i.math.Point, i.Rectangle = i.math.Rectangle, i.Matrix = i.math.Matrix, i.blendModes = i.CONST.BLEND_MODES;
                var r = 0;
                i.Circle = i.math.Circle, i.loaders.Loader.prototype.addList = function(t) {
                ...
                (function(e) {
                    ! function() {
                        ...
                        "undefined" != typeof e && e.nextTick ? (s.nextTick = e.nextTick, s.setImmediate = "undefined" != typeof setImmediate ? function(t) {
                            ...
                            setTimeout(t, 0)
                        }, s.setImmediate = s.nextTick), s.each = function(t, e, i) {
                            function n(e) {
                            ...
                            n()
                        }, s.forEachSeries = s.eachSeries, s.eachLimit = function(t, e, i, r) {
                            var n = p(e);
                            n.apply(null, [t, i, r])
                        ...
                        var p = function(t) {
                                return function(e, i, r) {
                                    ...
                                    ! function a() {
                                        ...
                                        for (; t > s && o < e.length;) o += 1, s += 1, i(e[o - 1], function(t) {
                        ...
                        s.map = f(g), s.mapSeries = v(g), s.mapLimit = function(t, e, i, r) {
                            return y(e)(t, i, r)
                        };
                        var y = function(t) {
                            return m(t, g)
                        ...
                        }, s.inject = s.reduce, s.foldl = s.reduce, s.reduceRight = function(t, e, i, r) {
                        ...
                        s.detect = f(b), s.detectSeries = v(b), s.some = function(t, e, i) {
                                ...
                                return function(i) {
                                    if (i) e.apply(null, arguments), e = function() {};
                                        ...
                                        var n = Array.prototype.slice.call(arguments, 1),
                                            o = t.next();
                                        n.push(o ? r(o) : e), s.setImmediate(function() {
                                            t.apply(null, n)
                                        })
                                    }
                                }
                        ...
                        s.concat = f(T), s.concatSeries = v(T), s.whilst = function(t, e, i) {
                            t() ? e(function(r) {
                            ...
                            function i(t, e, i, r) {
                                return t.started || (t.started = !0), h(e) || (e = [e]), 0 == e.length ? s.setImmediate(function() {
                                    ...
                                    i ? t.tasks.unshift(n) : t.tasks.push(n), t.saturated && t.tasks.length === t.concurrency && t.saturated(), s.setImmediate(t.process)
                                })
                            }
                            void 0 === e && (e = 1);
                            var n = 0,
                            ...
                            function n(t, e, n, o) {
                                return t.started || (t.started = !0), h(e) || (e = [e]), 0 == e.length ? s.setImmediate(function() {
                                    ...
                                    t.tasks.splice(r(t.tasks, a, i) + 1, 0, a), t.saturated && t.tasks.length === t.concurrency && t.saturated(), s.setImmediate(t.process)
                                })
                            }
                            var o = s.queue(t, e);
                        ...
                        var S = function(t) {
                            return function(e) {
                                ...
                                e.apply(null, i.concat([function(e) {
                                    var i = Array.prototype.slice.call(arguments, 1);
                                    "undefined" != typeof console && (e ? console.error && void 0 : console[t] && l(i, function(t) {}))
                                }]))
                            }
                        };
                        s.log = S("log"), s.dir = S("dir"), s.memoize = function(t, e) {
                            ...
                            var n = function() {
                                var n = Array.prototype.slice.call(arguments),
                                    o = n.pop(),
                                    a = e.apply(null, n);
                                a in i ? s.nextTick(function() {
                                    o.apply(null, i[a])
                                }) : a in r ? r[a].push(o) : (r[a] = [o], t.apply(null, n.concat([function() {
                                    i[a] = arguments;
                                    var t = r[a];
                                    delete r[a];
                        ...
                        s.applyEach = f(E), s.applyEachSeries = v(E), s.forever = function(t, e) {
                            function i(r) {
                                if (r) {
                                    if (e) return e(r);
                                    throw r
                            ...
                            i()
                        }, "undefined" != typeof i && i.exports ? i.exports = s : "undefined" != typeof t && t.amd ? t([], function() {
                            return s
                        }) : n.async = s
                    }()
            ...
            3: [function(t, e, i) {
                (function(t) {
                    ...
                    i.resolve = function() {
                        ...
                        return i.normalize(r(t, function(t) {
                        ...
                        for (var n = r(t.split("/")), o = r(e.split("/")), s = Math.min(n.length, o.length), a = s, h = 0; s > h; h++)
                            if (n[h] !== o[h]) {
                                a = h;
                                break
                            }
            ...
            4: [function(t, e) {
                ...
                }, n.title = "browser", n.browser = !0, n.env = {}, n.argv = [], n.version = "", n.on = r, n.addListener = r, n.once = r, n.off = r, n.removeListener = r, n.removeAllListeners = r, n.emit = r, n.binding = function() {
            ...
            5: [function(e, i, r) {
                ! function() {
                    ...
                    function o(t, e, i, r) {
                        ...
                        if ("*" === f || "**" === f || i[f]) {
                            ...
                            if ("**" === f) {
                                ...
                                for (a in i) "_listeners" !== a && i.hasOwnProperty(a) && ("*" === a || "**" === a ? (i[a]._listeners && !c && (d = d.concat(o(t, e, i[a], p))), d = d.concat(o(t, e, i[a], r))) : d = d.concat(a === m ? o(t, e, i[a], r + 2) : o(t, e, i[a], r)));
                                return d
                            }
                        ...
                        if (h = i["*"], h && o(t, e, h, r + 1), l = i["**"])
                            if (p > r) {
                                ...
                                for (a in l) "_listeners" !== a && l.hasOwnProperty(a) && (a === m ? o(t, e, l[a], r + 2) : a === f ? o(t, e, l[a], r + 1) : (u = {}, u[a] = l[a], o(t, e, {
                                    "**": u
                                }, r + 1)))
                    ...
                    function s(t, e) {
                        ...
                        for (var i = 0, r = t.length; r > i + 1; i++)
                            if ("**" === t[i] && "**" === t[i + 1]) return;
                            ...
                            if (n[o] || (n[o] = {}), n = n[o], 0 === t.length) {
                                if (n._listeners) {
                                    if ("function" == typeof n._listeners) n._listeners = [n._listeners, e];
                                        ...
                                        var s = h;
                                        "undefined" != typeof this._events.maxListeners && (s = this._events.maxListeners), s > 0 && n._listeners.length > s && void(n._listeners.warned = !0)
                                    }
                                } else n._listeners = e;
                                return !0
                            }
                    ...
                    var a = Array.isArray ? Array.isArray : function(t) {
                        ...
                        h = 10;
                    n.prototype.delimiter = ".", n.prototype.setMaxListeners = function(t) {
                        this._events || e.call(this), this._events.maxListeners = t, this._conf || (this._conf = {}), this._conf.maxListeners = t
                    }, n.prototype.event = "", n.prototype.once = function(t, e) {
                        ...
                        if (this._events[t]) {
                            if ("function" == typeof this._events[t]) this._events[t] = [this._events[t], i];
                                ...
                                var r = h;
                                "undefined" != typeof this._events.maxListeners && (r = this._events.maxListeners), r > 0 && this._events[t].length > r && void(this._events[t].warned = !0)
                            }
                    ...
                    }, n.prototype.addListener = n.prototype.on, n.prototype.off = function(t, e) {
                        ...
                        for (var s = 0; s < r.length; s++) {
                            ...
                            if (i = h._listeners, a(i)) {
                                ...
                                if (0 > l) continue;
                                return this.wildcard ? h._listeners.splice(l, 1) : this._events[t].splice(l, 1), 0 === i.length && (this.wildcard ? delete h._listeners : delete this._events[t]), this
                            }(i === e || i.listener && i.listener === e || i._origin && i._origin === e) && (this.wildcard ? delete h._listeners : delete this._events[t])
                        }
                        return this
                        ...
                        if (t && this._all && this._all.length > 0) {
                            for (e = this._all, i = 0, r = e.length; r > i; i++)
                                if (t === e[i]) return e.splice(i, 1), this
                        } else this._all = [];
                        return this
                    }, n.prototype.removeListener = n.prototype.off, n.prototype.removeAllListeners = function(t) {
                        if (0 === arguments.length) return !this._events || e.call(this), this;
                        if (this.wildcard)
                            for (var i = "string" == typeof t ? t.split(this.delimiter) : t.slice(), r = o.call(this, null, i, this.listenerTree, 0), n = 0; n < r.length; n++) {
                                var s = r[n];
                                s._listeners = null
                            } else {
                                if (!this._events[t]) return this;
                        ...
                        return n
                    }) : "object" == typeof r ? r.EventEmitter2 = n : window.EventEmitter2 = n
                }()
            }, {}],
            6: [function(t, e) {
                function i(t, e) {
                    o.call(this), e = e || 10, this.baseUrl = t || "", this.progress = 0, this.loading = !1, this._progressChunk = 0, this._beforeMiddleware = [], this._afterMiddleware = [], this._boundLoadResource = this.loadResource.bind(this), this._boundOnComplete = this._onComplete.bind(this), this._buffer = [], this.queue = r.queue(this._boundLoadResource, e), this.resources = {}
                }
                var r = t("async"),
                    n = t("./Resource"),
                    o = t("eventemitter2").EventEmitter2;
                i.prototype = Object.create(o.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.add = i.prototype.enqueue = function(t, e, i, r) {
                    if ("function" == typeof i && (r = i, i = null), this.resources[t]) throw new Error('Resource with name "' + t + '" already exists.');
                    return this.resources[t] = new n(t, this.baseUrl + e, i), "function" == typeof r && this.resources[t].once("afterMiddleware", r), this.queue.started ? (this.queue.push(this.resources[t]), this._progressChunk = (100 - this.progress) / (this.queue.length() + this.queue.running())) : (this._buffer.push(this.resources[t]), this._progressChunk = 100 / this._buffer.length), this
                }, i.prototype.before = i.prototype.pre = function(t) {
                    return this._beforeMiddleware.push(t), this
                }, i.prototype.after = i.prototype.use = function(t) {
                    return this._afterMiddleware.push(t), this
                }, i.prototype.reset = function() {
                    this._buffer.length = 0, this.queue.kill(), this.queue.started = !1, this.progress = 0, this._progressChunk = 0, this.loading = !1
                ...
                }, i.LOAD_TYPE = n.LOAD_TYPE, i.XHR_READY_STATE = n.XHR_READY_STATE, i.XHR_RESPONSE_TYPE = n.XHR_RESPONSE_TYPE
            }, {
                "./Resource": 7,
                async: 2,
                eventemitter2: 5
            ...
            7: [function(t, e) {
                function i(t, e, r) {
                    if (n.call(this), r = r || {}, "string" != typeof t || "string" != typeof e) throw new Error("Both name and url are required for constructing a resource.");
                    this.name = t, this.url = e, this.data = null, this.crossOrigin = r.crossOrigin, this.loadType = r.loadType || i.LOAD_TYPE.XHR, this.xhrType = r.xhrType, this.error = null, this.xhr = null, this._boundComplete = this.complete.bind(this), this._boundOnError = this._onError.bind(this), this._boundOnProgress = this._onProgress.bind(this), this._boundXhrOnError = this._xhrOnError.bind(this), this._boundXhrOnAbort = this._xhrOnAbort.bind(this), this._boundXhrOnLoad = this._xhrOnLoad.bind(this), this._boundXdrOnTimeout = this._xdrOnTimeout.bind(this)
                }
                ...
                i.prototype = Object.create(n.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.complete = function() {
                    ...
                    switch (this.emit("start", this), "string" != typeof this.crossOrigin && (this.crossOrigin = this._determineCrossOrigin()), this.loadType) {
                    ...
                    this.data = new Image, this.crossOrigin && (this.data.crossOrigin = ""), this.data.src = this.url, this.data.addEventListener("error", this._boundOnError, !1), this.data.addEventListener("load", this._boundComplete, !1), this.data.addEventListener("progress", this._boundOnProgress, !1)
                    ...
                    t.open("GET", this.url, !0), t.responseType = this.xhrType, t.addEventListener("error", this._boundXhrOnError, !1), t.addEventListener("abort", this._boundXhrOnAbort, !1), t.addEventListener("progress", this._boundOnProgress, !1), t.addEventListener("load", this._boundXhrOnLoad, !1), t.send()
                }, i.prototype._loadXdr = function() {
                    var t = this.xhr = new XDomainRequest;
                    t.timeout = 5e3, t.onerror = this._boundXhrOnError, t.ontimeout = this._boundXdrOnTimeout, t.onprogress = this._boundOnProgress, t.onload = this._boundXhrOnLoad
                    ...
                    this.error = new Error(r(t.target) + " Request failed. Status: " + t.target.status + ', text: "' + t.target.statusText + '"'), this.complete()
                    ...
                    var e = t.target;
                    200 === e.status ? this.data = this.xhrType === i.XHR_RESPONSE_TYPE.TEXT ? e.responseText : this.xhrType === i.XHR_RESPONSE_TYPE.DOCUMENT ? e.responseXML || e.response : e.response : this.error = new Error(e.responseText), this.complete()
                }, i.prototype._determineCrossOrigin = function() {
                    if (0 === this.url.indexOf("data:")) return "";
                    var t = window.location,
                        e = document.createElement("a");
                    return e.href = this.url, e.hostname !== t.hostname || e.port !== t.port || e.protocol !== t.protocol ? "anonymous" : ""
            ...
            8: [function(t, e) {
                e.exports = t("./Loader"), e.exports.Resource = t("./Resource"), e.exports.middleware = {
                    ...
                    parsing: {
                        json: t("./middlewares/parsing/json"),
                    ...
                    return function(t, e) {
                        if (t.xhr && t.xhrType === i.XHR_RESPONSE_TYPE.BLOB) {
                            if (0 === t.data.type.indexOf("image")) {
                                ...
                                t.data = new Image, t.data.src = r, t.data.onload = function() {
            ...
            14: [function(t, e) {
                ...
                i.prototype = Object.create(n.prototype), i.prototype.constructor = i, e.exports = i, Object.defineProperties(i.prototype, {
                    ...
                    if (!this._currentBounds) {
                        ...
                        for (var t, e, i, n = 1 / 0, o = 1 / 0, s = -1 / 0, a = -1 / 0, h = !1, l = 0, u = this.children.length; u > l; ++l) {
                            var c = this.children[l];
                            c.visible && (h = !0, t = this.children[l].getBounds(), n = n < t.x ? n : t.x, o = o < t.y ? o : t.y, e = t.width + t.x, i = t.height + t.y, s = s > e ? s : e, a = a > i ? a : i)
                        }
                ...
                }, i.prototype._renderWebGL = function() {}, i.prototype.renderCanvas = function(t) {
            ...
            15: [function(t, e) {
                function i() {
                    this.position = new r.Point, this.scale = new r.Point(1, 1), this.pivot = new r.Point(0, 0), this.rotation = 0, this.alpha = 1, this.visible = !0, this.renderable = !0, this.parent = null, this.worldAlpha = 1, this.worldTransform = new r.Matrix, this.filterArea = null, this._sr = 0, this._cr = 1, this._bounds = new r.Rectangle(0, 0, 1, 1), this._currentBounds = null, this._mask = null, this._cacheAsBitmap = !1, this._cachedObject = null
                }
                var r = t("../math"),
                    n = t("../utils"),
                    o = t("../textures/RenderTexture"),
                    s = new r.Matrix;
                i.prototype.constructor = i, n.eventTarget.mixin(i.prototype), e.exports = i, Object.defineProperties(i.prototype, {
                    x: {
                        get: function() {
                    ...
                    this.rotation % r.PI_2 ? (this.rotation !== this.rotationCache && (this.rotationCache = this.rotation, this._sr = Math.sin(this.rotation), this._cr = Math.cos(this.rotation)), t = this._cr * this.scale.x, e = this._sr * this.scale.x, i = -this._sr * this.scale.y, n = this._cr * this.scale.y, o = this.position.x, s = this.position.y, (this.pivot.x || this.pivot.y) && (o -= this.pivot.x * t + this.pivot.y * i, s -= this.pivot.x * e + this.pivot.y * n), h.a = t * a.a + e * a.c, h.b = t * a.b + e * a.d, h.c = i * a.a + n * a.c, h.d = i * a.b + n * a.d, h.tx = o * a.a + s * a.c + a.tx, h.ty = o * a.b + s * a.d + a.ty) : (t = this.scale.x, n = this.scale.y, o = this.position.x - this.pivot.x * t, s = this.position.y - this.pivot.y * n, h.a = t * a.a, h.b = t * a.b, h.c = n * a.c, h.d = n * a.d, h.tx = o * a.a + s * a.c + a.tx, h.ty = o * a.b + s * a.d + a.ty), this.worldAlpha = this.alpha * this.parent.worldAlpha, this._currentBounds = null
                }, i.prototype.displayObjectUpdateTransform = i.prototype.updateTransform, i.prototype.getBounds = function() {
                ...
                }, i.prototype.renderWebGL = function() {}, i.prototype.renderCanvas = function() {}, i.prototype.generateTexture = function(t, e, i) {
                    var r = this.getLocalBounds(),
                        n = new o(t, 0 | r.width, 0 | r.height, t, i, e);
                    return s.tx = -r.x, s.ty = -r.y, n.render(this, s), n
                }
            ...
            16: [function(t, e) {
                function i() {
                    r.call(this), this.fillAlpha = 1, this.lineWidth = 0, this.lineColor = 0, this.graphicsData = [], this.tint = 16777215, this.blendMode = u.BLEND_MODES.NORMAL, this.currentPath = null, this._webGL = {}, this.isMask = !1, this.boundsPadding = 0, this._localBounds = new l.Rectangle(0, 0, 1, 1), this.dirty = !0, this.glDirty = !1, this.cachedSpriteDirty = !1
                }
                var r = t("../display/Container"),
                    ...
                    l = t("../math"),
                    u = t("../const");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, Object.defineProperties(i.prototype, {}), h.prototype.clone = function() {
                    var t = new i;
                    ...
                    return this.lineWidth = t || 0, this.lineColor = e || 0, this.lineAlpha = arguments.length < 3 ? 1 : i, this.currentPath && (this.currentPath.shape.points.length ? this.drawShape(new l.Polygon(this.currentPath.shape.points.slice(-2))) : (this.currentPath.lineWidth = this.lineWidth, this.currentPath.lineColor = this.lineColor, this.currentPath.lineAlpha = this.lineAlpha)), this
                    ...
                    for (var h = a[a.length - 2], l = a[a.length - 1], u = 0, c = 1; s >= c; ++c) u = c / s, n = h + (t - h) * u, o = l + (e - l) * u, a.push(n + (t + (i - t) * u - n) * u, o + (e + (r - e) * u - o) * u);
                    return this.dirty = !0, this
                }, i.prototype.bezierCurveTo = function(t, e, i, r, n, o) {
                    this.currentPath ? 0 === this.currentPath.shape.points.length && (this.currentPath.shape.points = [0, 0]) : this.moveTo(0, 0);
                    for (var s, a, h, l, u, c = 20, d = this.currentPath.shape.points, p = d[d.length - 2], f = d[d.length - 1], m = 0, v = 1; c >= v; ++v) m = v / c, s = 1 - m, a = s * s, h = a * s, l = m * m, u = l * m, d.push(h * p + 3 * a * m * t + 3 * s * l * i + u * n, h * f + 3 * a * m * e + 3 * s * l * r + u * o);
                    return this.dirty = !0, this
                    ...
                    if (0 === l) return this;
                    for (var c = l / (2 * u), d = 2 * c, p = Math.cos(c), f = Math.sin(c), m = u - 1, v = m % 1 / m, g = 0; m >= g; g++) {
                        var y = g + v * g,
                            x = c + r + d * y,
                            _ = Math.cos(x),
                            b = -Math.sin(x);
                    ...
                    return t instanceof Array || (t = Array.prototype.slice.call(arguments)), this.drawShape(new l.Polygon(t)), this
                    ...
                    return n.baseTexture.resolution = t, r.context.scale(t, t), r.context.translate(-i.x, -i.y), a.renderGraphics(this, r.context), n
                    ...
                    if (this.visible && !(this.alpha <= 0) && this.isMask !== !0 && this.renderable) {
                        if (this._cacheAsBitmap) return (this.dirty || this.cachedSpriteDirty) && (this._generateCachedSprite(), this.updateCachedSpriteTexture(), this.cachedSpriteDirty = !1, this.dirty = !1), this._cachedSprite.alpha = this.alpha, void n.prototype.renderCanvas.call(this._cachedSprite, t);
                        var e = t.context,
                            i = this.worldTransform;
                        this.blendMode !== t.currentBlendMode && (t.currentBlendMode = this.blendMode, e.globalCompositeOperation = t.blendModes[t.currentBlendMode]), this._mask && t.maskManager.pushMask(this._mask, t);
                        var r = t.resolution;
                    ...
                    if (!this._currentBounds) {
                        ...
                        this.dirty && (this.updateLocalBounds(), this.glDirty = !0, this.cachedSpriteDirty = !0, this.dirty = !1);
                        var e = this._localBounds,
                            ...
                            S = f,
                            E = m;
                        S = S > v ? v : S, S = S > y ? y : S, S = S > _ ? _ : S, E = E > g ? g : E, E = E > x ? x : E, E = E > b ? b : E, w = v > w ? v : w, w = y > w ? y : w, w = _ > w ? _ : w, T = g > T ? g : T, T = x > T ? x : T, T = b > T ? b : T, this._bounds.x = S, this._bounds.width = w - S, this._bounds.y = E, this._bounds.height = T - E, this._currentBounds = this._bounds
                    }
                    return this._currentBounds
                    ...
                    if (this.graphicsData.length)
                        for (var n, o, s, a, h, l, c = 0; c < this.graphicsData.length; c++) {
                            var d = this.graphicsData[c],
                                p = d.type,
                                f = d.lineWidth;
                            if (n = d.shape, p === u.SHAPES.RECT || p === u.SHAPES.RREC) s = n.x - f / 2, a = n.y - f / 2, h = n.width + f, l = n.height + f, t = t > s ? s : t, e = s + h > e ? s + h : e, i = i > a ? a : i, r = a + l > r ? a + l : r;
                            else if (p === u.SHAPES.CIRC) s = n.x, a = n.y, h = n.radius + f / 2, l = n.radius + f / 2, t = t > s - h ? s - h : t, e = s + h > e ? s + h : e, i = i > a - l ? a - l : i, r = a + l > r ? a + l : r;
                            else if (p === u.SHAPES.ELIP) s = n.x, a = n.y, h = n.width + f / 2, l = n.height + f / 2, t = t > s - h ? s - h : t, e = s + h > e ? s + h : e, i = i > a - l ? a - l : i, r = a + l > r ? a + l : r;
                            else {
                                o = n.points;
                                for (var m = 0; m < o.length; m += 2) s = o[m], a = o[m + 1], t = t > s - f ? s - f : t, e = s + f > e ? s + f : e, i = i > a - f ? a - f : i, r = a + f > r ? a + f : r
                            }
                    ...
                    return this.graphicsData.push(e), e.type === u.SHAPES.POLY && (e.shape.closed = this.filling, this.currentPath = e), this.dirty = !0, e
                }
            }, {
                "../const": 13,
            ...
            18: [function(t, e) {
                function i(t) {
                    s.call(this, t), this.graphicsDataPool = [], this.primitiveShader = null, this.complexPrimitiveShader = null
                }
                var r = t("../../utils"),
                    n = t("../../math"),
                    o = t("../../const"),
                ...
                i.prototype = Object.create(s.prototype), i.prototype.constructor = i, e.exports = i, a.registerPlugin("graphics", i), i.prototype.onContextChange = function() {}, i.prototype.destroy = function() {
                    ...
                    var i;
                    return t.data.length ? (i = t.data[t.data.length - 1], (i.points.length > 32e4 || i.mode !== e || 1 === e) && (i = this.graphicsDataPool.pop() || new h(t.gl), i.mode = e, t.data.push(i))) : (i = this.graphicsDataPool.pop() || new h(t.gl), i.mode = e, t.data.push(i)), i.dirty = !0, i
                    ...
                    if (t.fill) {
                        var h = r.hex2rgb(t.fillColor),
                            ...
                            f = e.indices,
                            m = p.length / 6;
                        p.push(n, o), p.push(u, c, d, l), p.push(n + s, o), p.push(u, c, d, l), p.push(n, o + a), p.push(u, c, d, l), p.push(n + s, o + a), p.push(u, c, d, l), f.push(m, m, m + 1, m + 2, m + 3, m + 3)
                    }
                    if (t.lineWidth) {
                        var v = t.points;
                    ...
                    var i = t.shape,
                        ...
                        h = i.radius,
                        l = [];
                    if (l.push(n, o + h), l = l.concat(this.quadraticBezierCurve(n, o + a - h, n, o + a, n + h, o + a)), l = l.concat(this.quadraticBezierCurve(n + s - h, o + a, n + s, o + a, n + s, o + a - h)), l = l.concat(this.quadraticBezierCurve(n + s, o + h, n + s, o, n + s - h, o)), l = l.concat(this.quadraticBezierCurve(n + h, o, n, o, n, o + h)), t.fill) {
                        var u = r.hex2rgb(t.fillColor),
                            ...
                            x = 0;
                        for (x = 0; x < y.length; x += 3) v.push(y[x] + g), v.push(y[x] + g), v.push(y[x + 1] + g), v.push(y[x + 2] + g), v.push(y[x + 2] + g);
                    ...
                    for (var a, h, l, u, c, d, p = 20, f = [], m = 0, v = 0; p >= v; v++) m = v / p, a = s(t, i, m), h = s(e, r, m), l = s(i, n, m), u = s(r, o, m), c = s(a, l, m), d = s(h, u, m), f.push(c, d);
                    return f
                    ...
                    if (t.fill) {
                        var d = r.hex2rgb(t.fillColor),
                            ...
                            y = e.indices,
                            x = g.length / 6;
                        for (y.push(x), c = 0; l + 1 > c; c++) g.push(a, h, f, m, v, p), g.push(a + Math.sin(u * c) * i, h + Math.cos(u * c) * n, f, m, v, p), y.push(x++, x++);
                        y.push(x - 1)
                    }
                    if (t.lineWidth) {
                        var _ = t.points;
                        for (t.points = [], c = 0; l + 1 > c; c++) t.points.push(a + Math.sin(u * c) * i, h + Math.cos(u * c) * n);
                    ...
                    if (0 !== o.length) {
                        ...
                        var u, c, d, p, f, m, v, g, y, x, _, b, w, T, S, E, A, C, M, R, P, O, D, F = e.points,
                            L = e.indices,
                            k = o.length / 2,
                            I = o.length,
                            B = F.length / 6,
                            ...
                            z = U[1] * X,
                            Y = U[2] * X;
                        for (d = o[0], p = o[1], f = o[2], m = o[3], y = -(p - m), x = d - f, D = Math.sqrt(y * y + x * x), y /= D, x /= D, y *= N, x *= N, F.push(d - y, p - x, j, z, Y, X), F.push(d + y, p + x, j, z, Y, X), i = 1; k - 1 > i; i++) d = o[2 * (i - 1)], p = o[2 * (i - 1) + 1], f = o[2 * i], m = o[2 * i + 1], v = o[2 * (i + 1)], g = o[2 * (i + 1) + 1], y = -(p - m), x = d - f, D = Math.sqrt(y * y + x * x), y /= D, x /= D, y *= N, x *= N, _ = -(m - g), b = f - v, D = Math.sqrt(_ * _ + b * b), _ /= D, b /= D, _ *= N, b *= N, S = -x + p - (-x + m), E = -y + f - (-y + d), A = (-y + d) * (-x + m) - (-y + f) * (-x + p), C = -b + g - (-b + m), M = -_ + f - (-_ + v), R = (-_ + v) * (-b + m) - (-_ + f) * (-b + g), P = S * M - C * E, Math.abs(P) < .1 ? (P += 10.1, F.push(f - y, m - x, j, z, Y, X), F.push(f + y, m + x, j, z, Y, X)) : (u = (E * R - M * A) / P, c = (C * A - S * R) / P, O = (u - f) * (u - f) + (c - m) + (c - m), O > 19600 ? (w = y - _, T = x - b, D = Math.sqrt(w * w + T * T), w /= D, T /= D, w *= N, T *= N, F.push(f - w, m - T), F.push(j, z, Y, X), F.push(f + w, m + T), F.push(j, z, Y, X), F.push(f - w, m - T), F.push(j, z, Y, X), I++) : (F.push(u, c), F.push(j, z, Y, X), F.push(f - (u - f), m - (c - m)), F.push(j, z, Y, X)));
                        for (d = o[2 * (k - 2)], p = o[2 * (k - 2) + 1], f = o[2 * (k - 1)], m = o[2 * (k - 1) + 1], y = -(p - m), x = d - f, D = Math.sqrt(y * y + x * x), y /= D, x /= D, y *= N, x *= N, F.push(f - y, m - x), F.push(j, z, Y, X), F.push(f + y, m + x), F.push(j, z, Y, X), L.push(B), i = 0; I > i; i++) L.push(B++);
                        L.push(B - 1)
                    }
                    ...
                    if (!(i.length < 6)) {
                        ...
                        for (var o, s, a = 1 / 0, h = -1 / 0, l = 1 / 0, u = -1 / 0, c = 0; c < i.length; c += 2) o = i[c], s = i[c + 1], a = a > o ? o : a, h = o > h ? o : h, l = l > s ? s : l, u = s > u ? s : u;
            ...
            20: [function(t, e) {
                ...
                var r = e.exports = {
                        ...
                        autoDetectRenderer: function(t, e, n, o) {
                            return t = t || 800, e = e || 600, !o && i() ? new r.WebGLRenderer(t, e, n) : new r.CanvasRenderer(t, e, n)
                        }
                    },
                    n = t("./const");
            ...
            29: [function(t, e) {
                function i(t, e) {
                    r.call(this), this._properties = e || [!1, !0, !1, !1, !1], this._size = t || 15e3, this._buffers = null, this._updateStatic = !1, this.interactiveChildren = !1
                }
                var r = t("../display/Container");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.updateTransform = function() {
                    this.displayObjectUpdateTransform()
                }, i.prototype.renderWebGL = function(t) {
                    ...
                    if (this.visible && !(this.worldAlpha <= 0) && this.children.length && this.renderable) {
                        ...
                        for (var n = 0; n < this.children.length; ++n) {
                            ...
                            if (o.visible) {
                                ...
                                if (e.globalAlpha = this.worldAlpha * o.alpha, o.rotation % (2 * Math.PI) === 0) r && (e.setTransform(i.a, i.b, i.c, i.d, i.tx, i.ty), r = !1), e.drawImage(o.texture.baseTexture.source, s.x, s.y, s.width, s.height, o.anchor.x * -s.width * o.scale.x + o.position.x + .5 | 0, o.anchor.y * -s.height * o.scale.y + o.position.y + .5 | 0, s.width * o.scale.x, s.height * o.scale.y);
                                else {
                                    r || (r = !0), o.displayObjectUpdateTransform();
                                    var a = o.worldTransform;
                                    t.roundPixels ? e.setTransform(a.a, a.b, a.c, a.d, 0 | a.tx, 0 | a.ty) : e.setTransform(a.a, a.b, a.c, a.d, a.tx, a.ty), e.drawImage(o.texture.baseTexture.source, s.x, s.y, s.width, s.height, o.anchor.x * -s.width + .5 | 0, o.anchor.y * -s.height + .5 | 0, s.width, s.height)
                                }
                            }
                        }
                    }
            ...
            31: [function(t, e) {
                function i(t) {
                    ...
                    for (var i = 0, n = 0; e > i; i += 6, n += 4) this.indices[i + 0] = n + 0, this.indices[i + 1] = n + 1, this.indices[i + 2] = n + 2, this.indices[i + 3] = n + 0, this.indices[i + 4] = n + 2, this.indices[i + 5] = n + 3;
                ...
                var r = t("../../renderers/webgl/utils/ObjectRenderer"),
                    ...
                    s = t("./ParticleBuffer"),
                    a = t("../../math");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, n.registerPlugin("particle", i), i.prototype.onContextChange = function() {
                    ...
                    if (0 !== i) {
                        ...
                        o.prepend(this.renderer.currentRenderTarget.projectionMatrix), n.uniformMatrix3fv(this.shader.uniforms.projectionMatrix._location, !1, o.toArray(!0));
                        var s = t._updateStatic,
                            a = e[0]._texture.baseTexture;
                        a._glTextures[n.id] ? n.bindTexture(n.TEXTURE_2D, a._glTextures[n.id]) : (this.renderer.updateTexture(a), this.properties[0].dynamic && this.properties[3].dynamic || (s = !0));
                        for (var h = 0, l = 0; i > l; l += this.size) {
                            var u = i - l;
                            u > this.size && (u = this.size);
                            var c = t._buffers[h++];
                            c.uploadDynamic(e, l, u), s && c.uploadStatic(e, l, u), c.bind(this.shader), n.drawElements(n.TRIANGLES, 6 * u, n.UNSIGNED_SHORT, 0), this.renderer.drawCount++
                        }
                        t._updateStatic = !1
                    }
                    ...
                    for (var s, a, h, l, u, c, d, p, f, m = 0; i > m; m++) s = t[e + m], a = s._texture, l = s.scale.x, u = s.scale.y, a.trim ? (h = a.trim, d = h.x - s.anchor.x * h.width, c = d + a.crop.width, f = h.y - s.anchor.y * h.height, p = f + a.crop.height) : (c = a._frame.width * (1 - s.anchor.x), d = a._frame.width * -s.anchor.x, p = a._frame.height * (1 - s.anchor.y), f = a._frame.height * -s.anchor.y), r[o] = d * l, r[o + 1] = f * u, r[o + n] = c * l, r[o + n + 1] = f * u, r[o + 2 * n] = c * l, r[o + 2 * n + 1] = p * u, r[o + 3 * n] = d * l, r[o + 3 * n + 1] = p * u, o += 4 * n
            ...
            33: [function(t, e) {
                ...
                var r = t("../utils"),
                    n = t("../math"),
                    o = t("../const");
                i.prototype.constructor = i, e.exports = i, r.eventTarget.mixin(i.prototype), Object.defineProperties(i.prototype, {
                    backgroundColor: {
                        get: function() {
                            return this._backgroundColor
                        },
                        set: function(t) {
                            this._backgroundColor = t, this._backgroundColorString = r.hex2string(t), r.hex2rgb(t, this._backgroundColorRgb)
                        }
                    }
            ...
            34: [function(t, e) {
                function i(t, e, i) {
                    r.call(this, "Canvas", t, e, i), this.type = a.RENDERER_TYPE.CANVAS, this.context = this.view.getContext("2d", {
                        alpha: this.transparent
                    }), this.refresh = !0, this.maskManager = new n, this.roundPixels = !1, this.currentScaleMode = a.SCALE_MODES.DEFAULT, this.currentBlendMode = a.BLEND_MODES.NORMAL, this.smoothProperty = "imageSmoothingEnabled", this.context.imageSmoothingEnabled || (this.context.webkitImageSmoothingEnabled ? this.smoothProperty = "webkitImageSmoothingEnabled" : this.context.mozImageSmoothingEnabled ? this.smoothProperty = "mozImageSmoothingEnabled" : this.context.oImageSmoothingEnabled ? this.smoothProperty = "oImageSmoothingEnabled" : this.context.msImageSmoothingEnabled && (this.smoothProperty = "msImageSmoothingEnabled")), this.initPlugins(), this._mapBlendModes(), this._tempDisplayObjectParent = {
                ...
                var r = t("../SystemRenderer"),
                    ...
                    s = t("../../math"),
                    a = t("../../const");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, o.pluginTarget.mixin(i), i.prototype.render = function(t) {
                    var e = t.parent;
                    ...
                    this.destroyPlugins(), r.prototype.destroy.call(this, t), this.context = null, this.refresh = !0, this.maskManager.destroy(), this.maskManager = null, this.roundPixels = !1, this.currentScaleMode = 0, this.currentBlendMode = 0, this.smoothProperty = null
                    ...
                    for (var n = 0; n < t.graphicsData.length; n++) {
                        ...
                        if (e.lineWidth = o.lineWidth, o.type === i.SHAPES.POLY) {
                            ...
                            var m = .5522848,
                                ...
                                _ = p + c / 2,
                                b = f + d / 2;
                            e.moveTo(p, b), e.bezierCurveTo(p, b - g, _ - v, f, _, f), e.bezierCurveTo(_ + v, f, y, b - g, y, b), e.bezierCurveTo(y, b + g, _ + v, x, _, x), e.bezierCurveTo(_ - v, x, p, b + g, p, b), e.closePath(), o.fill && (e.globalAlpha = o.fillAlpha * r, e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6), e.fill()), o.lineWidth && (e.globalAlpha = o.lineAlpha * r, e.strokeStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6), e.stroke())
                            ...
                            var w = s.x,
                                ...
                                A = s.radius,
                                C = Math.min(S, E) / 2 | 0;
                            A = A > C ? C : A, e.beginPath(), e.moveTo(w, T + A), e.lineTo(w, T + E - A), e.quadraticCurveTo(w, T + E, w + A, T + E), e.lineTo(w + S - A, T + E), e.quadraticCurveTo(w + S, T + E, w + S, T + E - A), e.lineTo(w + S, T + A), e.quadraticCurveTo(w + S, T, w + S - A, T), e.lineTo(w + A, T), e.quadraticCurveTo(w, T, w, T + A), e.closePath(), (o.fillColor || 0 === o.fillColor) && (e.globalAlpha = o.fillAlpha * r, e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6), e.fill()), o.lineWidth && (e.globalAlpha = o.lineAlpha * r, e.strokeStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6), e.stroke())
                        }
                    }
                        ...
                        for (var n = 0; r > n; n++) {
                            ...
                            if (o.type === i.SHAPES.POLY) {
                                ...
                                var l = 2 * s.width,
                                    ...
                                    y = c + l / 2,
                                    x = d + u / 2;
                                e.moveTo(c, x), e.bezierCurveTo(c, x - m, y - f, d, y, d), e.bezierCurveTo(y + f, d, v, x - m, v, x), e.bezierCurveTo(v, x + m, y + f, g, y, g), e.bezierCurveTo(y - f, g, c, x + m, c, x), e.closePath()
                            } else if (o.type === i.SHAPES.RREC) {
                                var _ = s.x,
                                    b = s.y,
                                    w = s.width,
                                    ...
                                    S = s.radius,
                                    E = Math.min(w, T) / 2 | 0;
                                S = S > E ? E : S, e.moveTo(_, b + S), e.lineTo(_, b + T - S), e.quadraticCurveTo(_, b + T, _ + S, b + T), e.lineTo(_ + w - S, b + T), e.quadraticCurveTo(_ + w, b + T, _ + w, b + T - S), e.lineTo(_ + w, b + S), e.quadraticCurveTo(_ + w, b, _ + w - S, b), e.lineTo(_ + S, b), e.quadraticCurveTo(_, b, _, b + S), e.closePath()
                            }
                        }
                    }
            ...
            37: [function(t, e) {
                ...
                i.prototype.constructor = i, e.exports = i, i.prototype.pushMask = function(t, e) {
                    ...
                    var i = t.alpha,
                        n = t.worldTransform,
                        o = e.resolution;
                    e.context.setTransform(n.a * o, n.b * o, n.c * o, n.d * o, n.tx * o, n.ty * o), t.texture || (r.renderGraphicsMask(t, e.context), e.context.clip()), t.worldAlpha = i
            ...
            38: [function(t, e) {
                ...
                r.getTintedTexture = function(t, e) {
                    ...
                    for (var s = i.hex2rgb(e), a = s[0], h = s[1], l = s[2], u = n.getImageData(0, 0, o.width, o.height), c = u.data, d = 0; d < c.length; d += 4) c[d + 0] *= a, c[d + 1] *= h, c[d + 2] *= l;
                    n.putImageData(u, 0, 0)
                }, r.roundColor = function(t) {
                    var e = r.cacheStepsPerColorChannel,
                        n = i.hex2rgb(t);
                    return n[0] = Math.min(255, n[0] / e * e), n[1] = Math.min(255, n[1] / e * e), n[2] = Math.min(255, n[2] / e * e), i.rgb2hex(n)
                }, r.cacheStepsPerColorChannel = 8, r.convertTintToImage = !1, r.canUseMultiply = i.canUseNewCanvasBlendModes(), r.tintMethod = r.canUseMultiply ? r.tintWithMultiply : r.tintWithPerPixel
            }, {
                "../../../utils": 68
            }],
            39: [function(t, e) {
                function i(t, e, i) {
                    i = i || {}, r.call(this, "WebGL", t, e, i), this.type = p.RENDERER_TYPE.WEBGL, this.handleContextLost = this.handleContextLost.bind(this), this.handleContextRestored = this.handleContextRestored.bind(this), this._updateTextureBound = function(t) {
                        this.updateTexture(t.target)
                    }.bind(this), this._destroyTextureBound = function(t) {
                        this.destroyTexture(t.target)
                    }.bind(this), this.view.addEventListener("webglcontextlost", this.handleContextLost, !1), this.view.addEventListener("webglcontextrestored", this.handleContextRestored, !1), this._useFXAA = !1, this._FXAAFilter = null, this._contextOptions = {
                        alpha: this.transparent,
                        antialias: i.antialias,
                        premultipliedAlpha: this.transparent && "notMultiplied" !== this.transparent,
                        stencil: !0,
                        preserveDrawingBuffer: i.preserveDrawingBuffer
                    }, this.drawCount = 0, this.shaderManager = new n(this), this.maskManager = new o(this), this.stencilManager = new s(this), this.filterManager = new a(this), this.blendModeManager = new h(this), this.currentRenderTarget = this.renderTarget, this.currentRenderer = new u(this), this.initPlugins(), this._initContext(), this._mapBlendModes(), this._renderTargetStack = []
                }
                var r = t("../SystemRenderer"),
                    ...
                    d = t("../../utils"),
                    p = t("../../const");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, d.pluginTarget.mixin(i), i.glContextId = 0, i.prototype._initContext = function() {
                    ...
                    this.glContextId = i.glContextId++, t.id = this.glContextId, t.renderer = this, t.disable(t.DEPTH_TEST), t.disable(t.CULL_FACE), t.enable(t.BLEND), this.renderTarget = new l(this.gl, this.width, this.height, null, this.resolution, !0), this.emit("context", t), this.resize(this.width, this.height), this._useFXAA = this._contextOptions.antialias && !t.getContextAttributes().antialias, this._useFXAA && (this._FXAAFilter = [new c])
                }, i.prototype.render = function(t) {
                    if (!this.gl.isContextLost()) {
                        this._lastObjectRendered = t, this._useFXAA && (this._FXAAFilter[0].uniforms.resolution.value.x = this.width, this._FXAAFilter[0].uniforms.resolution.value.y = this.height, t.filterArea = this.renderTarget.size, t.filters = this._FXAAFilter);
                        var e = t.parent;
                        t.parent = this._tempDisplayObjectParent, t.updateTransform(), t.parent = e;
                        var i = this.gl;
                        i.bindFramebuffer(i.FRAMEBUFFER, null), this.clearBeforeRender && (this.transparent ? i.clearColor(0, 0, 0, 0) : i.clearColor(this._backgroundColorRgb[0], this._backgroundColorRgb[1], this._backgroundColorRgb[2], 1), i.clear(i.COLOR_BUFFER_BIT)), this.renderDisplayObject(t, this.renderTarget)
                    }
                }, i.prototype.renderDisplayObject = function(t, e) {
                    this.setRenderTarget(e), this.filterManager.setFilterStack(e.filterStack), t.renderWebGL(this), this.currentRenderer.flush()
                }, i.prototype.setObjectRenderer = function(t) {
                    this.currentRenderer !== t && (this.currentRenderer.stop(), this.currentRenderer = t, this.currentRenderer.start())
                }, i.prototype.setRenderTarget = function(t) {
                    this.currentRenderTarget = t, this.currentRenderTarget.activate(), this.stencilManager.setMaskStack(t.stencilMaskStack)
                }, i.prototype.resize = function(t, e) {
                    ...
                    var t = this.gl;
                    this.blendModes || (this.blendModes = {}, this.blendModes[p.BLEND_MODES.NORMAL] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.ADD] = [t.SRC_ALPHA, t.DST_ALPHA], this.blendModes[p.BLEND_MODES.MULTIPLY] = [t.DST_COLOR, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.SCREEN] = [t.SRC_ALPHA, t.ONE], this.blendModes[p.BLEND_MODES.OVERLAY] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.DARKEN] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.LIGHTEN] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.COLOR_DODGE] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.COLOR_BURN] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.HARD_LIGHT] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.SOFT_LIGHT] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.DIFFERENCE] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.EXCLUSION] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.HUE] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.SATURATION] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.COLOR] = [t.ONE, t.ONE_MINUS_SRC_ALPHA], this.blendModes[p.BLEND_MODES.LUMINOSITY] = [t.ONE, t.ONE_MINUS_SRC_ALPHA])
                }
            }, {
                "../../const": 13,
                "../../utils": 68,
            ...
            40: [function(t, e) {
                function i(t, e, i) {
                    this.passes = [this], this.shaders = [], this.padding = 0, this.uniforms = i || {}, this.vertexSrc = t, this.fragmentSrc = e
                }
                var r = t("../shaders/TextureShader");
                i.prototype.constructor = i, e.exports = i, i.prototype.getShader = function(t) {
                    var e = t.gl,
                        i = this.shaders[e.id];
                    return i || (i = new r(t.shaderManager, this.vertexSrc, this.fragmentSrc, this.uniforms, this.attributes), this.shaders[e.id] = i), i
            ...
            41: [function(t, e) {
                ...
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.applyFilter = function(t, e, i) {
            ...
            42: [function(t, e) {
                ...
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.applyFilter = function(t, e, i) {
                    var r = t.filterManager;
                    r.calculateMappedMatrix(e.frame, this.maskSprite, this.maskMatrix), this.uniforms.otherMatrix.value = this.maskMatrix.toArray(!0);
                    var n = this.getShader(t);
                    r.applyFilter(n, e, i)
            ...
            43: [function(t, e) {
                ...
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.setBlendMode = function(t) {
            ...
            44: [function(t, e) {
                function i(t) {
                    r.call(this, t), this.filterStack = [], this.filterStack.push({
                        ...
                        filter: [],
                        bounds: null
                    }), this.texturePool = [], this.textureSize = new s.Rectangle(0, 0, t.width, t.height), this.currentFrame = null
                }
                var r = t("./WebGLManager"),
                    n = t("../utils/RenderTarget"),
                    o = t("../utils/Quad"),
                    s = t("../../../math");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.onContextChange = function() {
                    ...
                    i.x = 0 | i.x, i.y = 0 | i.y, i.width = 0 | i.width, i.height = 0 | i.height, this.capFilterArea(i), this.currentFrame = i;
                    var r = this.getRenderTarget();
                    this.renderer.setRenderTarget(r), r.clear(), this.filterStack.push({
                        renderTarget: r,
                        filter: e
                    })
                    ...
                    if (1 === o.length) o[0].uniforms.dimensions && (o[0].uniforms.dimensions.value[0] = this.renderer.width, o[0].uniforms.dimensions.value[1] = this.renderer.height, o[0].uniforms.dimensions.value[2] = this.quad.vertices[0], o[0].uniforms.dimensions.value[3] = this.quad.vertices[5]), o[0].applyFilter(this.renderer, i, r), this.returnRenderTarget(i);
                        ...
                        for (var s = i, a = this.getRenderTarget(!0), h = 0; h < o.length - 1; h++) {
                            var l = o[h];
                            l.uniforms.dimensions && (l.uniforms.dimensions.value[0] = this.renderer.width, l.uniforms.dimensions.value[1] = this.renderer.height, l.uniforms.dimensions.value[2] = this.quad.vertices[0], l.uniforms.dimensions.value[3] = this.quad.vertices[5]), l.applyFilter(this.renderer, s, a);
                            var u = s;
                            s = a, a = u
                        }
                        o[o.length - 1].applyFilter(this.renderer, s, r), this.returnRenderTarget(s), this.returnRenderTarget(a)
                    }
                    return t.filter
                }, i.prototype.getRenderTarget = function(t) {
                    var e = this.texturePool.pop() || new n(this.renderer.gl, this.textureSize.width, this.textureSize.height, null, this.renderer.resolution);
                    ...
                    return r.tx /= n.width * h, r.ty /= n.width * h, r.invert(), o.prepend(r), o.scale(1, 1 / a), o.scale(h, l), o.translate(e.anchor.x, e.anchor.y), o
            ...
            45: [function(t, e) {
                function i(t) {
                    r.call(this, t), this.stencilStack = [], this.reverse = !0, this.count = 0, this.alphaMaskPool = []
                }
                var r = t("./WebGLManager"),
                    n = t("../filters/SpriteMaskFilter");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.pushMask = function(t, e) {
            ...
            46: [function(t, e) {
                ...
                var r = t("./WebGLManager"),
                    ...
                    a = t("../../../utils");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, a.pluginTarget.mixin(i), e.exports = i, i.prototype.onContextChange = function() {
                    this.initPlugins(), this.defaultShader = new n(this), this.primitiveShader = new s(this), this.complexPrimitiveShader = new o(this)
                    ...
                    r.prototype.destroy.call(this), this.destroyPlugins(), this.attribState = null, this.tempAttribState = null
                }
            }, {
                "../../../utils": 68,
            ...
            47: [function(t, e) {
                ...
                var r = t("./WebGLManager"),
                    n = t("../../../utils");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.setMaskStack = function(t) {
            ...
            51: [function(t, e) {
                function i(t, e, i, n, o) {
                    ...
                    this.uuid = r.uuid(), this.gl = t.renderer.gl, this.program = null, this.uniforms = n || {}, this.attributes = o || {}, this.textureCount = 1, this.vertexSrc = e, this.fragmentSrc = i, this.init()
                }
                var r = t("../../../utils"),
                    n = t("../../../const");
                i.prototype.constructor = i, e.exports = i, i.prototype.init = function() {
                    ...
                    var t = this.gl,
                        ...
                        r = t.createProgram();
                    return t.attachShader(r, e), t.attachShader(r, i), t.linkProgram(r), t.getProgramParameter(r, t.LINK_STATUS) || (window.console.error("Pixi.js Error: Could not initialize shader."), window.console.error("gl.VALIDATE_STATUS", t.getProgramParameter(r, t.VALIDATE_STATUS)), window.console.error("gl.getError()", t.getError()), "" !== t.getProgramInfoLog(r) && window.console.warn("Pixi.js Warning: gl.getProgramInfoLog()", t.getProgramInfoLog(r)), t.deleteProgram(r), r = null), t.deleteShader(e), t.deleteShader(i), this.program = r
                }, i.prototype.syncUniform = function(t) {
                    ...
                    switch (t.type) {
                        ...
                        case "fv":
                            ...
                            break;
                        case "v2v":
                            for (t._array || (t._array = new Float32Array(2 * o.length)), e = 0, i = o.length; i > e; ++e) t._array[2 * e] = o[e].x, t._array[2 * e + 1] = o[e].y;
                            s.uniform2fv(n, t._array);
                            break;
                        case "v3v":
                            for (t._array || (t._array = new Float32Array(3 * o.length)), e = 0, i = o.length; i > e; ++e) t._array[3 * e] = o[e].x, t._array[3 * e + 1] = o[e].y, t._array[3 * e + 2] = o[e].z;
                            s.uniform3fv(n, t._array);
                            break;
                        case "v4v":
                            for (t._array || (t._array = new Float32Array(4 * o.length)), e = 0, i = o.length; i > e; ++e) t._array[4 * e] = o[e].x, t._array[4 * e + 1] = o[e].y, t._array[4 * e + 2] = o[e].z, t._array[4 * e + 3] = o[e].w;
                        ...
                        case "sampler2D":
                            ...
                            a || this.initSampler2D(t), s.bindTexture(s.TEXTURE_2D, t.value.baseTexture._glTextures[s.id]), s.uniform1i(t._location, this.textureCount), this.textureCount++;
                            break;
                        default:
                    ...
                    if (i.hasLoaded)
                        if (i._glTextures[e.id] = e.createTexture(), e.bindTexture(e.TEXTURE_2D, i._glTextures[e.id]), e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, i.premultipliedAlpha), t.textureData) {
                            var r = t.textureData;
                            e.texImage2D(e.TEXTURE_2D, 0, r.luminance ? e.LUMINANCE : e.RGBA, e.RGBA, e.UNSIGNED_BYTE, i.source), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, r.magFilter ? r.magFilter : e.LINEAR), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, r.wrapS ? r.wrapS : e.CLAMP_TO_EDGE), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, r.wrapS ? r.wrapS : e.CLAMP_TO_EDGE), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, r.wrapT ? r.wrapT : e.CLAMP_TO_EDGE)
                        } else e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, e.RGBA, e.UNSIGNED_BYTE, i.source), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, i.scaleMode === n.SCALE_MODES.LINEAR ? e.LINEAR : e.NEAREST), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, i.scaleMode === n.SCALE_MODES.LINEAR ? e.LINEAR : e.NEAREST), i.isPowerOfTwo ? (e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, e.REPEAT), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, e.REPEAT)) : (e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE))
                }, i.prototype.destroy = function() {
                    ...
                    return this.gl.shaderSource(i, e), this.gl.compileShader(i), this.gl.getShaderParameter(i, this.gl.COMPILE_STATUS) ? i : (window.console.log(this.gl.getShaderInfoLog(i)), null)
                }
            }, {
                "../../../const": 13,
                "../../../utils": 68
            ...
            53: [function(t, e) {
                ...
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.start = function() {}, i.prototype.stop = function() {
                    this.flush()
                }, i.prototype.flush = function() {}, i.prototype.render = function() {}
            }, {
            ...
            55: [function(t, e) {
                var i = t("../../../math"),
                    ...
                    s = function(t, e, s, a, h, l) {
                        if (this.gl = t, this.frameBuffer = null, this.texture = null, this.size = new i.Rectangle(0, 0, 1, 1), this.resolution = h || n.RESOLUTION, this.projectionMatrix = new i.Matrix, this.transform = null, this.frame = null, this.stencilBuffer = null, this.stencilMaskStack = new o, this.filterStack = [{
                                renderTarget: this,
                                filter: [],
                                bounds: this.size
                            }], this.scaleMode = a || n.SCALE_MODES.DEFAULT, this.root = l, !this.root) {
                            this.frameBuffer = t.createFramebuffer(), this.texture = t.createTexture(), t.bindTexture(t.TEXTURE_2D, this.texture), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, a === n.SCALE_MODES.LINEAR ? t.LINEAR : t.NEAREST), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, a === n.SCALE_MODES.LINEAR ? t.LINEAR : t.NEAREST);
                ...
                s.prototype.constructor = s, e.exports = s, s.prototype.clear = function() {
                    var t = this.gl;
                    t.bindFramebuffer(t.FRAMEBUFFER, this.frameBuffer), t.clearColor(0, 0, 0, 0), t.clear(t.COLOR_BUFFER_BIT)
            ...
            57: [function(t, e) {
                function i(t) {
                    o.call(this), this.anchor = new r.Point, this._texture = null, this._width = 0, this._height = 0, this.tint = 16777215, this.blendMode = h.BLEND_MODES.NORMAL, this.shader = null, this.cachedTint = 16777215, this.texture = t || n.EMPTY
                }
                var r = t("../math"),
                ...
                i.prototype.destroy = function(t, e) {
                    ...
                    texture: {
                        ...
                        set: function(t) {
                            this._texture !== t && (this._texture = t, this.cachedTint = 16777215, t && (t.baseTexture.hasLoaded ? this._onTextureUpdate() : t.once("update", this._onTextureUpdate.bind(this))))
                        }
                    }
                    ...
                    if (!this._currentBounds) {
                        var e, i, r, n, o = this._texture._frame.width,
                            ...
                            v = c.tx,
                            g = c.ty;
                        if (0 === p && 0 === f) 0 > d && (d *= -1), 0 > m && (m *= -1), e = d * h + v, i = d * a + v, r = m * u + g, n = m * l + g;
                        else {
                            var y = d * h + f * u + v,
                                x = m * u + p * h + g,
                                _ = d * a + f * u + v,
                                ...
                                S = d * h + f * l + v,
                                E = m * l + p * h + g;
                            e = y, e = e > _ ? _ : e, e = e > w ? w : e, e = e > S ? S : e, r = x, r = r > b ? b : r, r = r > T ? T : r, r = r > E ? E : r, i = y, i = _ > i ? _ : i, i = w > i ? w : i, i = S > i ? S : i, n = x, n = b > n ? b : n, n = T > n ? T : n, n = E > n ? E : n
                        }
                        var A = this._bounds;
                    ...
                    if (!(!this.visible || this.alpha <= 0 || this.texture.crop.width <= 0 || this.texture.crop.height <= 0) && this.renderable) {
                        if (this.blendMode !== t.currentBlendMode && (t.currentBlendMode = this.blendMode, t.context.globalCompositeOperation = t.blendModes[t.currentBlendMode]), this._mask && t.maskManager.pushMask(this._mask, t), this.texture.valid) {
                            var e = this.texture.baseTexture.resolution / t.resolution;
                            t.context.globalAlpha = this.worldAlpha, t.smoothProperty && t.currentScaleMode !== this.texture.baseTexture.scaleMode && (t.currentScaleMode = this.texture.baseTexture.scaleMode, t.context[t.smoothProperty] = t.currentScaleMode === h.SCALE_MODES.LINEAR);
                            var i = this.texture.trim ? this.texture.trim.x - this.anchor.x * this.texture.trim.width : this.anchor.x * -this.texture._frame.width,
                                r = this.texture.trim ? this.texture.trim.y - this.anchor.y * this.texture.trim.height : this.anchor.y * -this.texture._frame.height;
                            t.roundPixels ? (t.context.setTransform(this.worldTransform.a, this.worldTransform.b, this.worldTransform.c, this.worldTransform.d, this.worldTransform.tx * t.resolution | 0, this.worldTransform.ty * t.resolution | 0), i = 0 | i, r = 0 | r) : t.context.setTransform(this.worldTransform.a, this.worldTransform.b, this.worldTransform.c, this.worldTransform.d, this.worldTransform.tx * t.resolution, this.worldTransform.ty * t.resolution), 16777215 !== this.tint ? (this.cachedTint !== this.tint && (this.cachedTint = this.tint, this.tintedTexture = s.getTintedTexture(this, this.tint)), t.context.drawImage(this.tintedTexture, 0, 0, this.texture.crop.width, this.texture.crop.height, i / e, r / e, this.texture.crop.width / e, this.texture.crop.height / e)) : t.context.drawImage(this.texture.baseTexture.source, this.texture.crop.x, this.texture.crop.y, this.texture.crop.width, this.texture.crop.height, i / e, r / e, this.texture.crop.width / e, this.texture.crop.height / e)
                        }
            ...
            58: [function(t, e) {
                function i(t) {
                    r.call(this, t), this.vertSize = 5, this.vertByteSize = 4 * this.vertSize, this.size = s.SPRITE_BATCH_SIZE;
                    ...
                    for (var n = 0, o = 0; i > n; n += 6, o += 4) this.indices[n + 0] = o + 0, this.indices[n + 1] = o + 1, this.indices[n + 2] = o + 2, this.indices[n + 3] = o + 0, this.indices[n + 4] = o + 2, this.indices[n + 5] = o + 3;
                ...
                var r = t("../../renderers/webgl/utils/ObjectRenderer"),
                    ...
                    s = t("../../const");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, o.registerPlugin("sprite", i), i.prototype.onContextChange = function() {
                    var t = this.renderer.gl;
                    ...
                    if (i) {
                        ...
                        } else r = e._frame.width * (1 - a), n = e._frame.width * -a, o = e._frame.height * (1 - h), s = e._frame.height * -h;
                        var u = this.currentBatchSize * this.vertByteSize,
                            ...
                            y = this.colors,
                            x = this.positions;
                        this.renderer.roundPixels ? (x[u] = d * n + f * s + v | 0, x[u + 1] = m * s + p * n + g | 0, x[u + 5] = d * r + f * s + v | 0, x[u + 6] = m * s + p * r + g | 0, x[u + 10] = d * r + f * o + v | 0, x[u + 11] = m * o + p * r + g | 0, x[u + 15] = d * n + f * o + v | 0, x[u + 16] = m * o + p * n + g | 0) : (x[u] = d * n + f * s + v, x[u + 1] = m * s + p * n + g, x[u + 5] = d * r + f * s + v, x[u + 6] = m * s + p * r + g, x[u + 10] = d * r + f * o + v, x[u + 11] = m * o + p * r + g, x[u + 15] = d * n + f * o + v, x[u + 16] = m * o + p * n + g), x[u + 2] = i.x0, x[u + 3] = i.y0, x[u + 7] = i.x1, x[u + 8] = i.y1, x[u + 12] = i.x2, x[u + 13] = i.y2, x[u + 17] = i.x3, x[u + 18] = i.y3;
                        var _ = t.tint;
                    ...
                    if (0 !== this.currentBatchSize) {
                        ...
                        for (var r, o, s, a, h = 0, l = 0, u = null, c = this.renderer.blendModeManager.currentBlendMode, d = null, p = !1, f = !1, m = 0, v = this.currentBatchSize; v > m; m++) a = this.sprites[m], r = a._texture.baseTexture, o = a.blendMode, s = a.shader || this.shader, p = c !== o, f = d !== s, (u !== r || p || f) && (this.renderBatch(u, h, l), l = m, h = 0, u = r, p && (c = o, this.renderer.blendModeManager.setBlendMode(c)), f && (d = s, t = d.shaders ? d.shaders[e.id] : d, t || (t = new n(this.renderer.shaderManager, null, d.fragmentSrc, d.uniforms), d.shaders[e.id] = t), this.renderer.shaderManager.setShader(t), e.uniformMatrix3fv(t.uniforms.projectionMatrix._location, !1, this.renderer.currentRenderTarget.projectionMatrix.toArray(!0)))), h++;
            ...
            59: [function(t, e) {
                function i(t, e, i) {
                    this.uuid = r.uuid(), this.resolution = i || 1, this.width = 100, this.height = 100, this.realWidth = 100, this.realHeight = 100, this.scaleMode = e || n.SCALE_MODES.DEFAULT, this.hasLoaded = !1, this.isLoading = !1, this.source = null, this.premultipliedAlpha = !0, this.imageUrl = null, this.isPowerOfTwo = !1, this.mipmap = !1, this._glTextures = [], t && this.loadSource(t)
                }
                var r = t("../utils"),
                    n = t("../const");
                i.prototype.constructor = i, e.exports = i, r.eventTarget.mixin(i.prototype), i.prototype.update = function() {
                    ...
                    this.hasLoaded = !0, this.realWidth = this.source.naturalWidth || this.source.width, this.realHeight = this.source.naturalHeight || this.source.height, this.width = this.realWidth / this.resolution, this.height = this.realHeight / this.resolution, this.isPowerOfTwo = r.isPowerOfTwo(this.width, this.height), this.update()
                }, i.prototype.destroy = function() {
                    ...
                    if (void 0 === e && 0 !== t.indexOf("data:") && (e = !0), !o) {
                        var s = new Image;
                        e && (s.crossOrigin = ""), o = new i(s, n), o.imageUrl = t, s.src = t, r.BaseTextureCache[t] = o, this.resolution = r.getResolutionOfUrl(t)
                    }
                    return o
            ...
            60: [function(t, e) {
                function i(t, e, i, l, u) {
                    ...
                    var c = new r;
                    if (c.width = e, c.height = i, c.resolution = u, c.scaleMode = l || h.SCALE_MODES.DEFAULT, c.hasLoaded = !0, n.call(this, c, new a.Rectangle(0, 0, e, i)), this.width = e, this.height = i, this.resolution = u, this.render = null, this.renderer = t, this.renderer.type === h.RENDERER_TYPE.WEBGL) {
                        var d = this.renderer.gl;
                        this.textureBuffer = new o(d, this.width, this.height, null, this.resolution), this.baseTexture._glTextures[d.id] = this.textureBuffer.texture, this.render = this.renderWebGL
                    } else this.render = this.renderCanvas, this.textureBuffer = new s(this.width * this.resolution, this.height * this.resolution), this.baseTexture.source = this.textureBuffer.canvas;
                ...
                var r = t("./BaseTexture"),
                    ...
                    h = t("../const"),
                    l = new a.Matrix;
                i.prototype = Object.create(n.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.resize = function(t, e, i) {
            ...
            61: [function(t, e) {
                ...
                var r = t("./BaseTexture"),
                    ...
                    a = t("../math"),
                    h = t("../utils");
                i.prototype.constructor = i, e.exports = i, s.mixin(i.prototype), Object.defineProperties(i.prototype, {
                    frame: {
                        get: function() {
                            return this._frame
                        },
                        set: function(t) {
                            ...
                            this.valid = t && t.width && t.height && this.baseTexture.source && this.baseTexture.hasLoaded, this.trim ? (this.width = this.trim.width, this.height = this.trim.height, this._frame.width = this.trim.width, this._frame.height = this.trim.height) : this.crop = t, this.valid && this._updateUvs()
                        }
                    }
                    ...
                    t.removeEventListener("loaded", this.onLoaded), this.frame = this.noFrame ? new a.Rectangle(0, 0, t.width, t.height) : this._frame, this.dispatchEvent({
                        type: "update",
                        content: this
                    })
                }, i.prototype.destroy = function(t) {
            ...
            62: [function(t, e) {
                ...
                e.exports = i, i.prototype.set = function(t, e, i) {
                    var r = e.width,
                        n = e.height;
            ...
            63: [function(t, e) {
                ...
                var n = t("./BaseTexture"),
                    o = t("../utils");
                i.prototype = Object.create(n.prototype), i.prototype.constructor = i, e.exports = i, i.prototype._onUpdate = function() {
                    ...
                    this.source && this.source._pixiId && (o.BaseTextureCache[this.source._pixiId] = null, delete o.BaseTextureCache[this.source._pixiId], this.source._pixiId = null, delete this.source._pixiId), n.prototype.destroy.call(this)
                }, i.fromVideo = function(t, e) {
                    ...
                    if (Array.isArray(t))
                        for (var o = 0; o < t.length; ++o) n.appendChild(r(t.src || t, t.mime));
            ...
            64: [function(t, e) {
                function i(t, e, i) {
                    this.__isEventObject = !0, this.stopped = !1, this.stoppedImmediate = !1, this.target = t, this.type = e, this.data = i, this.timeStamp = Date.now()
                }
                i.prototype.constructor = i, e.exports = i, i.prototype.stopPropagation = function() {
                    this.stopped = !0
            ...
            66: [function(t, e) {
                var i = t("./eventTarget"),
                    r = t("./EventData"),
                    n = function() {
                        this.updateBind = this.update.bind(this), this.active = !1, this.eventData = new r(this, "tick", {
                            deltaTime: 1
                        }), this.deltaTime = 1, this.timeElapsed = 0, this.lastTime = 0, this.speed = 1, this.start()
                    };
                i.mixin(n.prototype), n.prototype.start = function() {
                    ...
                    if (this.active) {
                        ...
                        var t = (new Date).getTime(),
                            e = t - this.lastTime;
                        e > 100 && (e = 100), this.deltaTime = .06 * e, this.deltaTime *= this.speed, this.eventData.data.deltaTime = this.deltaTime, this.emit("tick", this.eventData), this.lastTime = t
                    }
                }, e.exports = new n
            }, {
                "./EventData": 64,
                    ...
                    t.listeners = function(t) {
                        ...
                        if (this._listeners = this._listeners || {}, this._listeners[t]) {
                            ...
                            var i, r = this._listeners[t].slice(0),
                                ...
                                s = r[0];
                            for (i = 0; o > i; s = r[++i])
                                if (s(e), e.stoppedImmediate) return this;
                        ...
                        return this._listeners = this._listeners || {}, this._listeners[t] ? (this._listeners[t] = null, this) : this
                    }
                }
                var r = t("./EventData"),
                    n = new r(null, null, {});
                ...
                var i = t("../const"),
                    r = e.exports = {
                        ...
                        canUseNewCanvasBlendModes: function() {
                            ...
                            var t = document.createElement("canvas"),
                                e = t.getContext("2d");
                            return t.width = 1, t.height = 1, e.fillStyle = "#000", e.fillRect(0, 0, 1, 1), e.globalCompositeOperation = "multiply", e.fillStyle = "#fff", e.fillRect(0, 0, 1, 1), 0 === e.getImageData(0, 0, 1, 1).data[0]
                        },
                        ...
                        sayHello: function(t) {
                            if (!r._saidHello) {
                                if (navigator.userAgent.toLowerCase().indexOf("chrome") > -1) {
                                    var e = ["%c %c %c Pixi.js " + i.VERSION + " - " + t + "  %c  %c  http://www.pixijs.com/  %c %c ♥%c♥%c♥ ", "background: #ff66a5", "background: #ff66a5", "color: #ff66a5; background: #030307;", "background: #ff66a5", "background: #ffc3dc", "background: #ff66a5", "color: #ff2424; background: #fff", "color: #ff2424; background: #fff", "color: #ff2424; background: #fff"];
            ...
            70: [function(t, e) {
                function i(t) {
                    r.Sprite.call(this, t[0]), this._textures = t, this.animationSpeed = 1, this.loop = !0, this.onComplete = null, this.currentFrame = 0, this.playing = !1, this._updateBound = this.update.bind(this)
                }
                var r = t("../core"),
                    n = t("../core/utils");
                i.prototype = Object.create(r.Sprite.prototype), i.prototype.constructor = i, e.exports = i, Object.defineProperties(i.prototype, {
                    totalFrames: {
                        get: function() {
                    ...
                    textures: {
                        ...
                        set: function(t) {
                            this._textures = t, this.texture = this._textures[Math.floor(this.currentFrame) % this._textures.length]
                        }
                    }
            ...
            71: [function(t, e) {
                function i(t, e) {
                    r.call(this, t), this.points = e, this.vertices = new Float32Array(4 * e.length), this.uvs = new Float32Array(4 * e.length), this.colors = new Float32Array(2 * e.length), this.indices = new Uint16Array(2 * e.length), this.refresh()
                }
                var r = t("./Strip");
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.refresh = function() {
                    var t = this.points;
                    if (!(t.length < 1)) {
                        var e = this.uvs,
                            i = this.indices,
                        ...
                        for (var n, o, s, a = t.length, h = 1; a > h; h++) n = t[h], o = 4 * h, s = h / (a - 1), h % 2 ? (e[o] = s, e[o + 1] = 0, e[o + 2] = s, e[o + 3] = 1) : (e[o] = s, e[o + 1] = 0, e[o + 2] = s, e[o + 3] = 1), o = 2 * h, r[o] = 1, r[o + 1] = 1, o = 2 * h, i[o] = o, i[o + 1] = o + 1
                    }
                }, i.prototype.updateTransform = function() {
                    var t = this.points;
                    if (!(t.length < 1)) {
                        for (var e, i, r, n, o, s, a = t[0], h = 0, l = 0, u = this.vertices, c = t.length, d = 0; c > d; d++) i = t[d], r = 4 * d, e = d < t.length - 1 ? t[d + 1] : i, l = -(e.x - a.x), h = e.y - a.y, n = 10 * (1 - d / (c - 1)), n > 1 && (n = 1), o = Math.sqrt(h * h + l * l), s = this.texture.height / 2, h /= o, l /= o, h *= s, l *= s, u[r] = i.x + h, u[r + 1] = i.y + l, u[r + 2] = i.x - h, u[r + 3] = i.y - l, a = i;
            ...
            72: [function(t, e) {
                function i(t) {
                    r.Container.call(this), this.texture = t, this.uvs = new Float32Array([0, 1, 1, 1, 1, 0, 0, 1]), this.vertices = new Float32Array([0, 0, 100, 0, 100, 100, 0, 100]), this.colors = new Float32Array([1, 1, 1, 1]), this.indices = new Uint16Array([0, 1, 2, 3]), this.dirty = !0, this.blendMode = r.CONST.BLEND_MODES.NORMAL, this.canvasPadding = 0, this.drawMode = i.DrawModes.TRIANGLE_STRIP
                }
                var r = t("../core");
                i.prototype = Object.create(r.Container.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.renderWebGL = function(t) {
                    !this.visible || this.alpha <= 0 || !this.renderable || (t.spriteBatch.stop(), this._vertexBuffer || this._initWebGL(t), t.shaderManager.setShader(t.shaderManager.plugins.stripShader), this._renderStrip(t), t.spriteBatch.start())
                    ...
                    if (this.canvasPadding > 0) {
                        var b = this.canvasPadding / this.worldTransform.a,
                            ...
                            A = d - S,
                            C = Math.sqrt(E * E + A * A);
                        l = T + E / C * (C + b), d = S + A / C * (C + w), E = u - T, A = p - S, C = Math.sqrt(E * E + A * A), u = T + E / C * (C + b), p = S + A / C * (C + w), E = c - T, A = f - S, C = Math.sqrt(E * E + A * A), c = T + E / C * (C + b), f = S + A / C * (C + w)
                    }
                    ...
                    for (var e = t || this.worldTransform, i = e.a, n = e.b, o = e.c, s = e.d, a = e.tx, h = e.ty, l = -1 / 0, u = -1 / 0, c = 1 / 0, d = 1 / 0, p = this.vertices, f = 0, m = p.length; m > f; f += 2) {
                        var v = p[f],
                            g = p[f + 1],
                            y = i * v + o * g + a,
                            x = s * g + n * v + h;
            ...
            74: [function(t, e) {
                function i(t, e, i) {
                    r.Sprite.call(this, t), this.tileScale = new r.math.Point(1, 1), this.tilePosition = new r.math.Point(0, 0), this._width = e || 100, this._height = i || 100, this._tileScaleOffset = new r.math.Point(1, 1), this._tilingTexture = null, this._refreshTexture = !1, this._uvs = new n
                }
                var r = t("../core"),
                ...
                i.prototype = Object.create(r.Sprite.prototype), i.prototype.constructor = i, e.exports = i, Object.defineProperties(i.prototype, {
                    ...
                    if (e) {
                        var i = this._uvs;
                        this.tilePosition.x %= e.baseTexture.width * this._tileScaleOffset.x, this.tilePosition.y %= e.baseTexture.height * this._tileScaleOffset.y;
                        ...
                        o /= this.tileScale.x, s /= this.tileScale.y, i.x0 = 0 - r, i.y0 = 0 - n, i.x1 = 1 * o - r, i.y1 = 0 - n, i.x2 = 1 * o - r, i.y2 = 1 * s - n, i.x3 = 0 - r, i.y3 = 1 * s - n;
                        var a = e._uvs,
                            h = e._frame.width,
                            l = e._frame.height;
                        e._uvs = i, e._frame.width = this.width, e._frame.height = this.height, t.setObjectRenderer(t.plugins.sprite), t.plugins.sprite.render(this), e._uvs = a, e._frame.width = h, e._frame.height = l
                    }
                }, i.prototype.renderCanvas = function(t) {
                    if (this.visible && !(this.alpha <= 0)) {
                        var e = t.context;
                        this._mask && t.maskManager.pushMask(this._mask, t), e.globalAlpha = this.worldAlpha;
                        var i, r, n = this.worldTransform,
                            o = t.resolution;
                        if (e.setTransform(n.a * o, n.b * o, n.c * o, n.d * o, n.tx * o, n.ty * o), !this.__tilePattern || this._refreshTexture) {
                    ...
                    var t, e, i, r, n = this._width,
                        ...
                        T = c * a + p * h + m,
                        S = f * h + d * a + v;
                    t = g, t = t > x ? x : t, t = t > b ? b : t, t = t > T ? T : t, i = y, i = i > _ ? _ : i, i = i > w ? w : i, i = i > S ? S : i, e = g, e = x > e ? x : e, e = b > e ? b : e, e = T > e ? T : e, r = y, r = _ > r ? _ : r, r = w > r ? w : r, r = S > r ? S : r;
                    var E = this._bounds;
                    return E.x = t, E.width = e - t, E.y = i, E.height = r - i, this._currentBounds = E, E
                }, i.prototype.onTextureUpdate = function() {}, i.prototype.generateTilingTexture = function(t, e, i) {
                    if (this.texture.baseTexture.hasLoaded) {
                        ...
                        if (i && !e.baseTexture.isPowerOfTwo || l) {
                            n = r.utils.getNextPowerOfTwo(h.width), a = r.utils.getNextPowerOfTwo(h.height), s.texture = e;
                            var u = new o(t, n, a);
                        ...
                        } else this._tilingTexture && this._tilingTexture.isTiling && this._tilingTexture.destroy(!0), this._tileScaleOffset.x = 1, this._tileScaleOffset.y = 1, this._tilingTexture = e;
                        this._refreshTexture = !1, this.originalTexture = this.texture, this._texture = this._tilingTexture
                    }
                    ...
                    r.Sprite.prototype.destroy.call(this), this.tileScale = null, this._tileScaleOffset = null, this.tilePosition = null, this._tilingTexture.destroy(!0), this._tilingTexture = null, this._uvs = null
                }
            }, {
                "../core": 20,
                "../core/textures/RenderTexture": 60,
                "../core/textures/TextureUvs": 62
            }],
            75: [function(t, e) {
                var i = t("../core/math"),
                ...
                n.prototype._cacheAsBitmap = !1, n.prototype._originalRenderWebGL = null, n.prototype._originalRenderCanvas = null, n.prototype._originalUpdateTransform = null, n.prototype._originalHitTest = null, n.prototype._cachedSprite = null, Object.defineProperties(n.prototype, {
                    ...
                    if (!this._cachedSprite) {
                        var e = this.getLocalBounds(),
                            ...
                            a = s;
                        a.tx = -e.x, a.ty = -e.y, this.renderCanvas = this._originalRenderCanvas, n.render(this, a, !0), t.context = i, this.renderCanvas = this._renderCachedCanvas, this.updateTransform = this.displayObjectUpdateTransform, this.getBounds = this._getCahcedBounds, this._cachedSprite = new o(n), this._cachedSprite.worldTransform = this.worldTransform, this._cachedSprite.anchor.x = -(e.x / e.width), this._cachedSprite.anchor.y = -(e.y / e.height), this.hitTest = this._cachedSprite.hitTest.bind(this._cachedSprite)
                    }
            ...
            77: [function(t, e) {
                ...
                var r = t("../../core");
                i.prototype = Object.create(r.AbstractFilter.prototype), i.prototype.constructor = i, e.exports = i, Object.defineProperties(i.prototype, {
                    size: {
                        get: function() {
            ...
            78: [function(t, e) {
                function i() {
                    r.AbstractFilter.call(this), this.blurXFilter = new n, this.blurYFilter = new o, this.defaultFilter = new r.AbstractFilter
                }
                var r = t("../../core"),
                    n = t("../blur/BlurXFilter"),
                    o = t("../blur/BlurYFilter");
                i.prototype = Object.create(r.AbstractFilter.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.applyFilter = function(t, e, i) {
                    var n = t.filterManager.getRenderTarget(!0);
                    this.defaultFilter.applyFilter(t, e, i), this.blurXFilter.applyFilter(t, e, n), t.blendModeManager.setBlendMode(r.CONST.BLEND_MODES.SCREEN), this.blurYFilter.applyFilter(t, n, i), t.blendModeManager.setBlendMode(r.CONST.BLEND_MODES.NORMAL), t.filterManager.returnRenderTarget(n)
                }, Object.defineProperties(i.prototype, {
                    blur: {
                        get: function() {
            ...
            87: [function(t, e) {
                function i(t) {
                    ...
                    }), this.maskSprite = t, this.maskMatrix = e, this.scale = new r.math.Point(20, 20)
                }
                var r = t("../../core");
                i.prototype = Object.create(r.AbstractFilter.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.applyFilter = function(t, e, i) {
                    var r = t.filterManager;
            ...
            93: [function(t, e) {
                function i(t) {
                    ...
                    }), t.baseTexture._powerOf2 = !0, t.baseTexture.hasLoaded ? this.onTextureLoaded() : t.baseTexture.once("loaded", this.onTextureLoaded.bind(this))
                }
                var r = t("../../core");
                i.prototype = Object.create(r.AbstractFilter.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.onTextureLoaded = function() {
            ...
            98: [function(t, e) {
                ...
                var r = t("../../core");
                i.prototype = Object.create(r.AbstractFilter.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.updateDelta = function() {
            ...
            99: [function(t, e) {
                ...
                "../../core": 20,
                "./TiltShiftXFilter": 100,
                "./TiltShiftYFilter": 101
            }],
            100: [function(t, e) {
                function i() {
                    r.call(this)
                ...
                i.prototype = Object.create(r.prototype), i.prototype.constructor = i, e.exports = i, i.prototype.updateDelta = function() {
            ...
            103: [function(t, e) {
                ...
                var r = t("../core");
                i.prototype.constructor = i, e.exports = i, i.prototype.getLocalPosition = function(t, e) {
                    var i = t.worldTransform,
                        ...
                        u = i.ty,
                        c = 1 / (o * l + s * -h);
                    return e = e || new r.math.Point, e.x = l * c * n.x + -s * c * n.y + (u * s - a * l) * c, e.y = o * c * n.y + -h * c * n.x + (-u * o + a * h) * c, e
                }
            }, {
                "../core": 20
            }],
            104: [function(t, e) {
                function i(t) {
                    this.renderer = t, this.mouse = new n, this.eventData = new r.utils.EventData, this.eventData.data = this.mouse, this.interactiveDataPool = [], this.interactionDOMElement = null, this.eventsAdded = !1, this.onMouseUp = this.onMouseUp.bind(this), this.processMouseUp = this.processMouseUp.bind(this), this.onMouseDown = this.onMouseDown.bind(this), this.processMouseDown = this.processMouseDown.bind(this), this.onMouseMove = this.onMouseMove.bind(this), this.processMouseMove = this.processMouseMove.bind(this), this.onMouseOut = this.onMouseOut.bind(this), this.processMouseOverOut = this.processMouseOverOut.bind(this), this.onTouchStart = this.onTouchStart.bind(this), this.processTouchStart = this.processTouchStart.bind(this), this.onTouchEnd = this.onTouchEnd.bind(this), this.processTouchEnd = this.processTouchEnd.bind(this), this.onTouchMove = this.onTouchMove.bind(this), this.processTouchMove = this.processTouchMove.bind(this), this.last = 0, this.currentCursorStyle = "inherit", this._tempPoint = new r.math.Point, this.resolution = 1, this.setTargetElement(this.renderer.view, this.renderer.resolution), this.update()
                }
                var r = t("../core"),
                    n = t("./InteractionData"),
                    o = 10,
                    s = !0;
                i.prototype.constructor = i, e.exports = i, i.prototype.setTargetElement = function(t, e) {
                    ...
                    if (requestAnimationFrame(this.update.bind(this)), !this.throttleUpdate() && this.interactionDOMElement) {
                        if (this.didMove) return void(this.didMove = !1);
                        this.cursor = "inherit", this.processInteractive(this.mouse.global, this.renderer._lastObjectRendered, this.processMouseOverOut.bind(this), !0), this.currentCursorStyle !== this.cursor && (this.currentCursorStyle = this.cursor, this.interactionDOMElement.style.cursor = this.cursor)
                    }
                    ...
                    if (n = n || e.interactive, e.interactiveChildren)
                        for (var a = o.length - 1; a >= 0; a--) !s && r ? s = this.processInteractive(t, o[a], i, !0, n) : this.processInteractive(t, o[a], i, !1, !1);
                    return n && (r && (e.hitArea ? (e.worldTransform.applyInverse(t, this._tempPoint), s = e.hitArea.contains(this._tempPoint.x, this._tempPoint.y)) : e.hitTest && (s = e.hitTest(t))), e.interactive && i(e, s)), s
                }, i.prototype.onMouseDown = function(t) {
                    this.mouse.originalEvent = t, this.eventData.data = this.mouse, this.eventData.stopped = !1, s && this.mouse.originalEvent.preventDefault(), this.processInteractive(this.mouse.global, this.renderer._lastObjectRendered, this.processMouseDown, !0)
                    ...
                    this.mouse.originalEvent = t, this.eventData.data = this.mouse, this.eventData.stopped = !1, this.processInteractive(this.mouse.global, this.renderer._lastObjectRendered, this.processMouseUp, !0)
                    ...
                    this.mouse.originalEvent = t, this.eventData.stopped = !1, this.interactionDOMElement.style.cursor = "inherit", this.mapPositionToPoint(this.mouse.global, t.clientX, t.clientY), this.processInteractive(this.mouse.global, this.renderer._lastObjectRendered, this.processMouseOverOut, !1)
                    ...
                    for (var e = t.changedTouches, i = 0; i < e.length; i++) {
                        ...
                        n.originalEvent = t, this.eventData.data = n, this.eventData.stopped = !1, this.processInteractive(n.global, this.renderer._lastObjectRendered, this.processTouchStart, !0), this.returnTouchData(n)
                    }
                    ...
                    for (var e = t.changedTouches, i = 0; i < e.length; i++) {
                        var r = e[i],
                            n = this.getTouchData(r);
                        n.originalEvent = t, this.eventData.data = n, this.eventData.stopped = !1, this.processInteractive(n.global, this.renderer._lastObjectRendered, this.processTouchEnd, !0), this.returnTouchData(n)
                    }
                    ...
                    for (var e = t.changedTouches, i = 0; i < e.length; i++) {
                        var r = e[i],
                            n = this.getTouchData(r);
                        n.originalEvent = t, this.eventData.data = n, this.eventData.stopped = !1, this.processInteractive(n.global, this.renderer._lastObjectRendered, this.processTouchMove, !1), this.returnTouchData(n)
                    }
                    ...
                    return e || (e = new n), e.identifier = t.identifier, this.mapPositionToPoint(e.global, t.clientX, t.clientY), e
                }, i.prototype.returnTouchData = function(t) {
                    this.interactiveDataPool.push(t)
                }, r.WebGLRenderer.registerPlugin("interaction", i), r.CanvasRenderer.registerPlugin("interaction", i)
            }, {
                "../core": 20,
                "./InteractionData": 103
            }],
            105: [function(t, e) {
                ...
                "./InteractionData": 103,
                "./InteractionManager": 104,
                "./interactiveTarget": 106
            }],
            106: [function(t, e) {
                var i = t("../core"),
                    r = new i.math.Point;
                i.DisplayObject.prototype.interactive = !1, i.DisplayObject.prototype.buttonMode = !1, i.DisplayObject.prototype.interactiveChildren = !0, i.DisplayObject.prototype.defaultCursor = "pointer", i.DisplayObject.prototype._over = !1, i.DisplayObject.prototype._touchDown = !1, i.Sprite.prototype.hitTest = function(t) {
            ...
            107: [function(t, e) {
                var i = t("resource-loader"),
                    ...
                    a = function() {
                        i.call(this), this.use(i.middleware.parsing.json()).use(i.middleware.parsing.blob()).use(r()).use(n()).use(o()).use(s())
                    };
                ...
                e.exports = function() {
                    return function(t, e) {
                        ...
                        this.add(t.name + "_image", a, h, function(i) {
                            ...
                            n.font = o.getAttribute("face"), n.size = parseInt(o.getAttribute("size"), 10), n.lineHeight = parseInt(s.getAttribute("lineHeight"), 10), n.chars = {};
                            for (var a = t.data.getElementsByTagName("char"), h = 0; h < a.length; h++) {
                                var l = parseInt(a[h].getAttribute("id"), 10),
                                    u = new r.math.Rectangle(parseInt(a[h].getAttribute("x"), 10), parseInt(a[h].getAttribute("y"), 10), parseInt(a[h].getAttribute("width"), 10), parseInt(a[h].getAttribute("height"), 10));
                                n.chars[l] = {
                    ...
                    return function(t, e) {
                        if (t.data && t.data.bones) {
                            ...
                            this.add(t.name + "_atlas", o, s, function(i) {
                                ...
                                t.spine = a, t.spineAtlas = o, r.each(o.pages, function(t, e) {
                            ...
                            this.add(t.name + "_image", this.baseUrl + s + "/" + t.data.meta.image, o, function(i) {
                                ...
                                for (var o in r) {
                                    ...
                                    if (s) {
                                        var h = null,
                                            l = null;
                                        if (h = r[o].rotated ? new n.math.Rectangle(s.x, s.y, s.h, s.w) : new n.math.Rectangle(s.x, s.y, s.w, s.h), r[o].trimmed && (l = new n.math.Rectangle(r[o].spriteSourceSize.x / a, r[o].spriteSourceSize.y / a, r[o].sourceSize.w / a, r[o].sourceSize.h / a)), r[o].rotated) {
                                            var u = h.width;
                                            h.width = h.height, h.height = u
                                        }
                                        h.x /= a, h.y /= a, h.width /= a, h.height /= a, t.textures[o] = new n.Texture(i.texture.baseTexture, h, h.clone(), l, r[o].rotated), n.utils.TextureCache[o] = t.textures[o]
                                    }
                                }
                                e()
                            })
            ...
            112: [function(t, e) {
                ...
                e.exports = function() {
                    return function(t, e) {
                        t.data && t.data.nodeName && "img" === t.data.nodeName.toLowerCase() && (t.texture = new i.Texture(new i.BaseTexture(t.data, null, i.utils.getResolutionOfUrl(t.url))), i.utils.TextureCache[t.url] = t.texture), e()
                    }
                }
            }, {
                "../core": 20
            ...
            113: [function(t, e) {
                function i(t) {
                    ...
                    this.spineData = t, this.skeleton = new n.Skeleton(t), this.skeleton.updateWorldTransform(), this.stateData = new n.AnimationStateData(t), this.state = new n.AnimationState(this.stateData), this.slotContainers = [];
                ...
                var r = t("../core"),
                    n = t("./SpineRuntime");
                n.Bone.yDown = !0, i.prototype = Object.create(r.Container.prototype), i.prototype.constructor = i, e.exports = i, Object.defineProperties(i.prototype, {
                    autoUpdate: {
                        get: function() {
                        ...
                        if (a) {
                            ...
                            if (l === n.AttachmentType.region) {
                                if (a.rendererObject && (!s.currentSpriteName || s.currentSpriteName !== a.rendererObject.name)) {
                                    ...
                                    if (void 0 !== s.currentSprite && (s.currentSprite.visible = !1), s.sprites = s.sprites || {}, void 0 !== s.sprites[u]) s.sprites[u].visible = !0;
                                    else {
                                ...
                                var d = s.bone;
                                h.position.x = d.worldX + a.x * d.m00 + a.y * d.m01, h.position.y = d.worldY + a.x * d.m10 + a.y * d.m11, h.scale.x = d.worldScaleX, h.scale.y = d.worldScaleY, h.rotation = -(s.bone.worldRotation * n.degRad), s.currentSprite.tint = r.utils.rgb2hex([s.r, s.g, s.b])
                            } else {
                                ...
                                if (!s.currentMeshName || s.currentMeshName !== a.name) {
                                    var p = a.name;
                                    if (void 0 !== s.currentMesh && (s.currentMesh.visible = !1), s.meshes = s.meshes || {}, void 0 !== s.meshes[p]) s.meshes[p].visible = !0;
                                    else {
                    ...
                    var i = e.rendererObject,
                        ...
                        a = new r.Texture(o, s),
                        h = new r.Sprite(a),
                        l = i.rotate ? .5 * Math.PI : 0;
                    return h.scale.set(i.width / i.originalWidth, i.height / i.originalHeight), h.rotation = l - e.rotation * n.degRad, h.anchor.x = h.anchor.y = .5, t.sprites = t.sprites || {}, t.sprites[i.name] = h, h
                }, i.prototype.createMesh = function(t, e) {
                    var i = e.rendererObject,
                        n = i.page.rendererObject,
                        o = new r.Texture(n),
                        s = new r.Strip(o);
                    return s.drawMode = r.Strip.DrawModes.TRIANGLES, s.canvasPadding = 1.5, s.vertices = new Float32Array(e.uvs.length), s.uvs = e.uvs, s.indices = e.triangles, t.meshes = t.meshes || {}, t.meshes[e.name] = s, s
                }
            }, {
                "../core": 20,
                "./SpineRuntime": 114
            ...
            114: [function(t, e) {
                ...
                r.BoneData = function(t, e) {
                    ...
                    updateWorldTransform: function() {
                        ...
                        if (t) this.worldX = this.x * t.m00 + this.y * t.m01 + t.worldX, this.worldY = this.x * t.m10 + this.y * t.m11 + t.worldY, this.data.inheritScale ? (this.worldScaleX = t.worldScaleX * this.scaleX, this.worldScaleY = t.worldScaleY * this.scaleY) : (this.worldScaleX = this.scaleX, this.worldScaleY = this.scaleY), this.worldRotation = this.data.inheritRotation ? t.worldRotation + this.rotationIK : this.rotationIK, this.worldFlipX = t.worldFlipX != this.flipX, this.worldFlipY = t.worldFlipY != this.flipY;
                            ...
                            this.worldX = e ? -this.x : this.x, this.worldY = i != r.Bone.yDown ? -this.y : this.y, this.worldScaleX = this.scaleX, this.worldScaleY = this.scaleY, this.worldRotation = this.rotationIK, this.worldFlipX = e != this.flipX, this.worldFlipY = i != this.flipY
                        }
                        var n = this.worldRotation * r.degRad,
                            o = Math.cos(n),
                            s = Math.sin(n);
                        this.worldFlipX ? (this.m00 = -o * this.worldScaleX, this.m01 = s * this.worldScaleY) : (this.m00 = o * this.worldScaleX, this.m01 = -s * this.worldScaleY), this.worldFlipY != r.Bone.yDown ? (this.m10 = -s * this.worldScaleX, this.m11 = -o * this.worldScaleY) : (this.m10 = s * this.worldScaleX, this.m11 = o * this.worldScaleY)
                    },
                    ...
                    var l, u, c = r.temp,
                        d = t.parent;
                    d ? (c[0] = i, c[1] = n, d.worldToLocal(c), i = (c[0] - t.x) * d.worldScaleX, n = (c[1] - t.y) * d.worldScaleY) : (i -= t.x, n -= t.y), e.parent == t ? (l = e.x, u = e.y) : (c[0] = e.x, c[1] = e.y, e.parent.localToWorld(c), t.worldToLocal(c), l = c[0], u = c[1]);
                    ...
                    var x = (i * i + n * n - v * v - g * g) / y; - 1 > x ? x = -1 : x > 1 && (x = 1);
                    var _ = Math.acos(x) * o,
                        b = v + g * x,
                        w = g * Math.sin(_),
                        T = Math.atan2(n * b - i * w, i * b + n * w),
                        S = (T - m) * r.radDeg - h;
                    S > 180 ? S -= 360 : -180 > S && (S += 360), t.rotationIK = h + S * s, S = (_ + m) * r.radDeg - a, S > 180 ? S -= 360 : -180 > S && (S += 360), e.rotationIK = a + (S + t.worldRotation - e.parent.worldRotation) * s
                }, r.Skin = function(t) {
                    ...
                    for (var r = 0, n = t.length - i; n >= r; r += i)
                        if (t[r] > e) return r;
                    return -1
                }, r.Curves = function() {
                    this.curves = []
                    ...
                    setCurve: function(t, e, i, r, n) {
                        var o = .1,
                            ...
                            T = this.curves;
                        T[w++] = 2;
                        for (var S = v, E = g, A = w + 19 - 1; A > w; w += 2) T[w] = S, T[w + 1] = E, v += y, g += x, y += _, x += b, S += v, E += g
                    },
                    getCurvePercent: function(t, e) {
                        ...
                        for (var o = 0, s = r, a = r + 19 - 1; a > r; r += 2)
                            if (o = i[r], o >= e) {
                                var h, l;
                                return r == s ? (h = 0, l = 0) : (h = i[r - 2], l = i[r - 1]), l + (i[r + 1] - l) * (e - h) / (o - h)
                            }
                        var u = i[r - 1];
                    ...
                    apply: function(t, e, i, n, o) {
                        ...
                        if (!(i < s[0])) {
                            var a = t.bones[this.boneIndex];
                            if (i >= s[s.length - 3]) return a.x += (a.data.x + s[s.length - 2] - a.x) * o, void(a.y += (a.data.y + s[s.length - 1] - a.y) * o);
                            var h = r.Animation.binarySearch(s, i, 3),
                                l = s[h - 2],
                                u = s[h - 1],
                                c = s[h],
                                d = 1 - (i - c) / (s[h + -3] - c);
                            d = this.curves.getCurvePercent(h / 3 - 1, d), a.x += (a.data.x + l + (s[h + 1] - l) * d - a.x) * o, a.y += (a.data.y + u + (s[h + 2] - u) * d - a.y) * o
                        }
                    }
                    ...
                    apply: function(t, e, i, n, o) {
                        ...
                        if (!(i < s[0])) {
                            var a = t.bones[this.boneIndex];
                            if (i >= s[s.length - 3]) return a.scaleX += (a.data.scaleX * s[s.length - 2] - a.scaleX) * o, void(a.scaleY += (a.data.scaleY * s[s.length - 1] - a.scaleY) * o);
                            var h = r.Animation.binarySearch(s, i, 3),
                                l = s[h - 2],
                                u = s[h - 1],
                                c = s[h],
                                d = 1 - (i - c) / (s[h + -3] - c);
                            d = this.curves.getCurvePercent(h / 3 - 1, d), a.scaleX += (a.data.scaleX * (l + (s[h + 1] - l) * d) - a.scaleX) * o, a.scaleY += (a.data.scaleY * (u + (s[h + 2] - u) * d) - a.scaleY) * o
                        }
                    }
                    ...
                    setFrame: function(t, e, i, r, n, o) {
                        t *= 5, this.frames[t] = e, this.frames[t + 1] = i, this.frames[t + 2] = r, this.frames[t + 3] = n, this.frames[t + 4] = o
                    },
                    apply: function(t, e, i, n, o) {
                        var s = this.frames;
                        if (!(i < s[0])) {
                            ...
                            if (i >= s[s.length - 5]) {
                                ...
                                var d = r.Animation.binarySearch(s, i, 5),
                                    ...
                                    g = s[d],
                                    y = 1 - (i - g) / (s[d - 5] - g);
                                y = this.curves.getCurvePercent(d / 5 - 1, y), a = p + (s[d + 1] - p) * y, h = f + (s[d + 2] - f) * y, l = m + (s[d + 3] - m) * y, u = v + (s[d + 4] - v) * y
                            }
                            var x = t.slots[this.slotIndex];
                            1 > o ? (x.r += (a - x.r) * o, x.g += (h - x.g) * o, x.b += (l - x.b) * o, x.a += (u - x.a) * o) : (x.r = a, x.g = h, x.b = l, x.a = u)
                        }
                    }
                }, r.AttachmentTimeline = function(t) {
                    this.curves = new r.Curves(t), this.frames = [], this.frames.length = t, this.attachmentNames = [], this.attachmentNames.length = t
                    ...
                    apply: function(t, e, i) {
                        ...
                        if (!(i < n[0])) {
                            ...
                            var s = t.drawOrder,
                                ...
                                h = this.drawOrders[o];
                            if (h)
                                for (var l = 0, u = h.length; u > l; l++) s[l] = t.slots[h[l]];
                            else
                                for (var l = 0, u = a.length; u > l; l++) s[l] = a[l]
                        }
                    }
                }, r.FfdTimeline = function(t) {
                    this.curves = new r.Curves(t), this.frames = [], this.frames.length = t, this.frameVertices = [], this.frameVertices.length = t
                        ...
                        if (s.attachment == this.attachment) {
                            ...
                            if (!(i < a[0])) {
                                ...
                                if (u.length != l && (o = 1), u.length = l, i >= a[a.length - 1]) {
                                    var c = h[a.length - 1];
                                    if (1 > o)
                                        for (var d = 0; l > d; d++) u[d] += (c[d] - u[d]) * o;
                                    else
                                        for (var d = 0; l > d; d++) u[d] = c[d]
                                } else {
                    ...
                    apply: function(t, e, i, n, o) {
                        ...
                        if (!(i < s[0])) {
                            ...
                            if (i >= s[s.length - 3]) return a.mix += (s[s.length - 2] - a.mix) * o, void(a.bendDirection = s[s.length - 1]);
                            var h = r.Animation.binarySearch(s, i, 3),
                                l = s[h + -2],
                                u = s[h],
                                c = 1 - (i - u) / (s[h + -3] - u);
                    ...
                    findEvent: function(t) {
                        for (var e = this.events, i = 0, r = e.length; r > i; i++)
                            if (e[i].name == t) return e[i];
                        return null
                    },
                    ...
                    this.ikConstraints = [];
                    for (var e = 0, i = t.ikConstraints.length; i > e; e++) this.ikConstraints.push(new r.IkConstraint(t.ikConstraints[e], this));
                    ...
                    setAttachment: function(t, e) {
                        for (var i = this.slots, r = 0, n = i.length; n > r; r++) {
                            ...
                            if (o.data.name == t) {
                                var s = null;
                                if (e && (s = this.getAttachmentBySlotIndex(r, e), !s)) throw "Attachment not found: " + e + ", for slot: " + t;
                    ...
                    setUVs: function(t, e, i, r, n) {
                        var o = this.uvs;
                        n ? (o[2] = t, o[3] = r, o[4] = t, o[5] = e, o[6] = i, o[7] = e, o[0] = i, o[1] = r) : (o[0] = t, o[1] = r, o[2] = t, o[3] = e, o[4] = i, o[5] = e, o[6] = i, o[7] = r)
                    },
                    updateOffset: function() {
                        var t = this.width / this.regionOriginalWidth * this.scaleX,
                            ...
                            g = s * l,
                            y = this.offset;
                        y[0] = u - p, y[1] = d + c, y[2] = u - g, y[3] = v + c, y[4] = f - g, y[5] = v + m, y[6] = f - p, y[7] = d + m
                    },
                    computeVertices: function(t, e, i, r) {
                        ...
                        var n = i.m00,
                            ...
                            a = i.m11,
                            h = this.offset;
                        r[0] = h[0] * n + h[1] * o + t, r[1] = h[0] * s + h[1] * a + e, r[2] = h[2] * n + h[3] * o + t, r[3] = h[2] * s + h[3] * a + e, r[4] = h[4] * n + h[5] * o + t, r[5] = h[4] * s + h[5] * a + e, r[6] = h[6] * n + h[7] * o + t, r[7] = h[6] * s + h[7] * a + e
                    }
                    ...
                    updateUVs: function() {
                        ...
                        if (this.uvs && this.uvs.length == i || (this.uvs = new r.Float32Array(i)), this.regionRotate)
                            for (var n = 0; i > n; n += 2) this.uvs[n] = this.regionU + this.regionUVs[n + 1] * t, this.uvs[n + 1] = this.regionV + e - this.regionUVs[n] * e;
                        else
                            for (var n = 0; i > n; n += 2) this.uvs[n] = this.regionU + this.regionUVs[n] * t, this.uvs[n + 1] = this.regionV + this.regionUVs[n + 1] * e
                    },
                    ...
                    computeWorldVertices: function(t, e, i, r) {
                        var n, o, s, a, h, l, u, c = i.bone.skeleton.bones,
                            d = this.weights,
                            p = this.bones,
                            f = 0,
                            m = 0,
                        ...
                        if (i.attachmentVertices.length)
                            for (var x = i.attachmentVertices; y > m; f += 2) {
                                for (o = 0, s = 0, n = p[m++] + m; n > m; m++, v += 3, g += 2) a = c[p[m]], h = d[v] + x[g], l = d[v + 1] + x[g + 1], u = d[v + 2], o += (h * a.m00 + l * a.m01 + a.worldX) * u, s += (h * a.m10 + l * a.m11 + a.worldY) * u;
                                r[f] = o + t, r[f + 1] = s + e
                            } else
                                for (; y > m; f += 2) {
                                    for (o = 0, s = 0, n = p[m++] + m; n > m; m++, v += 3) a = c[p[m]], h = d[v], l = d[v + 1], u = d[v + 2], o += (h * a.m00 + l * a.m01 + a.worldX) * u, s += (h * a.m10 + l * a.m11 + a.worldY) * u;
                                    r[f] = o + t, r[f + 1] = s + e
                                }
                    }
                    ...
                    computeWorldVertices: function(t, e, i, r) {
                        t += i.worldX, e += i.worldY;
                        for (var n = i.m00, o = i.m01, s = i.m10, a = i.m11, h = this.vertices, l = 0, u = h.length; u > l; l += 2) {
                            var c = h[l],
                                d = h[l + 1];
                ...
                }, r.TrackEntry = function() {}, r.TrackEntry.prototype = {
                    next: null,
                    previous: null,
                    animation: null,
                    loop: !1,
                    ...
                    addAnimation: function(t, e, i, n) {
                        ...
                        return 0 >= n && (s ? n += s.endTime - this.data.getMix(s.animation, e) : n = 0), o.delay = n, o
                    },
                    ...
                    readSkeletonData: function(t, e) {
                        ...
                        for (var o = t.bones, s = 0, a = o.length; a > s; s++) {
                            ...
                            u.length = (h.length || 0) * this.scale, u.x = (h.x || 0) * this.scale, u.y = (h.y || 0) * this.scale, u.rotation = h.rotation || 0, u.scaleX = h.hasOwnProperty("scaleX") ? h.scaleX : 1, u.scaleY = h.hasOwnProperty("scaleY") ? h.scaleY : 1, u.inheritScale = h.hasOwnProperty("inheritScale") ? h.inheritScale : !0, u.inheritRotation = h.hasOwnProperty("inheritRotation") ? h.inheritRotation : !0, i.bones.push(u)
                        }
                        var c = t.ik;
                        if (c)
                            for (var s = 0, a = c.length; a > s; s++) {
                                for (var d = c[s], p = new r.IkConstraintData(d.name), o = d.bones, f = 0, m = o.length; m > f; f++) {
                                ...
                                p.bendDirection = !d.hasOwnProperty("bendPositive") || d.bendPositive ? 1 : -1, p.mix = d.hasOwnProperty("mix") ? d.mix : 1, i.ikConstraints.push(p)
                            }
                        for (var g = t.slots, s = 0, a = g.length; a > s; s++) {
                            ...
                            var x = new r.SlotData(y.name, u),
                                _ = y.color;
                            _ && (x.r = this.toColor(_, 0), x.g = this.toColor(_, 1), x.b = this.toColor(_, 2), x.a = this.toColor(_, 3)), x.attachmentName = y.attachment, x.additiveBlending = y.additive && "true" == y.additive, i.slots.push(x)
                        }
                        var b = t.skins;
                        for (var w in b)
                        ...
                        for (var O in P)
                            if (P.hasOwnProperty(O)) {
                                var D = P[O],
                                    F = new r.EventData(O);
                                F.intValue = D["int"] || 0, F.floatValue = D["float"] || 0, F.stringValue = D.string || null, i.events.push(F)
                            }
                        var L = t.animations;
                    ...
                    readAttachment: function(t, e, i) {
                        ...
                        if (n == r.AttachmentType.region) {
                            ...
                            if (!a) return null;
                            a.path = o, a.x = (i.x || 0) * s, a.y = (i.y || 0) * s, a.scaleX = i.hasOwnProperty("scaleX") ? i.scaleX : 1, a.scaleY = i.hasOwnProperty("scaleY") ? i.scaleY : 1, a.rotation = i.rotation || 0, a.width = (i.width || 0) * s, a.height = (i.height || 0) * s;
                            var h = i.color;
                        ...
                        if (n == r.AttachmentType.mesh) {
                            ...
                            return l ? (l.path = o, l.vertices = this.getFloatArray(i, "vertices", s), l.triangles = this.getIntArray(i, "triangles"), l.regionUVs = this.getFloatArray(i, "uvs", 1), l.updateUVs(), h = i.color, h && (l.r = this.toColor(h, 0), l.g = this.toColor(h, 1), l.b = this.toColor(h, 2), l.a = this.toColor(h, 3)), l.hullLength = 2 * (i.hull || 0), i.edges && (l.edges = this.getIntArray(i, "edges")), l.width = (i.width || 0) * s, l.height = (i.height || 0) * s, l) : null
                        }
                        if (n == r.AttachmentType.skinnedmesh) {
                            var l = this.attachmentLoader.newSkinnedMeshAttachment(t, e, o);
                            if (!l) return null;
                            l.path = o;
                            for (var u = this.getFloatArray(i, "uvs", 1), c = this.getFloatArray(i, "vertices", 1), d = [], p = [], f = 0, m = c.length; m > f;) {
                                var v = 0 | c[f++];
                                p[p.length] = v;
                                for (var g = f + 4 * v; g > f;) p[p.length] = c[f], d[d.length] = c[f + 1] * s, d[d.length] = c[f + 2] * s, d[d.length] = c[f + 3], f += 4
                            }
                            return l.bones = p, l.weights = d, l.triangles = this.getIntArray(i, "triangles"), l.regionUVs = u, l.updateUVs(), h = i.color, h && (l.r = this.toColor(h, 0), l.g = this.toColor(h, 1), l.b = this.toColor(h, 2), l.a = this.toColor(h, 3)), l.hullLength = 2 * (i.hull || 0), i.edges && (l.edges = this.getIntArray(i, "edges")), l.width = (i.width || 0) * s, l.height = (i.height || 0) * s, l
                        }
                        if (n == r.AttachmentType.boundingbox) {
                            for (var y = this.attachmentLoader.newBoundingBoxAttachment(t, e), c = i.vertices, f = 0, m = c.length; m > f; f++) y.vertices.push(c[f] * s);
                            return y
                        }
                    ...
                    readAnimation: function(t, e, i) {
                                ...
                                for (var u in E)
                                    if (E.hasOwnProperty(u)) {
                                        ...
                                        if ("rotate" == u) {
                                            ...
                                            var d, A = 1;
                                            "scale" == u ? d = new r.ScaleTimeline(c.length) : (d = new r.TranslateTimeline(c.length), A = this.scale), d.boneIndex = S;
                                            for (var p = 0, f = 0, m = c.length; m > f; f++) {
                                                var v = c[f],
                                                    C = (v.x || 0) * A,
                                                    M = (v.y || 0) * A;
                                            ...
                                            if ("flipX" != u && "flipY" != u) throw "Invalid timeline type for a bone: " + u + " (" + T + ")";
                                            var C = "flipX" == u,
                        ...
                        for (var I in k) {
                            ...
                            for (a in h) {
                                ...
                                for (var U in N) {
                                    ...
                                    var j, z = X.type == r.AttachmentType.mesh;
                                    ...
                                    for (var p = 0, f = 0, m = c.length; m > f; f++) {
                                        ...
                                        if (v.vertices) {
                                            ...
                                            var G = v.offset || 0,
                                                H = W.length;
                                            if (1 == this.scale)
                                                for (var V = 0; H > V; V++) Y[V + G] = W[V];
                                            else
                                                for (var V = 0; H > V; V++) Y[V + G] = W[V] * this.scale;
                                            if (z)
                                                for (var q = X.vertices, V = 0, H = Y.length; H > V; V++) Y[V] += q[V]
                        ...
                        if (K || (K = e.draworder), K) {
                            for (var d = new r.DrawOrderTimeline(K.length), Q = i.slots.length, p = 0, f = 0, m = K.length; m > f; f++) {
                                var $ = K[f],
                                    J = null;
                                if ($.offsets) {
                                    J = [], J.length = Q;
                        ...
                        if (ne) {
                            for (var d = new r.EventTimeline(ne.length), p = 0, f = 0, m = ne.length; m > f; f++) {
                                ...
                                ae.intValue = oe.hasOwnProperty("int") ? oe["int"] : se.intValue, ae.floatValue = oe.hasOwnProperty("float") ? oe["float"] : se.floatValue, ae.stringValue = oe.hasOwnProperty("string") ? oe.string : se.stringValue, d.setFrame(p++, oe.time, ae)
                            }
                            n.push(d), o = Math.max(o, d.frames[d.getFrameCount() - 1])
                        }
                    ...
                    e && e.indexOf("/") !== e.length && (e += "/"), this.pages = [], this.regions = [], this.texturesLoading = 0;
                    ...
                    for (var a = null;;) {
                        ...
                        if (h = o.trim(h), h.length)
                            if (a) {
                                ...
                                var d = parseInt(s[0]),
                                    p = parseInt(s[1]);
                                l.u = u / a.width, l.v = c / a.height, l.rotate ? (l.u2 = (u + p) / a.width, l.v2 = (c + d) / a.height) : (l.u2 = (u + d) / a.width, l.v2 = (c + p) / a.height), l.x = u, l.y = c, l.width = Math.abs(d), l.height = Math.abs(p), 4 == o.readTuple(s) && (l.splits = [parseInt(s[0]), parseInt(s[1]), parseInt(s[2]), parseInt(s[3])], 4 == o.readTuple(s) && (l.pads = [parseInt(s[0]), parseInt(s[1]), parseInt(s[2]), parseInt(s[3])], o.readTuple(s))), l.originalWidth = parseInt(s[0]), l.originalHeight = parseInt(s[1]), o.readTuple(s), l.offsetX = parseInt(s[0]), l.offsetY = parseInt(s[1]), l.index = parseInt(o.readValue()), this.regions.push(l)
                            } else {
                                a = new r.AtlasPage, a.name = h, 2 == o.readTuple(s) && (a.width = parseInt(s[0]), a.height = parseInt(s[1]), o.readTuple(s)), a.format = r.Atlas.Format[s[0]], o.readTuple(s), a.minFilter = r.Atlas.TextureFilter[s[0]], a.magFilter = r.Atlas.TextureFilter[s[1]];
                                var f = o.readValue();
                                a.uWrap = r.Atlas.TextureWrap.clampToEdge, a.vWrap = r.Atlas.TextureWrap.clampToEdge, "x" == f ? a.uWrap = r.Atlas.TextureWrap.repeat : "y" == f ? a.vWrap = r.Atlas.TextureWrap.repeat : "xy" == f && (a.uWrap = a.vWrap = r.Atlas.TextureWrap.repeat), a.rendererObject = i.BaseTexture.fromImage(e + h, n), this.pages.push(a)
                            }
                        else a = null
                    }
                }, r.Atlas.prototype = {
                    ...
                    clampToEdge: 1,
                    repeat: 2
                }, r.AtlasPage = function() {}, r.AtlasPage.prototype = {
                    name: null,
                    format: null,
                    minFilter: null,
                    magFilter: null,
                    ...
                    width: 0,
                    height: 0
                }, r.AtlasRegion = function() {}, r.AtlasRegion.prototype = {
                    page: null,
                    name: null,
                    x: 0,
                    y: 0,
                    ...
                    newMeshAttachment: function(t, e, i) {
                        ...
                        return o.rendererObject = n, o.regionU = n.u, o.regionV = n.v, o.regionU2 = n.u2, o.regionV2 = n.v2, o.regionRotate = n.rotate, o.regionOffsetX = n.offsetX, o.regionOffsetY = n.offsetY, o.regionWidth = n.width, o.regionHeight = n.height, o.regionOriginalWidth = n.originalWidth, o.regionOriginalHeight = n.originalHeight, o
                    },
                    ...
                    update: function(t, e) {
                        ...
                        for (var u = 0; n > u; u++) {
                            ...
                            if (p.type == r.AttachmentType.boundingbox) {
                                a.push(p);
                                var f, m = h.length;
                                m > 0 ? (f = h[m - 1], h.splice(m - 1, 1)) : f = [], l.push(f), f.length = p.vertices.length, p.computeWorldVertices(o, s, d.bone, f)
                            }
                        }
                        e && this.aabbCompute()
                    },
                    aabbCompute: function() {
                        for (var t = this.polygons, e = Number.MAX_VALUE, i = Number.MAX_VALUE, r = Number.MIN_VALUE, n = Number.MIN_VALUE, o = 0, s = t.length; s > o; o++)
                    ...
                    polygonIntersectsSegment: function(t, e, i, r, n) {
                        for (var o = t.length, s = e - r, a = i - n, h = e * n - i * r, l = t[o - 2], u = t[o - 1], c = 0; o > c; c += 2) {
                            var d = t[c],
                                p = t[c + 1],
                                f = l * p - u * d,
                                m = l - d,
                            ...
                            if ((y >= l && d >= y || y >= d && l >= y) && (y >= e && r >= y || y >= r && e >= y)) {
                                var x = (h * v - a * f) / g;
                                if ((x >= u && p >= x || x >= p && u >= x) && (x >= i && n >= x || x >= n && i >= x)) return !0
                            }
                            l = d, u = p
                        }
                        return !1
            ...
            116: [function(t, e) {
                function i(t, e) {
                    r.Container.call(this), this.textWidth = 0, this.textHeight = 0, this._glyphs = [], this._style = {
                        tint: e.tint,
                        align: e.align,
                        fontName: null,
                        fontSize: 0
                ...
                var r = t("../core");
                i.prototype = Object.create(r.Container.prototype), i.prototype.constructor = i, e.exports = i, Object.defineProperties(i.prototype, {
                    tint: {
                        get: function() {
                    ...
                    font: {
                        ...
                        set: function(t) {
                            "string" == typeof t ? (t = t.split(" "), this._style.fontName = t.slice(1).join(" "), this._style.fontSize = t.length >= 2 ? parseInt(t[0], 10) : i.fonts[this.fontName].size) : (this._style.fontName = t.name, this._style.fontSize = "number" == typeof t.size ? t.size : parseInt(t.size, 10)), this.dirty = !0
                        }
                    },
                    text: {
                        get: function() {
                    ...
                    for (var t = i.fonts[this.fontName], e = new r.math.Point, n = null, o = [], s = 0, a = 0, h = [], l = 0, u = this.fontSize / t.size, c = -1, d = 0; d < this.text.length; d++) {
                        var p = this.text.charCodeAt(d);
                        if (c = /(\s)/.test(this.text.charAt(d)) ? d : c, /(?:\r\n|\r|\n)/.test(this.text.charAt(d))) h.push(s), a = Math.max(a, s), l++, e.x = 0, e.y += t.lineHeight, n = null;
                        else if (-1 !== c && this.maxWidth > 0 && e.x * u > this.maxWidth) o.splice(c, d - c), d = c, c = -1, h.push(s), a = Math.max(a, s), l++, e.x = 0, e.y += t.lineHeight, n = null;
                        else {
                            var f = t.chars[p];
                            f && (n && f.kerning[n] && (e.x += f.kerning[n]), o.push({
                                texture: f.texture,
                                line: l,
                                charCode: p,
                                position: new r.math.Point(e.x + f.xOffset, e.y + f.yOffset)
                            }), s = e.x + (f.texture.width + f.xOffset), e.x += f.xAdvance, n = p)
                        }
                    }
                    ...
                    for (d = 0; l >= d; d++) {
                        var v = 0;
                        "right" === this.style.align ? v = a - h[d] : "center" === this.style.align && (v = (a - h[d]) / 2), m.push(v)
                    }
                    var g = o.length,
                        y = this.tint;
                    for (d = 0; g > d; d++) {
                        var x = this._glyphs[d];
                        x ? x.texture = o[d].texture : (x = new r.Sprite(o[d].texture), this._glyphs.push(x)), x.position.x = (o[d].position.x + m[o[d].line]) * u, x.position.y = o[d].position.y * u, x.scale.x = x.scale.y = u, x.tint = y, x.parent || this.addChild(x)
                    }
            ...
            117: [function(t, e) {
                function i(t, e, i) {
                    this.canvas = document.createElement("canvas"), this.context = this.canvas.getContext("2d"), this.resolution = i || r.RESOLUTION, this._text = null, this._style = null, r.Sprite.call(this, r.Texture.fromCanvas(this.canvas)), this.text = t, this.style = e
                }
                var r = t("../core");
                i.prototype = Object.create(r.Sprite.prototype), i.prototype.constructor = i, e.exports = i, i.fontPropertiesCache = {}, i.fontPropertiesCanvas = document.createElement("canvas"), i.fontPropertiesContext = i.fontPropertiesCanvas.getContext("2d"), Object.defineProperties(i.prototype, {
                    width: {
                        get: function() {
                    ...
                    style: {
                        ...
                        set: function(t) {
                            t = t || {}, t.font = t.font || "bold 20pt Arial", t.fill = t.fill || "black", t.align = t.align || "left", t.stroke = t.stroke || "black", t.strokeThickness = t.strokeThickness || 0, t.wordWrap = t.wordWrap || !1, t.wordWrapWidth = t.wordWrapWidth || 100, t.dropShadow = t.dropShadow || !1, t.dropShadowColor = t.dropShadowColor || "#000000", t.dropShadowAngle = t.dropShadowAngle || Math.PI / 6, t.dropShadowDistance = t.dropShadowDistance || 5, this._style = t, this.dirty = !0
                        }
                    },
                    text: {
                        get: function() {
                    ...
                    for (var e = t.wordWrap ? this.wordWrap(this._text) : this._text, i = e.split(/(?:\r\n|\r|\n)/), r = new Array(i.length), n = 0, o = this.determineFontProperties(t.font), s = 0; s < i.length; s++) {
                    ...
                    var l = o.fontSize + t.strokeThickness,
                        u = l * i.length;
                    t.dropShadow && (u += t.dropShadowDistance), this.canvas.height = u * this.resolution, this.context.scale(this.resolution, this.resolution), navigator.isCocoonJS && this.context.clearRect(0, 0, this.canvas.width, this.canvas.height), this.context.font = t.font, this.context.strokeStyle = t.stroke, this.context.lineWidth = t.strokeThickness, this.context.textBaseline = "alphabetic";
                    var c, d;
                    if (t.dropShadow) {
                        ...
                        for (s = 0; s < i.length; s++) c = t.strokeThickness / 2, d = t.strokeThickness / 2 + s * l + o.ascent, "right" === t.align ? c += n - r[s] : "center" === t.align && (c += (n - r[s]) / 2), t.fill && this.context.fillText(i[s], c + p, d + f)
                    }
                    for (this.context.fillStyle = t.fill, s = 0; s < i.length; s++) c = t.strokeThickness / 2, d = t.strokeThickness / 2 + s * l + o.ascent, "right" === t.align ? c += n - r[s] : "center" === t.align && (c += (n - r[s]) / 2), t.stroke && t.strokeThickness && this.context.strokeText(i[s], c, d), t.fill && this.context.fillText(i[s], c, d);
                    this.updateTexture()
                }, i.prototype.updateTexture = function() {
                    this._texture.baseTexture.hasLoaded = !0, this._texture.baseTexture.resolution = this.resolution, this._texture.baseTexture.width = this.canvas.width / this.resolution, this._texture.baseTexture.height = this.canvas.height / this.resolution, this._texture.crop.width = this._texture._frame.width = this.canvas.width / this.resolution, this._texture.crop.height = this._texture._frame.height = this.canvas.height / this.resolution, this._width = this.canvas.width / this.resolution, this._height = this.canvas.height / this.resolution, this._texture.update(), this.dirty = !1
                }, i.prototype.renderWebGL = function(t) {
                    this.dirty && (this.resolution = t.resolution, this.updateText()), r.Sprite.prototype.renderWebGL.call(this, t)
                }, i.prototype.renderCanvas = function(t) {
                    this.dirty && (this.resolution = t.resolution, this.updateText()), r.Sprite.prototype.renderCanvas.call(this, t)
                    ...
                    if (!e) {
                        ...
                        var o = Math.ceil(n.measureText("|Mq").width),
                            ...
                            a = 2 * s;
                        s = 1.4 * s | 0, r.width = o, r.height = a, n.fillStyle = "#f00", n.fillRect(0, 0, o, a), n.font = t, n.textBaseline = "alphabetic", n.fillStyle = "#000", n.fillText("|M�q", 0, s);
                        ...
                        e.descent = h - s, e.descent += 6, e.fontSize = e.ascent + e.descent, i.fontPropertiesCache[t] = e
                    }
                    return e
    ...
    function(t) {
        ...
        e.prototype = {
            ...
            _registerListener: function(t, i, r, n) {
                var o, s = this._indexOfListener(t, r);
                if (-1 !== s) {
                    if (o = this._bindings[s], o.isOnce() !== i) throw new Error("You cannot add" + (i ? "" : "Once") + "() then add" + (i ? "Once" : "") + "() the same listener without removing the relationship first.")
        ...
        var n = r;
        n.Signal = r, "function" == typeof define && define.amd ? define("signals", [], function() {
            return n
        }) : "undefined" != typeof module && module.exports ? module.exports = n : t.signals = n
    }(this), define("com/fido/loader/Cache", ["require", "exports", "module"], function(t, e, i) {
        var r = function() {
        ...
        s.prototype.addFonts = function(t) {
            ...
            t.type === s.CUSTOM ? (t.object.onLoaded.addOnce(this._onFileLoaded, this), t.object.load()) : (this.ajaxRequest.open("GET", t.url, !0), this.ajaxRequest.send())
            ...
            return 0 === this.pixiAssetsToLoad.length ? void this._onComplete() : (this.pixiAssetLoader = new r.loaders.Loader, this.pixiAssetLoader.addList(this.pixiAssetsToLoad), void this.pixiAssetLoader.load(function() {
                this._onProgress(), this._onComplete()
            }.bind(this)))
        }, s.prototype._loadFonts = function() {
            return 0 === this.fontsToLoad.length ? void this._loadFiles() : (WebFontConfig = {
                    google: {
            ...
            this.pixiAssetLoader && (t += this.pixiAssetsToLoad.length - this.pixiAssetLoader.loadCount), this.onProgress.dispatch(1)
        }, s.TEXT = 0, s.JSON = 1, s.CUSTOM = 2, i.exports = s
    ...
    }), define("com/fido/app/ScreenManager", ["require", "exports", "module", "PIXI", "./transitions/AlphaTransition"], function(t, e, i) {
        var r = t("PIXI"),
            n = t("./transitions/AlphaTransition"),
            o = function(t, e, i) {
                this.container = t || new r.DisplayObjectContainer, this.screens = {}, this.currentScreen, this.fading = !1, this.w = e || 400, this.h = i || 400, this.history = [], this.defaultTransition = new n, this.transition = this.defaultTransition, this.active = !1
            };
        o.constructor = o, o.prototype.gotoScreenByID = function(t, e) {
            ...
            if (this.currentScreen !== t && (this.history.push(t), this.nextScreen = t, !this.active)) {
                ...
                this.nextScreen && this.nextScreen.resize && this.nextScreen.resize(this.w, this.h), this.currentScreen = t, this.transition.begin(this, e, this.nextScreen)
            }
        ...
        Device = function() {
            ...
            this._checkBrowser(t), this._checkOS(t), this._checkDevice(t), this._checkAudio(), this._checkFeatures(), this._checkIsMobile()
        }, Device.prototype._checkBrowser = function(t) {
            /Arora/.test(t) ? this.arora = !0 : /Chrome/.test(t) ? this.chrome = !0 : /Epiphany/.test(t) ? this.epiphany = !0 : /Firefox/.test(t) ? this.firefox = !0 : /Mobile Safari/.test(t) ? this.mobileSafari = !0 : /MSIE (\d+\.\d+);/.test(t) || navigator.userAgent.match(/Trident.*rv[ :]*11\./) ? (this.ie = !0, this.ieVersion = parseInt(RegExp.$1, 10)) : /Midori/.test(t) ? this.midori = !0 : /Opera/.test(t) ? this.opera = !0 : /Safari/.test(t) && (this.safari = !0), navigator.standalone && (this.webApp = !0), navigator.isCocoonJS && (this.cocoonJS = !0)
            ...
            }(navigator.userAgent || navigator.vendor || window.opera), this.isMobile = t
    ...
    }), define("com/fido/app/LoaderScreen", ["require", "exports", "module", "PIXI", "com/fido/system/Ticker", "com/fido/utils/FrameWait", "signals"], function(t, e, i) {
        var r = t("PIXI"),
            n = t("com/fido/system/Ticker"),
            o = t("com/fido/utils/FrameWait"),
            s = t("signals"),
            a = function(t) {
                r.DisplayObjectContainer.call(this), this.app = t, this.easeLoad = 0, this.targetLoad = 0, this.onReady = new s, this.onComplete = new s, this.bar = new r.Sprite, this.initLoader()
            };
        a.prototype = Object.create(r.DisplayObjectContainer.prototype), a.prototype.initLoader = function() {
            ...
            this.easeLoad += .3 * (this.targetLoad - this.easeLoad), this.easeLoad > .99 && (this.easeLoad = 1, n.instance.remove(this.update, this), this.onComplete.dispatch()), this.bar.scale.x = this.easeLoad
    ...
    }), define("com/fido/app/OrientationManager", ["require", "exports", "module", "com/fido/system/Ticker"], function(t, e, i) {
        var r = t("com/fido/system/Ticker"),
            n = function(t) {
                this.mode = t, this.rotateScreen = new Image, this.rotateScreen.src = ASSET_URL + "img/rotate-device.png", this.rotateScreen.style.position = "absolute", this.rotateScreen.style.top = "0", this.rotateScreen.style.left = "0", this.rotateScreen.style.zIndex = 1e7, this.rotateScreen.style.display = "none", this.rotateScreen.width = 446, this.rotateScreen.height = 288, document.body.appendChild(this.rotateScreen), this.supportsOrientationChange = "onorientationchange" in window, this.supportsOrientationChange && window.addEventListener("orientationchange", this.checkOrientation.bind(this), !1)
            };
        n.constructor = n, n.prototype.checkOrientation = function() {
            90 === window.orientation || -90 === window.orientation ? (r.instance.stop(), this.rotateScreen.style.display = "block") : (r.instance.start(), this.rotateScreen.style.display = "none")
        }, n.prototype.check = function(t, e) {
            var i = 0 === this.mode ? !(e > t) : e > t,
                n = t / 892,
                o = e / 576,
                s = Math.max(n, o);
            this.rotateScreen.width = 892 * s, this.rotateScreen.height = 576 * s, this.rotateScreen.style.left = t / 2 - this.rotateScreen.width / 2 + "px", this.rotateScreen.style.top = e / 2 - this.rotateScreen.height / 2 + "px", this.supportsOrientationChange || (i ? (r.instance.stop(), this.rotateScreen.style.display = "block") : (r.instance.start(), this.rotateScreen.style.display = "none"))
        }, i.exports = n
    }), define("com/fido/app/App", ["require", "exports", "module", "PIXI", "com/fido/loader/Loader", "com/fido/app/ScreenManager", "com/fido/system/Ticker", "com/fido/system/Device", "com/fido/app/LoaderScreen", "com/fido/app/OrientationManager", "signals"], function(t, e, i) {
        var r = t("PIXI"),
            ...
            c = function(t) {
                ...
                this.setupPixi(), s.instance.start(), s.instance.add(this.update, this), this.screenManager = new o(null, 300, 300), this.loader = new n, this.onReady = new u, this.options.orientationMode !== c.orientationModes.BOTH && (this.orientationManager = new l(this.options.orientationMode)), this.stage.addChild(this.screenManager.container), this.active = !0
            };
        c.prototype.setupPixi = function() {
            var t = this.options;
            r.utils.sayHello = function() {}, t.forceCanvas || a.instance.android && !a.instance.chrome ? (this.renderer = new r.CanvasRenderer(t.width, t.height), this.renderer.clearBeforeRender = !1) : this.renderer = r.autoDetectRenderer(t.width, t.height, {
                backgroundColor: 1
            }), window.WEBGL = r.isWebGL = this.renderer instanceof r.WebGLRenderer, this.view = this.renderer.view, this.stage = new r.Stage(t.backgroundColor), this.view.style.position = "absolute", r.stage = this.stage
        }, c.prototype.update = function() {
            this.renderer.render(this.stage)
        }, c.prototype.startup = function() {
            this.loaderScreen = new this.options.loaderScreen(this), this.loaderScreen.onReady.addOnce(this.onLoaderScreenReady, this), this.loaderScreen.onComplete.addOnce(this.onLoaderScreenComplete, this), this.screenManager.addScreen(this.loaderScreen, "loader"), this.screenManager.gotoScreenByID("loader")
        ...
        }, c.prototype.onAssetsLoaded = function() {}, c.prototype.onProgresss = function(t) {
            this.loaderScreen.updateProgress(t)
        }, c.prototype.onLoaderScreenComplete = function() {
            this.onReady.dispatch()
        }, c.prototype.resize = function(t, e) {
            this.orientationManager && this.orientationManager.check(t, e), this.options.resizeMode === c.resizeModes.DEFUALT ? (this.renderer.resize(t, e), this.view.style.width = "auto", this.view.style.height = "auto") : this.this.options.resizeMode === c.resizeModes.CSS_RESIZE_PRESERVE_RATIO || this.options.resizeMode === c.resizeModes.CSS_RESIZE && (this.view.style.width = t + "px", this.view.style.height = e + "px")
        }, c.resizeModes = {
            DEFUALT: 0,
    ...
    }), define("com/fido/sound/SoundManager", ["require", "exports", "module", "signals", "com/fido/system/VisibilityChecker"], function(t, e, i) {
        var r = t("signals"),
            n = t("com/fido/system/VisibilityChecker"),
            o = function() {
                this.disabled = !1, this.preload = !0, this.sounds = {}, this.groups = {}, this.globalVolume = 1, this.isMuted = !1, this.onMuteToggle = new r
            };
        o.prototype.addSound = function(t, e, i) {
            ...
            if (!this.disabled) {
                ...
                i._playbackSpeed = e;
                var r = "music" == t ? 0 : 1;
                i._webAudio && Howler._howls[r]._audioNode[0] && (Howler._howls[r]._audioNode[0].bufferSource.playbackRate.value = e)
            }
        ...
        }, o.sfx = new o, o.music = new o, o.sfx.disabled = !Howler.usingWebAudio, n.onHide.add(Howler.mute, Howler), n.onShow.add(Howler.unmute, Howler), i.exports = o
        ...
        var r = t("signals"),
            n = function(t) {
                ...
                this.view = t, this.onPress = new r, this.onDown = new r, this.onUp = new r, this.view.interactive = !0, this.view.buttonMode = !0, this.view.mousedown = this.view.touchstart = this.onDown.dispatch.bind(this, this), this.view.mouseup = this.view.touchend = this.onUp.dispatch.bind(this, this), this.view.click = this.view.tap = this.onPress.dispatch.bind(this, this)
            };
        n.constructor = n, i.exports = n
    }), define("com/fido/utils/ThreeSlice", ["require", "exports", "module", "PIXI"], function(t, e, i) {
        var r = t("PIXI"),
            n = function(t, e, i) {
                this.left = new r.Sprite(t), this.middle = new r.Sprite(e), this.right = new r.Sprite(i), r.DisplayObjectContainer.call(this), this.addChild(this.left), this.addChild(this.middle), this.addChild(this.right)
            };
        n.prototype = Object.create(r.DisplayObjectContainer.prototype), Object.defineProperty(n.prototype, "width", {
            get: function() {
                return this._width
            },
            set: function(t) {
                this._width = t, this.left.position.x = 0, this.middle.position.x = this.left.width, this.middle.width = t - (this.left.width + this.right.width), this.right.position.x = this.middle.position.x + this.middle.width - 1
            }
        }), n.fromFrames = function(t, e, i) {
            return new n(r.Texture.fromFrame(t), r.Texture.fromFrame(e), r.Texture.fromFrame(i))
        }, i.exports = n
    }), define("com/nebulon/app/buttons/AabButton", ["require", "exports", "module", "PIXI", "com/fido/ui/buttons/Button", "com/fido/utils/ThreeSlice"], function(t, e, i) {
        var r = t("PIXI"),
            n = t("com/fido/ui/buttons/Button"),
            o = t("com/fido/utils/ThreeSlice"),
            s = function(t) {
                this.label = new r.Text(t, {
                    fill: "#FFFFFF"
                }), this.label.x = 23, this.label.y = 32;
                var e = this.createBackground(this.label.width);
                e.addChild(this.label), n.call(this, e)
            };
        s.prototype = Object.create(n.prototype), s.prototype.createBackground = function(t) {
            ...
            e.addChildAt(i, 0), e.width = Math.max(t + 40, 90), i.scale.x = (e.width - 14) / 100, i.position.x = 10, i.position.y = 11;
            var n = !0;
            return n && (this.rollover = r.Sprite.fromFrame("3_slice_halftone_rollover.png"), this.rollover.width = 2 * e.width, this.rollover.height = 71, this.rollover.y = 10, this.rollover.x = 2 * -e.width, e.addChildAt(this.rollover, 1), this.rolloverMask = (new r.Graphics).beginFill(16763904).drawRect(0, 0, 100, 71), this.rolloverMask.position.x = 10, this.rolloverMask.position.y = 11, this.rolloverMask.scale.x = i.scale.x, this.rollover.mask = this.rolloverMask, e.addChild(this.rolloverMask), e.mouseover = this.onMouseOver.bind(this), e.mouseout = this.onMouseOut.bind(this), e.touchstart = this.onMouseOver.bind(this), e.touchend = e.touchendoutside = this.onMouseOut.bind(this)), e.hitArea = new r.Rectangle(0, 0, Math.max(t + 40, 90), 90), e
    ...
    }), define("com/nebulon/app/buttons/BaseAabButton", ["require", "exports", "module", "PIXI", "com/fido/ui/buttons/Button", "com/fido/utils/ThreeSlice", "com/fido/system/Ticker"], function(t, e, i) {
        var r = t("PIXI"),
            n = t("com/fido/ui/buttons/Button"),
            o = t("com/fido/utils/ThreeSlice"),
            s = (t("com/fido/system/Ticker"), function(t) {
                n.call(this, t)
            });
        s.prototype = Object.create(n.prototype), s.prototype.createBackground = function(t, e) {
            e = e || 1, t /= e;
            ...
            i.addChildAt(n, 0), i.width = Math.max(t + 40, 90), n.scale.x = (i.width - 14) / 100, n.position.x = 10, n.position.y = 11;
            ...
            this.rollover = r.Sprite.fromFrame("3_slice_halftone_rollover.png"), this.rollover.width = 2 * this.bg.width, this.rollover.height = 71, this.rollover.y = 10, this.rollover.x = 2 * -this.bg.width, this.bg.addChildAt(this.rollover, 1), this.rolloverMask = (new r.Graphics).beginFill(16763904).drawRect(0, 0, 100, 71), this.rolloverMask.position.x = 10, this.rolloverMask.position.y = 11, this.rolloverMask.scale.x = this.blueBg.scale.x, this.rollover.mask = this.rolloverMask, this.bg.addChild(this.rolloverMask), this.view.mouseover = this.onMouseOver.bind(this), this.view.mouseout = this.onMouseOut.bind(this), this.view.touchstart = this.onMouseOver.bind(this), this.view.touchend = this.view.touchendoutside = this.onMouseOut.bind(this), this.count = 0, this.scale = 1, this.intensity = .1, this.defaultScale = 1, this.overScale = 1.1
    ...
    }), define("com/nebulon/app/buttons/AabLabelButton", ["require", "exports", "module", "PIXI", "./BaseAabButton", "com/fido/sound/SoundManager"], function(t, e, i) {
        var r = t("PIXI"),
            n = t("./BaseAabButton"),
            o = (t("com/fido/sound/SoundManager"), function(t, e) {
                this.label = new r.Sprite.fromFrame(t), this.label.anchor.set(.5), e && (this.label.x = -e / 2 + this.label.width / 2 + 5), e = e || this.label.width + 10;
                var i = .7;
                this.createBackground(e, i);
                var o = new r.DisplayObjectContainer;
                o.addChild(this.bg);
                var s = e + 20;
                o.hitArea = new r.Rectangle(-s / 2, -90 * i / 2, s, 90 * i), o.addChild(this.label), n.call(this, o), o.mousedown = o.touchstart = this.onTouch.bind(this), this.activateDefaultRollover()
            });
        ...
        n.getTexturesFromFrames = function(t) {
            ...
            for (var e = t.toString().split(""), i = "", r = e.length, n = r % 3 - 1, o = 0; r > o; o++) i += e[o], (o - n) % 3 == 0 && o != r - 1 && (i += ",");
            return i
    ...
    }), define("com/nebulon/app/screens/LoaderScreen", ["require", "exports", "module", "PIXI", "../buttons/AabButton", "../buttons/AabLabelButton", "com/fido/ui/buttons/Button", "com/fido/system/Ticker", "com/fido/utils/FrameWait", "com/fido/system/Device", "com/fido/utils/Utils"], function(t, e, i) {
        var r = t("PIXI"),
            n = (t("../buttons/AabButton"), t("../buttons/AabLabelButton"), t("com/fido/ui/buttons/Button"), t("com/fido/system/Ticker")),
            o = (t("com/fido/utils/FrameWait"), t("com/fido/system/Device"), t("com/fido/utils/Utils"), function(t) {
                this.app = t, r.DisplayObjectContainer.call(this), this.text = new r.Text("l o a d i n g . . .", {
                    fill: "white",
                    font: "20px Arial"
                }), this.text.anchor.set(.5), this.text.filters = [new r.filters.BloomFilter], this.tick = 0
            });
        o.prototype = Object.create(r.DisplayObjectContainer.prototype), o.prototype.onShown = function() {
            n.instance.add(this.update, this)
        }, o.prototype.onHidden = function() {
            n.instance.remove(this.update, this)
        }, o.prototype.update = function() {
            this.tick += .05, this.text.alpha = .6 + .5 * (Math.sin(this.tick) + 1) * .4
        }, o.prototype.resize = function(t, e) {
        ...
        Mini3d = function() {
            this.view = new PIXI.DisplayObjectContainer, this.children = [], this.focalLength = 400, this.position3d = {
                x: 0,
                y: 0,
                z: 0
            }, this.rotation3d = {
        ...
        }, Mini3d.constructor = Mini3d, Mini3d.prototype.addChild = function(t) {
            ...
            for (var t, e, i, n, o, s, a, h, l, u, c = Math.sin(this.rotation3d.x), d = Math.cos(this.rotation3d.x), p = Math.sin(this.rotation3d.y), f = Math.cos(this.rotation3d.y), m = Math.sin(this.rotation3d.z), v = Math.cos(this.rotation3d.z), g = 0; g < this.children.length; g++) {
                ...
                t = y.position3d.x - this.position3d.x, e = y.position3d.y - this.position3d.y, i = y.position3d.z - this.position3d.z, n = d * e - c * i, o = c * e + d * i, a = f * o - p * t, s = p * o + f * t, h = v * s - m * n, l = m * s + v * n, u = this.focalLength / (this.focalLength + a), t = h * u, e = l * u, i = a, y.scale.x = y.scale.y = u * y.scaleRatio, y.scale.x *= y.scaleOffset.x, y.scale.y *= y.scaleOffset.y, y.depth = -y.position3d.z, y.position.x = t, y.position.y = e
            }
            this.view.children.sort(r)
        }, i.exports = Mini3d
    }), define("com/nebulon/app/screens/Cloud", ["require", "exports", "module", "PIXI", "com/fido/system/Device", "com/fido/utils/Mini3d", "com/fido/system/Ticker"], function(t, e, i) {
        var r = t("PIXI"),
            n = (t("com/fido/system/Device"), t("com/fido/utils/Mini3d"), t("com/fido/system/Ticker")),
            o = function(t) {
                r.Sprite.call(this, t), this.position3d = {
                    x: 0,
                    y: 0,
                    z: 0
                }, this.scaleRatio = 2, this.scaleOffset = new r.Point(1, 1)
            };
        o.prototype = Object.create(r.Sprite.prototype), o.prototype.onShow = function() {
            n.instance.add(this.update, this)
        }, o.prototype.onShown = function() {}, o.prototype.update = function() {}, i.exports = o
    ...
    }), define("com/nebulon/app/screens/Clouds", ["require", "exports", "module", "PIXI", "com/fido/system/Device", "com/fido/utils/Mini3d", "./Cloud", "com/fido/utils/Math2"], function(t, e, i) {
        var r = t("PIXI"),
            n = (t("com/fido/system/Device"), t("com/fido/utils/Mini3d")),
            o = t("./Cloud"),
            s = t("com/fido/utils/Math2"),
            a = function(t) {
                this.app = t, r.DisplayObjectContainer.call(this), this.bg = new r.Sprite.fromImage(window.ASSET_URL + "img/skyBG.jpg"), this.addChild(this.bg), this.mini3d = new n, this.addChild(this.mini3d.view), this.speed = -15, this.range = 3e3, this.clouds = [], this.images = ["isoporp.svg", "isoporp.png"];
                for (var e = 0; 50 > e; e++) {
        ...
        a.prototype = Object.create(r.DisplayObjectContainer.prototype), a.prototype.onShow = function() {}, a.prototype.onShown = function() {}, a.prototype.update = function() {
            for (var t = 0; t < this.clouds.length; t++) {
                var e = this.clouds[t];
                e.position3d.z += this.speed, e.position3d.z < 300 ? e.alpha = e.position3d.z / 300 : e.alpha += .01 * (1 - e.alpha), e.position3d.z < 0 && (e.scaleRatio = 5, e.position3d.z += this.range, e.position3d.x = s.random(-4500, 4500), e.position3d.y = 1200 - Math.abs(.2 * e.position3d.x) + s.random(0, 200), e.rotation = e.position3d.x * -2e-4, e.alpha = 0, e.scaleOffset.x = s.random(.6, 1.4), e.scaleOffset.y = s.random(.9, 1.1), Math.random() < .5 && (e.scaleOffset.x *= -1))
            }
            this.mini3d.update(), this.count++, this.mini3d.view.rotation = .08 * Math.cos(.02 * this.count), this.mini3d.position3d.y = 200 * Math.sin(.03 * this.count), this.mini3d.position3d.y -= 50, this.mini3d.rotation3d.y = .2 * Math.sin(.02 * this.count * .5)
        }, a.prototype.resize = function(t, e) {
            this.mini3d.view.x = t / 2, this.mini3d.view.y = e / 2
        }, i.exports = a
    }), define("com/nebulon/app/screens/Stars", ["require", "exports", "module", "PIXI", "com/fido/system/Device", "com/fido/utils/Mini3d", "com/fido/system/Ticker", "./Cloud", "com/fido/utils/Math2"], function(t, e, i) {
        var r = t("PIXI"),
            n = (t("com/fido/system/Device"), t("com/fido/utils/Mini3d")),
            o = (t("com/fido/system/Ticker"), t("./Cloud")),
            s = t("com/fido/utils/Math2"),
            a = function(t) {
                this.app = t, r.DisplayObjectContainer.call(this), this.bg = new r.Sprite.fromImage(window.ASSET_URL + "img/spaceBG.jpg"), this.bg.anchor.set(.5), this.bg.x = 950, this.bg.y = 600, this.bg.scale.set(1.185), this.addChild(this.bg), this.sun = new r.Sprite.fromImage(window.ASSET_URL + "img/sun_add.png"), this.mini3d = new n, this.addChild(this.mini3d.view), this.speed = -5, this.range = 2e3, this.clouds = [], this.images = ["isoporp.svg", "isoporp.svg", "isoporp.svg"];
                for (var e = 0; 30 > e; e++) {
                    var i = new o(r.Texture.fromImage(ASSET_URL + "img/" + this.images[e % 3]));
                    i.blendMode = r.CONST.BLEND_MODES.SCREEN, i.rotSpeed = 4, this.mini3d.addChild(i), this.clouds.push(i), i.position3d.z = -(this.range / 30) * e
                }
        ...
        a.prototype = Object.create(r.DisplayObjectContainer.prototype), a.prototype.onShow = function() {}, a.prototype.onShown = function() {}, a.prototype.update = function() {
            for (var t = 0; t < this.clouds.length; t++) {
                var e = this.clouds[t];
                e.position3d.z += this.speed, e.position3d.z < 300 ? e.alpha = e.position3d.z / 300 : e.alpha += .01 * (1 - e.alpha), e.rotation += e.rotSpeed, e.position3d.z < 0 && (e.scaleRatio = 5, e.rotSpeed = s.random(-5e-4, 5e-4), e.position3d.z += this.range, e.position3d.x = s.random(-4950, 4950), e.position3d.y = s.random(-4950, 4950), e.alpha = 0, e.rotation = 0, e.scaleOffset.x = s.random(1, 1.2), e.scaleOffset.y = s.random(1, 1.2), Math.random() < .5 && (e.scaleOffset.x *= -1))
            }
            this.mini3d.update(), this.count += .25, this.bg.rotation += 2e-4, this.mini3d.view.rotation = .08 * Math.cos(.02 * this.count), this.mini3d.position3d.y = 200 * Math.sin(.03 * this.count), this.mini3d.position3d.y -= 50, this.mini3d.rotation3d.y = .2 * Math.sin(.02 * this.count * .5)
        }, a.prototype.resize = function(t, e) {
            this.mini3d.view.x = t / 2, this.mini3d.view.y = e / 2
        }, i.exports = a
    }), define("com/fido/physics/DoubleSpring", ["require", "exports", "module"], function(t, e, i) {
        var r = function() {
            this.x = 0, this.ax = 0, this.dx = 0, this.tx = 0, this.y = 0, this.ay = 0, this.dy = 0, this.ty = 0, this.max = 30, this.damp = .75, this.springiness = .09, this.max = 160, this.damp = .7, this.springiness = .69
        };
        r.constructor = r, r.prototype.update = function() {
    ...
    }), define("com/nebulon/app/screens/MaskyMask", ["require", "exports", "module", "PIXI", "com/fido/system/Device", "com/fido/utils/Mini3d", "com/fido/system/Ticker", "com/fido/utils/Math2", "com/fido/physics/DoubleSpring"], function(t, e, i) {
        var r = t("PIXI"),
            n = (t("com/fido/system/Device"), t("com/fido/utils/Mini3d"), t("com/fido/system/Ticker"), t("com/fido/utils/Math2")),
            o = t("com/fido/physics/DoubleSpring"),
            s = function() {
                var t = new r.RenderTexture(window.renderer, 1900, 1200);
                r.Sprite.call(this, t), this.container = new r.Container, this.m = new r.Matrix, this.m.translate(950, 600), this.blobs = [];
                for (var e = 0; 50 > e; e++) blob = new r.Sprite.fromImage(ASSET_URL + "img/isoporp.svg"), blob.target = new r.Point(n.random(-950, 950), n.random(-600, 600)), this.blobs.push(blob), blob.spring = new o, blob.rotationSpeed = n.random(-.1, .1), blob.anchor.set(.5), blob.count = Math.random() * Math.PI * 2, this.container.addChild(blob);
                this.isOpen = !1, this.count = 0, this.anchor.set(.5), this.target = new r.Point
            };
        s.prototype = Object.create(r.Sprite.prototype), s.prototype.update = function() {
            this.count += .01;
            for (var t = 0; t < this.blobs.length; t++) {
                var e = this.blobs[t];
                e.count += .1;
                var i = Math.sin(.5 * e.count);
                if (e.spring.update(), e.scale.set(i), e.rotation += .1 * e.rotationSpeed, e.alpha = .9, e.count > 2 * Math.PI) {
                    e.count -= 2 * Math.PI;
                    var r = Math.random() * Math.PI * 2,
                        o = n.random(100, 200);
                    e.x = this.target.x + Math.sin(r) * o, e.y = this.target.y + Math.cos(r) * o, e.rotation = Math.random() * Math.PI * 2
                }
            }
        ...
        function r(t) {
            ...
            n.AbstractFilter.call(this, ["attribute vec2 aVertexPosition;", "attribute vec2 aTextureCoord;", "attribute vec4 aColor;", "uniform mat3 projectionMatrix;", "uniform mat3 otherMatrix;", "varying vec2 vMaskCoord;", "varying vec2 vTextureCoord;", "varying vec4 vColor;", "void main(void)", "{", "   gl_Position = vec4((projectionMatrix * vec3(aVertexPosition, 1.0)).xy, 0.0, 1.0);", "   vTextureCoord = aTextureCoord;", "   vMaskCoord = ( otherMatrix * vec3( aTextureCoord, 1.0)  ).xy;", "   vColor = vec4(aColor.rgb * aColor.a, aColor.a);", "}"].join("\n"), ["precision lowp float;", "varying vec2 vMaskCoord;", "varying vec2 vTextureCoord;", "varying vec4 vColor;", "uniform sampler2D uSampler;", "uniform sampler2D mask;", "void main(void)", "{", "   vec4 masky =  texture2D(mask, vMaskCoord);", "   float strength =  (masky.r * masky.a);", "   strength *= 5.0;", "   strength = min(1.0, strength ) ;", "   vec4 original =  texture2D(uSampler, vTextureCoord +  (1.0-strength) * 0.1);", "   original *= strength;", "   gl_FragColor =  original;", "}"].join("\n"), {
                mask: {
                    type: "sampler2D",
                    value: t.texture
                },
        ...
        var n = t("PIXI");
        r.prototype = Object.create(n.AbstractFilter.prototype), r.prototype.constructor = r, i.exports = r, r.prototype.applyFilter = function(t, e, i) {
            var r = t.filterManager;
            r.calculateMappedMatrix(e.frame, this.maskSprite, this.maskMatrix), this.uniforms.otherMatrix.value = this.maskMatrix.toArray(!0);
            var n = this.getShader(t);
            r.applyFilter(n, e, i)
        ...
        var r = t("PIXI"),
            n = i.exports = function() {
                r.AbstractFilter.call(this, null, ["precision highp float;", "uniform sampler2D uSampler;", "varying vec2 vTextureCoord;", "varying vec4 vColor;", "uniform vec2 center;", "uniform float strength;", "uniform vec2 texSize;", "uniform float vignetteOffset;", "uniform float vignetteDarkness;", "uniform float sine;", "uniform float cosine;", "uniform float shiftSampleDistance;", "uniform vec2 red;", "uniform vec2 green;", "uniform vec2 blue;", "uniform float saturation;", "uniform float saturationConstant;", "float random(vec3 scale, float seed) {", "return fract(sin(dot(gl_FragCoord.xyz + seed, scale)) * 43758.5453 + seed);", "}", "vec3 czm_saturation(vec3 rgb, float adjustment)", "{", "const vec3 W = vec3(0.2125, 0.7154, 0.0721);", "vec3 intensity = vec3(dot(rgb, W));", "return mix(intensity, rgb, adjustment);", "}", "void main() {", "vec4 color = vec4(0.0);", "float total = 0.0;", "vec2 toCenter = center - vTextureCoord * texSize;", "float blurAmount = 0.3;", "vec4 actual = texture2D(uSampler, vTextureCoord );", "float dist = distance( vTextureCoord, vec2( 0.5 ) );", "float offset = random(vec3(12.9898, 78.233, 151.7182), 0.0);", "for (float t = 0.0; t <= 20.0; t++) {", "   float percent = (t + offset) / 20.0;", "   float weight = 4.0 * (percent - percent * percent);", "   vec4 sample = texture2D(uSampler, vTextureCoord + toCenter * percent * strength / texSize);", "   sample.rgb *= sample.a;", "   color += sample * weight;", "   total += weight;", "}", "color = color / total;", "float mixBlur = 0.08;", "float distMix = smoothstep( 0.8, vignetteDarkness * 0.799, dist *( vignetteOffset + vignetteDarkness ) );", "gl_FragColor = mix( color, actual, max( mixBlur, distMix ) );", "vec4 shift;", "float distMixInv = 1.0 - distMix;", "shift.r = texture2D(uSampler, vTextureCoord + ( red * distMixInv ) /texSize.xy ).r;", "shift.g = texture2D(uSampler, vTextureCoord + ( green * distMixInv ) /texSize.xy ).g;", "shift.b = texture2D(uSampler, vTextureCoord + ( blue * distMixInv ) /texSize.xy ).b;", "shift.a = texture2D(uSampler, vTextureCoord ).a;", "gl_FragColor = mix( gl_FragColor, shift, 0.3 );", "float feather = 0.005;", "float satMix = 1.0 - smoothstep( 0.5, feather * 0.499, dist * ( 1.2 + feather ) );", "satMix *= saturationConstant;", "gl_FragColor.rgb = czm_saturation(gl_FragColor.rgb, max( saturation * ( satMix + 1.0 ), 1.0 )  );", "gl_FragColor.rgb /= gl_FragColor.a + 0.00001;", "}"].join("\n"), {
                    center: {
                        type: "v2",
                        value: {
                            x: 950,
        ...
        n.prototype = Object.create(r.AbstractFilter.prototype), n.constructor = n, Object.defineProperties(n.prototype, {
            center: {
                get: function() {
                    return this.uniforms.center.value
                },
    ...
    }), define("com/nebulon/app/screens/MainScreen", ["require", "exports", "module", "PIXI", "com/fido/system/Device", "com/nebulon/app/screens/Clouds", "com/nebulon/app/screens/Stars", "com/nebulon/app/screens/MaskyMask", "com/fido/system/Ticker", "./SuperFilter", "./SpeedFilter"], function(t, e, i) {
        var r = t("PIXI"),
            ...
            u = t("./SpeedFilter"),
            c = function(t) {
                this.app = t, r.DisplayObjectContainer.call(this), this.clouds = new o, this.stars = new s, this.addChild(this.clouds), this.addChild(this.stars), this.maskyMask = new a, this.addChild(this.maskyMask), this.maskyMask.renderable = !1, this.superFilter = new l(this.maskyMask), this.interactiveChildren = !1, this.hitArea = new r.Rectangle(0, 0, 1900, 1200), this.interactive = !0, this.mousedown = this.touchstart = this.onDown.bind(this), this.mousemove = this.touchmove = this.onMove.bind(this), this.speedFilter = new u, this.stars.filters = n.instance.isMobile ? [this.superFilter] : [this.superFilter], this.autoMode = !0, this.posy = new r.Point, this.userposy = new r.Point, this.count = 0, this.autoCount = 1e5, this.ratio = 0
            };
        c.prototype = Object.create(r.DisplayObjectContainer.prototype), c.prototype.onDown = function() {
        ...
        }, c.prototype.onShown = function() {}, c.prototype.update = function() {
            this.autoCount++, this.autoCount > 60 ? (this.count += .01, this.posy.x = 1900 * Math.sin(this.count) * .25, this.posy.y = 1200 * Math.cos(2 * this.count) * .05, this.ratio += .1 * (1 - this.ratio)) : this.ratio += .1 * (0 - this.ratio);
            var t = this.userposy.x + (this.posy.x - this.userposy.x) * this.ratio,
                e = this.userposy.y + (this.posy.y - this.userposy.y) * this.ratio;
            this.maskyMask.target.x = t, this.maskyMask.target.y = e, this.clouds.update(), this.stars.update(), this.maskyMask.update()
        }, c.prototype.resize = function(t, e) {
            this.clouds.resize(t, e), this.stars.resize(t, e), this.maskyMask.resize(t, e)
        }, i.exports = c
    }), define("APP_root", ["require", "exports", "module", "PIXI", "com/fido/app/App", "com/fido/system/Ticker", "com/fido/system/Device", "com/fido/sound/SoundManager", "com/nebulon/app/screens/LoaderScreen", "com/nebulon/app/screens/MainScreen"], function(t, e, i) {
        var r = t("PIXI");
        window.PIXI = r;
        var n = t("com/fido/app/App"),
            ...
            h = function() {
                ...
                n.call(this, t), this.safeSize = {
                    width: 1900,
                    height: 1200
                }, this.maxSize = {
                    width: 1900,
                    height: 1200
                }, this.onReady.add(this.onAppReady, this), this.startup(), this.ls = new s, this.screenManager.addScreen(this.ls, "loader"), this.screenManager.gotoScreenByID("loader");
                var e = new r.loaders.Loader;
                e.add("x", window.ASSET_URL + "img/skyBG.jpg").add("x1", window.ASSET_URL + "img/isoporp.svg").add("xx", window.ASSET_URL + "img/isoporp.svg").add("x2", window.ASSET_URL + "img/spaceBG.jpg").add("x3", window.ASSET_URL + "img/sun_add.png").add("x4", window.ASSET_URL + "img/isoporp.svg").add("x5", window.ASSET_URL + "img/isoporp.svg").add("x6", window.ASSET_URL + "img/isoporp.svg").add("x7", window.ASSET_URL + "img/isoporp.svg").load(this.onAppReady.bind(this)), window.addEventListener("message", function(t) {
                    "resume" === t.data ? o.instance.start() : o.instance.stop()
                })
            };
        h.prototype = Object.create(n.prototype), h.prototype.onAppReady = function() {
            window.renderer = this.renderer, this.starsScreen = new a(this), this.screenManager.addScreen(this.starsScreen, "title"), this.screenManager.gotoScreenByID("title"), this.resize(this.w, this.h)
        }, h.prototype.resize = function(t, e) {
            this.w = t, this.h = e;
            var i = 1;
            this.isMobile && (i = window.devicePixelRatio ? window.devicePixelRatio : window.screen.deviceXDPI / window.screen.logicalXDPI);
            var r = t / this.safeSize.width > e / this.safeSize.height ? t / this.safeSize.width : e / this.safeSize.height,
                n = Math.min(this.maxSize.width * r, t),
                o = Math.min(this.maxSize.height * r, e);
            this.renderer.resize(n * i | 0, o * i | 0), this.view.style.width = n + "px", this.view.style.height = o + "px", this.view.style.left = t / 2 - n / 2 + "px", this.view.style.top = e / 2 - o / 2 + "px", this.screenManager.resize(n / r, o / r), this.screenManager.container.scale.set(r * i)
        }, i.exports = h
    });
var Stats = function() {
    var t = Date.now(),
    ...
    for (p.id = "fpsGraph", p.style.cssText = "position:relative;width:74px;height:30px;background-color:#0ff", c.appendChild(p); 74 > p.children.length;) {
    ...
    for (g.id = "msGraph", g.style.cssText = "position:relative;width:74px;height:30px;background-color:#0f0", m.appendChild(g); 74 > g.children.length;) f = document.createElement("span"), f.style.cssText = "width:1px;height:30px;float:left;background-color:#131", g.appendChild(f);
    var y = function(t) {
        switch (l = t) {
            case 0:
    ...
    return {
        ...
        begin: function() {
            ...
            return g.appendChild(g.firstChild).style.height = u + "px", h++, l > e + 1e3 && (o = Math.round(1e3 * h / (l - e)), s = Math.min(s, o), a = Math.max(a, o), d.textContent = o + " FPS (" + s + "-" + a + ")", u = Math.min(30, 30 - 30 * (o / 100)), p.appendChild(p.firstChild).style.height = u + "px", e = l, h = 0), l
        },
        update: function() {
            t = this.end()
        }
...
define("stats", function() {}), window.ASSET_URL = "assets/", config = {
    app: "com/fortieth/FortiethApp"
}, window.console || (window.console = {
    log: function() {}
}), window.console.log || (window.console.log = function() {}), require.config({
    baseUrl: "./js",
    paths: {
        PIXI: "libs/pixi.min",
...
}), window.DEVICE_SCALE = window.devicePixelRatio || 1, hasCanvasSupport() ? require(["TWEEN", "EASEPACK", "CSSPACK", "HOWLER", "PIXI", "APP_root", "stats", "com/fido/system/Device"], function(t, e, i, r, n, o, s, a) {
    function h() {
        document.getElementById("container");
        a.instance.iOS && a.instance.iOS_version < 7 || window.scrollTo(0, 0), l.resize(window.innerWidth, window.innerHeight)
    }
    var l = new o;
    window.app = l;
    var u = document.getElementById("container");
    u.appendChild(l.view), u.style.background = "black", l.view.style.position = "absolute", l.view.style.top = 0, l.view.style.left = 0, window.addEventListener("resize", function() {
